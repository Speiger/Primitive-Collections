...
public class Byte2FloatArrayMap extends AbstractByte2FloatMap implements Byte2FloatOrderedMap
{
	...
	public Byte2FloatArrayMap(Byte2FloatMap map) {
		this(map.size());
		for(ObjectIterator<Byte2FloatMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Byte2FloatMap.Entry) {
					...
					return keys[index] == entry.getByteKey() && Float.floatToIntBits(getFloatValue()) == Float.floatToIntBits(entry.getFloatValue());
				}
