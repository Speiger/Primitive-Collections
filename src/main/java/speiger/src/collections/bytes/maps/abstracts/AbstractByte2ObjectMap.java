...
public abstract class AbstractByte2ObjectMap<V> extends AbstractMap<Byte, V> implements Byte2ObjectMap<V>
{
	...
	protected ObjectIterable<Byte2ObjectMap.Entry<V>> getFastIterable(Byte2ObjectMap<V> map) {
		return Byte2ObjectMaps.fastIterable(map);
	}
	
	protected ObjectIterator<Byte2ObjectMap.Entry<V>> getFastIterator(Byte2ObjectMap<V> map) {
		return Byte2ObjectMaps.fastIterator(map);
	}
	...
	public void putAll(Byte2ObjectMap<V> m) {
		for(ObjectIterator<Byte2ObjectMap.Entry<V>> iter = getFastIterator(m);iter.hasNext();) {
	...
	public void replaceObjects(ByteObjectUnaryOperator<V> mappingFunction) {
		...
		for(ObjectIterator<Byte2ObjectMap.Entry<V>> iter = getFastIterator(this);iter.hasNext();) {
			Byte2ObjectMap.Entry<V> entry = iter.next();
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					ObjectIterator<Byte2ObjectMap.Entry<V>> iter = getFastIterator(AbstractByte2ObjectMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Byte2ObjectMap.Entry<V>> iter = getFastIterator(this);
