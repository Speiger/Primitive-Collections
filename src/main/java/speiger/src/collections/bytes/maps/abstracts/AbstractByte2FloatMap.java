...
public abstract class AbstractByte2FloatMap extends AbstractMap<Byte, Float> implements Byte2FloatMap
{
	...
	protected ObjectIterable<Byte2FloatMap.Entry> getFastIterable(Byte2FloatMap map) {
		return Byte2FloatMaps.fastIterable(map);
	}
	
	protected ObjectIterator<Byte2FloatMap.Entry> getFastIterator(Byte2FloatMap map) {
		return Byte2FloatMaps.fastIterator(map);
	}
	...
	public void addToAll(Byte2FloatMap m) {
		for(Byte2FloatMap.Entry entry : getFastIterable(m))
			addTo(entry.getByteKey(), entry.getFloatValue());
	}
	
	@Override
	public void putAll(Byte2FloatMap m) {
		for(ObjectIterator<Byte2FloatMap.Entry> iter = getFastIterator(m);iter.hasNext();) {
	...
	public void replaceFloats(ByteFloatUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Byte2FloatMap.Entry> iter = getFastIterator(this);iter.hasNext();) {
			Byte2FloatMap.Entry entry = iter.next();
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					ObjectIterator<Byte2FloatMap.Entry> iter = getFastIterator(AbstractByte2FloatMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Byte2FloatMap.Entry> iter = getFastIterator(this);
