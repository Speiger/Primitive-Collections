...
public interface BytePriorityDequeue extends BytePriorityQueue
{
	 ...
	 */
	public default void enqueueAllFirst(byte... e) {
	 ...
	 */
	public default void enqueueAllFirst(byte[] e, int length) {
	 ...
	 * @param length the amount of elements that should be inserted
	 */	
	public default void enqueueAllFirst(byte[] e, int offset, int length) {
	 ...
	 */
	public default void enqueueAllFirst(ByteCollection c) {
		for(ByteIterator iter = c.iterator();iter.hasNext();)
			enqueueFirst(iter.nextByte());
	}
	 ...
	 */
	public default byte last() { return peek(size()-1); }
	 ...
	 */
	public default BytePriorityDequeue synchronizeQueue() { return BytePriorityQueues.synchronize(this); }
	 ...
	 * @see BytePriorityQueues#synchronize
	 */
	public default BytePriorityDequeue synchronizeQueue(Object mutex) { return BytePriorityQueues.synchronize(this, mutex); }
