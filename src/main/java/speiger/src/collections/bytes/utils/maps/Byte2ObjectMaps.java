...
public class Byte2ObjectMaps
{
	...
	public static class UnmodifyableOrderedMap<V> extends UnmodifyableMap<V> implements Byte2ObjectOrderedMap<V> {
		...
		@Override
		public V putFirst(byte key, V value) { throw new UnsupportedOperationException(); }
		@Override
		public V putLast(byte key, V value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Byte2ObjectMap.Entry<V> firstEntry() { return map.firstEntry(); }
		@Override
		public Byte2ObjectMap.Entry<V> lastEntry() { return map.lastEntry(); }
		@Override
		public Byte2ObjectMap.Entry<V> pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Byte2ObjectMap.Entry<V> pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet<V> extends UnmodifyableEntrySet<V> implements ObjectOrderedSet<Byte2ObjectMap.Entry<V>>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Byte2ObjectMap.Entry<V> getFirst() { return set.getFirst(); }
		@Override
		public Byte2ObjectMap.Entry<V> removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Byte2ObjectMap.Entry<V> getLast() { return set.getLast(); }
		@Override
		public Byte2ObjectMap.Entry<V> removeLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedOrderedMap<V> extends SynchronizedMap<V> implements Byte2ObjectOrderedMap<V> {
		...
		@Override
		public V putFirst(byte key, V value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public V putLast(byte key, V value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap<V> extends AbstractByte2ObjectMap<V> implements Byte2ObjectMap<V> {
		...
		@Override
		public V computeIfAbsent(byte key, ByteFunction<V> mappingFunction) { synchronized(mutex) { return map.computeIfAbsent(key, mappingFunction); } }
		@Override
