...
public class ImmutableShort2CharOpenHashMap extends AbstractShort2CharMap implements Short2CharOrderedMap
{
	...
	public ImmutableShort2CharOpenHashMap(Short2CharMap map, float loadFactor) {
		...
		char[] values = new char[keys.length];
		int index = 0;
		for(Short2CharMap.Entry entry : getFastIterable(map)) {
	...
	private class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharOrderedMap.FastOrderedSet {
		...
		@Override
		public Short2CharMap.Entry getFirst() {
			return new BasicEntry(firstShortKey(), firstCharValue());
		}
		
		@Override
		public Short2CharMap.Entry getLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Short2CharMap.Entry> reverseIterator() {
	...
	private class Values extends AbstractCharCollection implements CharOrderedCollection {
		...
		@Override
		public int size() { return ImmutableShort2CharOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
