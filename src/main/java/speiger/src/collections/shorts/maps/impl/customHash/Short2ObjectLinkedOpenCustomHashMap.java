...
public class Short2ObjectLinkedOpenCustomHashMap<V> extends Short2ObjectOpenCustomHashMap<V> implements Short2ObjectOrderedMap<V>
{
	...
	@Override
	public V putFirst(short key, V value) {
		if(strategy.equals(key, (short)0)) {
	...
	@Override
	public V putLast(short key, V value) {
		if(strategy.equals(key, (short)0)) {
			if(containsNull) return values[nullIndex];
			values[nullIndex] = value;
			containsNull = true;
	...
	public Short2ObjectMap.Entry<V> pollFirstEntry() {
		...
		size--;
		if(strategy.equals(result.getShortKey(), (short)0)) {
			containsNull = false;
			keys[nullIndex] = (short)0;
			values[nullIndex] = null;
		}
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectOrderedMap.FastOrderedSet<V> {
		...
		@Override
		public Short2ObjectMap.Entry<V> removeFirst() {
		...
		@Override
		public Short2ObjectMap.Entry<V> removeLast() {
	...
	private class Values extends AbstractObjectCollection<V> implements ObjectOrderedCollection<V> {
		...
		@Override
		public int size() { return Short2ObjectLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Short2ObjectLinkedOpenCustomHashMap.this.clear(); }
		@Override
