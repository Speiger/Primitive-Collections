...
public class Short2BooleanLinkedOpenCustomHashMap extends Short2BooleanOpenCustomHashMap implements Short2BooleanOrderedMap
{
	...
	@Override
	public boolean putFirst(short key, boolean value) {
		if(strategy.equals(key, (short)0)) {
	...
	@Override
	public boolean putLast(short key, boolean value) {
		if(strategy.equals(key, (short)0)) {
			if(containsNull) return values[nullIndex];
			values[nullIndex] = value;
			containsNull = true;
	...
	private class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanOrderedMap.FastOrderedSet {
		...
		@Override
		public Short2BooleanMap.Entry getFirst() {
			return new BasicEntry(firstShortKey(), firstBooleanValue());
		}
		
		@Override
		public Short2BooleanMap.Entry getLast() {
			return new BasicEntry(lastShortKey(), lastBooleanValue());
		}
		
		@Override
		public Short2BooleanMap.Entry removeFirst() {
		...
		@Override
		public Short2BooleanMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Short2BooleanMap.Entry> reverseIterator() {
	...
	private class Values extends AbstractBooleanCollection implements BooleanOrderedCollection {
		...
		@Override
		public int size() { return Short2BooleanLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Short2BooleanLinkedOpenCustomHashMap.this.clear(); }
		@Override
