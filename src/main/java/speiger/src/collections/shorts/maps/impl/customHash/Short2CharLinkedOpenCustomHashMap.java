...
public class Short2CharLinkedOpenCustomHashMap extends Short2CharOpenCustomHashMap implements Short2CharOrderedMap
{
	...
	private class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharOrderedMap.FastOrderedSet {
		...
		@Override
		public Short2CharMap.Entry removeFirst() {
		...
		@Override
		public Short2CharMap.Entry removeLast() {
	...
	private class Values extends AbstractCharCollection implements CharOrderedCollection {
		...
		@Override
		public int size() { return Short2CharLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Short2CharLinkedOpenCustomHashMap.this.clear(); }
		@Override
