...
public class Short2FloatArrayMap extends AbstractShort2FloatMap implements Short2FloatOrderedMap
{
	...
	public Short2FloatArrayMap(Short2FloatMap map) {
		this(map.size());
		for(ObjectIterator<Short2FloatMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
	...
	private class MapEntrySet extends AbstractObjectSet<Short2FloatMap.Entry> implements Short2FloatOrderedMap.FastOrderedSet {
		...
		@Override
		public Short2FloatMap.Entry getFirst() {
			return new BasicEntry(firstShortKey(), firstFloatValue());
		}
		
		@Override
		public Short2FloatMap.Entry getLast() {
			return new BasicEntry(lastShortKey(), lastFloatValue());
		}
		
		@Override
		public Short2FloatMap.Entry removeFirst() {
		...
		@Override
		public Short2FloatMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Short2FloatMap.Entry> reverseIterator() {
		...
		@Override
		public Optional<Short2FloatMap.Entry> reduce(ObjectObjectUnaryOperator<Short2FloatMap.Entry, Short2FloatMap.Entry> operator) {
			Objects.requireNonNull(operator);
		...
		@Override
		public Optional<Short2FloatMap.Entry> findFirst(Predicate<Short2FloatMap.Entry> filter) {
			Objects.requireNonNull(filter);
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Short2FloatMap.Entry) {
					...
					return keys[index] == entry.getShortKey() && Float.floatToIntBits(getFloatValue()) == Float.floatToIntBits(entry.getFloatValue());
				}
