...
public interface Short2DoubleMap extends Map<Short, Double>, Short2DoubleFunction
{
	...
	/**
	 * A Helper method that allows to put int a Short2DoubleMap.Entry into a map.
	 ...
	 * @return the last present value or default return	value.
	 */
	public default Double put(Map.Entry<Short, Double> entry) {
		return put(entry.getKey().shortValue(), entry.getValue().doubleValue());
	}
	...
	@Override
	public default double applyAsDouble(short key) {
		return get(key);
	}
	/**
