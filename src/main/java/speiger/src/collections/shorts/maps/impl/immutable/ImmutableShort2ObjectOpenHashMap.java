...
public class ImmutableShort2ObjectOpenHashMap<V> extends AbstractShort2ObjectMap<V> implements Short2ObjectOrderedMap<V>
{
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectOrderedMap.FastOrderedSet<V> {
		...
		@Override
		public Short2ObjectMap.Entry<V> getFirst() {
			return new BasicEntry<>(firstShortKey(), firstValue());
		}
		
		@Override
		public Short2ObjectMap.Entry<V> getLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> reverseIterator() {
		...
		@Override
		public Optional<Short2ObjectMap.Entry<V>> reduce(ObjectObjectUnaryOperator<Short2ObjectMap.Entry<V>, Short2ObjectMap.Entry<V>> operator) {
			Objects.requireNonNull(operator);
		...
		@Override
		public Optional<Short2ObjectMap.Entry<V>> findFirst(Predicate<Short2ObjectMap.Entry<V>> filter) {
			Objects.requireNonNull(filter);
	...
	private class Values extends AbstractObjectCollection<V> implements ObjectOrderedCollection<V> {
		...
		@Override
		public int size() { return ImmutableShort2ObjectOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
