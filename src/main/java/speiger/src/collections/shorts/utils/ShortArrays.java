...
public class ShortArrays
{
	...
	public static short[] pour(ShortIterator iter, int max) {
		ShortCollections.CollectionWrapper list = ShortCollections.wrapper();
	 ...
	 * @return the provided sorted array
	 */
	public static short[] indirectShuffle(short[] array, Swapper swapper) {
	 ...
	 * @return the provided sorted array
	 */
	public static short[] indirectShuffle(short[] array, Random random, Swapper swapper) {
	 ...
	 * @return the provided sorted array
	 */
	public static short[] indirectShuffle(short[] array, int length, Random random, Swapper swapper) {
	 ...
	 * @return the provided sorted array
	 */
	public static short[] indirectShuffle(short[] array, int offset, int length, Random random, Swapper swapper) {
		for(int i = length-1; i>=0;i--) {
			int j = offset + i;
			int p = offset + random.nextInt(i + 1);
			swapper.swap(j, p);
	 ...
	 * @return input array
	 */
	public static short[] indirectInsertionSort(short[] array, ShortComparator comp, Swapper swapper) {
	 ...
	 * @param swapper the callback which elements were swapped
	 */
	public static void indirectInsertionSort(short[] array, int length, ShortComparator comp, Swapper swapper) {
	 ...
	 * @param swapper the callback which elements were swapped
	 */
	public static void indirectInsertionSort(short[] array, int from, int to, ShortComparator comp, Swapper swapper) {
		for (int i = from+1;i<to; i++) {
			short current = array[i];
			int j = i - 1;
			while(j >= from && comp.compare(current, array[j]) < 0) {
	 ...
	 * @return input array
	 */
	public static short[] indirectSelectionSort(short[] array, ShortComparator comp, Swapper swapper) {
	 ...
	 * @param swapper the callback which elements were swapped
	 */
	public static void indirectSelectionSort(short[] array, int length, ShortComparator comp, Swapper swapper) {
	 ...
	 * @param swapper the callback which elements were swapped
	 */
	public static void indirectSelectionSort(short[] array, int from, int to, ShortComparator comp, Swapper swapper) {
		for (int i = from; i < to; i++) {
			short min = array[i];
			int minId = i;
			for(int j = i+1; j < to; j++) {
	 ...
	 * @return input array
	 */
	public static short[] indirectMergeSort(short[] array, ShortComparator comp, Swapper swapper) {
	 ...
	 * @param swapper the callback which elements were swapped
	 */
	public static void indirectMergeSort(short[] array, int length, ShortComparator comp, Swapper swapper) {
	 ...
	 * @param swapper the callback which elements were swapped
	 */
	public static void indirectMergeSort(short[] array, short[] supp, int from, int to, ShortComparator comp, Swapper swapper) {
		if(to - from < BASE_THRESHOLD) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void indirectParallelMergeSort(short[] array, ShortComparator comp, Swapper swapper) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void indirectParallelMergeSort(short[] array, int length, ShortComparator comp, Swapper swapper) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void indirectParallelMergeSort(short[] array, short[] supp, int from, int to, ShortComparator comp, Swapper swapper) {
		if(SanityChecks.canParallelTask() && to - from >= PARALLEL_THRESHOLD) {
	 ...
	 * @return input array
	 */
	public static short[] indirectQuickSort(short[] array, ShortComparator comp, Swapper swapper) {
	 ...
	 * @param swapper the callback which elements were swapped
	 */
	public static void indirectQuickSort(short[] array, int length, ShortComparator comp, Swapper swapper) {
	 ...
	 * @param swapper the callback which elements were swapped
	 */
	public static void indirectQuickSort(short[] array, int from, int to, ShortComparator comp, Swapper swapper) {
		int length = to - from;
		if(length <= 0) return;
		if(length < BASE_THRESHOLD) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void indirectParallelQuickSort(short[] array, ShortComparator comp, Swapper swapper) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void indirectParallelQuickSort(short[] array, int length, ShortComparator comp, Swapper swapper) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void indirectParallelQuickSort(short[] array, int from, int to, ShortComparator comp, Swapper swapper) {
		if(SanityChecks.canParallelTask() && to - from >= PARALLEL_THRESHOLD) {
	...
	static void swap(short[] a, int from, int to, Swapper swapper) {
	...
	static void swap(short[] a, int from, int to, int length, Swapper swapper) {
		to -= length;
	...
	static class QuickSortActionCompSwap extends RecursiveAction {
		...
		QuickSortActionCompSwap(short[] array, int from, int to, ShortComparator comp, Swapper swapper) {
			this.array = array;
			this.from = from;
			this.to = to;
			this.comp = comp;
	...
	static class MergeSortActionCompSwap extends RecursiveAction {
		...
		MergeSortActionCompSwap(short[] array, short[] supp, int from, int to, ShortComparator comp, Swapper swapper) {
			this.array = array;
			this.supp = supp;
			this.from = from;
			this.to = to;
