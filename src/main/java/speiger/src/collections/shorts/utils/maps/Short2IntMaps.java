...
public class Short2IntMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Short2IntOrderedMap {
		...
		@Override
		public int putFirst(short key, int value) { throw new UnsupportedOperationException(); }
		@Override
		public int putLast(short key, int value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Short2IntMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Short2IntMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Short2IntMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Short2IntMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Short2IntMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Short2IntMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Short2IntMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Short2IntMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Short2IntMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Short2IntOrderedMap {
		...
		@Override
		public int putFirst(short key, int value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public int putLast(short key, int value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractShort2IntMap implements Short2IntMap {
		...
		@Override
		public int computeIntNonDefault(short key, ShortIntUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeIntNonDefault(key, mappingFunction); } }
		@Override
		public int computeIntIfAbsentNonDefault(short key, Short2IntFunction mappingFunction) { synchronized(mutex) { return map.computeIntIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public int computeIntIfPresentNonDefault(short key, ShortIntUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeIntIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public int supplyIntIfAbsentNonDefault(short key, IntSupplier valueProvider) { synchronized(mutex) { return map.supplyIntIfAbsentNonDefault(key, valueProvider); } }
		@Override
