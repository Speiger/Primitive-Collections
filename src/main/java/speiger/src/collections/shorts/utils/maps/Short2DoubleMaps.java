...
public class Short2DoubleMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Short2DoubleOrderedMap {
		...
		@Override
		public double putFirst(short key, double value) { throw new UnsupportedOperationException(); }
		@Override
		public double putLast(short key, double value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Short2DoubleMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Short2DoubleMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Short2DoubleMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Short2DoubleMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Short2DoubleMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Short2DoubleMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Short2DoubleMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Short2DoubleMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Short2DoubleMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Short2DoubleOrderedMap {
		...
		@Override
		public double putFirst(short key, double value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public double putLast(short key, double value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractShort2DoubleMap implements Short2DoubleMap {
		...
		@Override
		public double computeDoubleNonDefault(short key, ShortDoubleUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeDoubleNonDefault(key, mappingFunction); } }
		@Override
		public double computeDoubleIfAbsentNonDefault(short key, Short2DoubleFunction mappingFunction) { synchronized(mutex) { return map.computeDoubleIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public double computeDoubleIfPresentNonDefault(short key, ShortDoubleUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeDoubleIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public double supplyDoubleIfAbsentNonDefault(short key, DoubleSupplier valueProvider) { synchronized(mutex) { return map.supplyDoubleIfAbsentNonDefault(key, valueProvider); } }
		@Override
