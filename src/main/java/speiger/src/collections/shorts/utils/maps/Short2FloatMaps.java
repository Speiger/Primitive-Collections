...
public class Short2FloatMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Short2FloatOrderedMap {
		...
		@Override
		public float putFirst(short key, float value) { throw new UnsupportedOperationException(); }
		@Override
		public float putLast(short key, float value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Short2FloatMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Short2FloatMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Short2FloatMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Short2FloatMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Short2FloatMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Short2FloatMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Short2FloatMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Short2FloatMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Short2FloatMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Short2FloatOrderedMap {
		...
		@Override
		public float putFirst(short key, float value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public float putLast(short key, float value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractShort2FloatMap implements Short2FloatMap {
		...
		@Override
		public float computeFloatNonDefault(short key, ShortFloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatNonDefault(key, mappingFunction); } }
		@Override
		public float computeFloatIfAbsentNonDefault(short key, Short2FloatFunction mappingFunction) { synchronized(mutex) { return map.computeFloatIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public float computeFloatIfPresentNonDefault(short key, ShortFloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public float supplyFloatIfAbsentNonDefault(short key, FloatSupplier valueProvider) { synchronized(mutex) { return map.supplyFloatIfAbsentNonDefault(key, valueProvider); } }
		@Override
