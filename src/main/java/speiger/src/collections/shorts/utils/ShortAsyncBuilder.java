...
public class ShortAsyncBuilder
{
	 ...
	 */
	public <E> ObjectAsyncBuilder<E> map(Short2ObjectFunction<E> mapper) {
	 ...
	 * @return a new Builder Object with the mapped Iterable
	 */
	public <E, V extends Iterable<E>> ObjectAsyncBuilder<E> flatMap(Short2ObjectFunction<V> mapper) {
	 ...
	 * @return a new Builder Object with the mapped Iterable
	 */
	public <E> ObjectAsyncBuilder<E> arrayflatMap(Short2ObjectFunction<E[]> mapper) {
	 ...
	 */
	public ShortAsyncBuilder filter(Short2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchAny(Short2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchNone(Short2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchAll(Short2BooleanFunction filter) {
	 ...
	 */
	public ShortAsyncBuilder findFirst(Short2BooleanFunction filter) {
	 ...
	 */
	public IntAsyncBuilder count(Short2BooleanFunction filter) {
	...
	private static class MatchTask extends BaseBooleanTask
	{
		...
		public MatchTask(ShortIterator iter, Short2BooleanFunction filter, int type) {
			this.iter = iter;
			this.filter = filter;
			this.type = type;
	...
	private static class FindFirstTask extends BaseShortTask
	{
		...
		public FindFirstTask(ShortIterator iter, Short2BooleanFunction filter) {
			this.iter = iter;
			this.filter = filter;
		}
	...
	private static class CountTask extends BaseIntTask
	{
		...
		public CountTask(ShortIterator iter, Short2BooleanFunction filter) {
			this.iter = iter;
			this.filter = filter;
		}
