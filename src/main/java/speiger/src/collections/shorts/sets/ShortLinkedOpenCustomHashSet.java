...
public class ShortLinkedOpenCustomHashSet extends ShortOpenCustomHashSet implements ShortOrderedSet
{
	...
	public boolean moveToFirst(short o) {
		if(isEmpty() || strategy.equals(getFirstShort(), o)) return false;
		if(strategy.equals(o, (short)0)) {
			if(containsNull) {
				moveToFirstIndex(nullIndex);
				return true;
	...
	public boolean moveToLast(short o) {
		if(isEmpty() || strategy.equals(getLastShort(), o)) return false;
		if(strategy.equals(o, (short)0)) {
			if(containsNull) {
				moveToLastIndex(nullIndex);
				return true;
	...
	public Object[] toArray() {
		...
		for(int i = 0, index = firstIndex;index != -1;i++,index = (int)links[index]) {
			obj[i] = Short.valueOf(keys[index]);
		}
		return obj;
	}
	...
	public <E> E[] toArray(E[] a) {
		...
		for(int i = 0, index = firstIndex;index != -1;i++,index = (int)links[index]) {
			a[i] = (E)Short.valueOf(keys[index]);
		}
