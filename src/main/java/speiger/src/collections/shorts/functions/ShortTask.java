...
public interface ShortTask extends RunnableFuture<Short> {
	...
	@Override
	@Deprecated
	public default Short get() throws InterruptedException, ExecutionException { return Short.valueOf(getShort()); }
	
	@Override
	@Deprecated
	public default Short get(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException { return Short.valueOf(getShort(timeout, unit)); }
}