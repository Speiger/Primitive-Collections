...
public class BooleanArrays
{
	...
	/**
	 * A Helper function to convert a Primitive Array to a Boolean Array.
	 * @param a the array that should be converted
	 * @return a Boolean Array of the input array.
	 */
	public static Boolean[] wrap(boolean[] a) {
	 ...
	 * @return a Boolean Array of the input array.
	 */
	public static Boolean[] wrap(boolean[] a, int length) {
	 ...
	 * @return a Boolean Array of the input array.
	 */
	public static Boolean[] wrap(boolean[] a, int offset, int length) {
		SanityChecks.checkArrayCapacity(a.length, offset, length);
		Boolean[] result = new Boolean[length];
		for(int i = offset;i<length;i++)
			result[i] = Boolean.valueOf(a[i]);
		return result;
	}
	
	/**
	 * A Helper function to convert a Boolean Array to a boolean Array.
	 * @param a the array that should be converted
	 * @return a boolean Array of the input array.
	 */
	public static boolean[] unwrap(Boolean[] a) {
	 ...
	 * @return a boolean Array of the input array.
	 */
	public static boolean[] unwrap(Boolean[] a, int length) {
	 ...
	 * @return a boolean Array of the input array.
	 */
	public static boolean[] unwrap(Boolean[] a, int offset, int length) {
		SanityChecks.checkArrayCapacity(a.length, offset, length);
		boolean[] result = new boolean[length];
		for(int i = offset;i<length;i++)
			result[i] = a[i].booleanValue();
		return result;
	}
	 ...
	 */
	public static boolean[] pour(BooleanIterator iter) {
	 ...
	 */
	public static boolean[] pour(BooleanIterator iter, int max) {
		BooleanCollections.CollectionWrapper list = BooleanCollections.wrapper();
		BooleanIterators.pour(iter, list, max);
		return list.toBooleanArray(new boolean[list.size()]);
	}
	 ...
	 */
	public static int shiftDown(boolean[] data, int size, int index, BooleanComparator comp) {
		int half = size >>> 1;
		boolean value = data[index];
		if(comp != null) {
			while(index < half) {
				int child = (index << 1) + 1;
				boolean childValue = data[child];
				int right = child+1;
			...
			while(index < half) {
				...
				boolean childValue = data[child];
				int right = child+1;
				if(right < size && Boolean.compare(data[right], childValue) < 0) childValue = data[child = right];
				if(Boolean.compare(value, childValue) <= 0) break;
				data[index] = childValue;
				index = child;
			}
		}
	 ...
	 * @return the index the element was shifted to
	 */
	public static int shiftUp(boolean[] data, int index, BooleanComparator comp) {
		boolean value = data[index];
		if(comp != null) {
			while(index > 0) {
				int parent = (index - 1) >>> 1;
				boolean parentValue = data[parent];
			...
			while(index > 0) {
				int parent = (index - 1) >>> 1;
				boolean parentValue = data[parent];
				if(Boolean.compare(value, parentValue) >= 0) break;
				data[index] = parentValue;
				index = parent;
			}
		}
	 ...
	 */
	public static boolean[] heapify(boolean[] data, int size, BooleanComparator comp) {
	 ...
	 * @return the provided sorted array
	 */
	public static boolean[] shuffle(boolean[] array, int length) {
	 ...
	 * @return the provided sorted array
	 */
	public static boolean[] shuffle(boolean[] array, int offset, int length) {
	 ...
	 * @return the provided sorted array
	 */
	public static boolean[] shuffle(boolean[] array, int length, Random random) {
	 ...
	 * @return the provided sorted array
	 */
	public static boolean[] shuffle(boolean[] array, int offset, int length, Random random) {
		for(int i = length-1; i>=0;i--) {
			int p = offset + random.nextInt(i + 1);
			boolean t = array[offset+i];
	 ...
	 * @return the provided array
	 */
	public static boolean[] reverse(boolean[] array, int length) {
	 ...
	 * @return the provided array
	 */
	public static boolean[] reverse(boolean[] array, int offset, int length) {
	 ...
	 * @return input array.
	 */
	public static boolean[] stableSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void stableSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void stableSort(boolean[] array, int from, int to, BooleanComparator comp) {
	 ...
	 * @return input array
	 */
	public static boolean[] stableSort(boolean[] array) {
	 ...
	 * @param length the maxmium size of the array to be sorted
	 */
	public static void stableSort(boolean[] array, int length) {
	 ...
	 * @param to where the array should be sorted to
	 */
	public static void stableSort(boolean[] array, int from, int to) {
	 ...
	 * @return input array
	 */
	public static boolean[] unstableSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void unstableSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void unstableSort(boolean[] array, int from, int to, BooleanComparator comp) {
	 ...
	 * @return input array
	 */
	public static boolean[] unstableSort(boolean[] array) {
	 ...
	 * @param length the maxmium size of the array to be sorted
	 */
	public static void unstableSort(boolean[] array, int length) {
	 ...
	 * @param to where the array should be sorted to
	 */
	public static void unstableSort(boolean[] array, int from, int to) {
	 ...
	 * @return input array
	 */
	public static boolean[] insertionSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void insertionSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void insertionSort(boolean[] array, int from, int to, BooleanComparator comp) {
	 ...
	 * @return input array
	 */
	public static boolean[] insertionSort(boolean[] array) {
	 ...
	 * @param length the maxmium size of the array to be sorted
	 */
	public static void insertionSort(boolean[] array, int length) {
	 ...
	 * @param to where the array should be sorted to
	 */
	public static void insertionSort(boolean[] array, int from, int to) {
		for (int i = from+1;i<to; i++) {
			boolean current = array[i];
			int j = i - 1;
			while(j >= from && Boolean.compare(current, array[j]) < 0) {
				array[j+1] = array[j--];
			}
			array[j+1] = current;
		}
	 ...
	 * @return input array
	 */
	public static boolean[] selectionSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void selectionSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void selectionSort(boolean[] array, int from, int to, BooleanComparator comp) {
	 ...
	 * @return input array
	 */
	public static boolean[] selectionSort(boolean[] array) {
	 ...
	 * @param length the maxmium size of the array to be sorted
	 */
	public static void selectionSort(boolean[] array, int length) {
	 ...
	 * @param to where the array should be sorted to
	 */
	public static void selectionSort(boolean[] array, int from, int to) {
		for (int i = from,m=to-1; i < m; i++) {
			boolean min = array[i];
			int minId = i;
			for(int j = i+1; j < to; j++) {
				if(Boolean.compare(array[j], min) < 0) {
					min = array[j];
					minId = j;
				}
			}
	 ...
	 * @return input array
	 */
	public static boolean[] mergeSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void mergeSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void mergeSort(boolean[] array, boolean[] supp, int from, int to, BooleanComparator comp) {
	 ...
	 * @return input array
	 */
	public static boolean[] mergeSort(boolean[] array) {
	 ...
	 * @param length the maxmium size of the array to be sorted
	 */
	public static void mergeSort(boolean[] array, int length) {
	 ...
	 * @param to where the array should be sorted to
	 */
	public static void mergeSort(boolean[] array, boolean[] supp, int from, int to) {
		if(to - from < BASE_THRESHOLD) {
		...
		if(Boolean.compare(supp[mid - 1], supp[mid]) <= 0)
		{
			System.arraycopy(supp, from, array, from, to - from);
			return;
		}
		for(int p = from, q = mid;from < to;from++) {
			if(q >= to || p < mid && Boolean.compare(supp[p], supp[q]) < 0) array[from] = supp[p++];
			else array[from] = supp[q++];
		}
	}
	 ...
	 */
	public static void parallelMergeSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMergeSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMergeSort(boolean[] array, boolean[] supp, int from, int to, BooleanComparator comp) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMergeSort(boolean[] array, int length) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMergeSort(boolean[] array, boolean[] supp, int from, int to) {
		if(SanityChecks.canParallelTask() && to - from >= PARALLEL_THRESHOLD) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void memFreeMergeSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void memFreeMergeSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void memFreeMergeSort(boolean[] array, int from, int to, BooleanComparator comp) {
		if(to - from < BASE_THRESHOLD) {
			insertionSort(array, from, to, comp);
			return;
		}
	 ...
	 * @param length the maxmium size of the array to be sorted
	 */
	public static void memFreeMergeSort(boolean[] array, int length) {
	 ...
	 * @param to where the array should be sorted to
	 */
	public static void memFreeMergeSort(boolean[] array, int from, int to) {
		if(to - from < BASE_THRESHOLD) {
			insertionSort(array, from, to);
			return;
		}
		...
		if(Boolean.compare(array[mid - 1], array[mid]) <= 0)
			return;
		for(int i = from, j = mid, comp;i < j && j < to;) {
			if((comp = Boolean.compare(array[i], array[j])) < 0)
				i++;
			else if(comp == 0) swap(array, ++i, j);
			else {
				int k = j;
				for(;k < to - 1 && Boolean.compare(array[i], array[k + 1]) > 0;k++);
				if(j == k) {
					swap(array, i++, j);
					continue;
				}
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMemFreeMergeSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMemFreeMergeSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMemFreeMergeSort(boolean[] array, int from, int to, BooleanComparator comp) {
		if(SanityChecks.canParallelTask() && to - from >= PARALLEL_THRESHOLD) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMemFreeMergeSort(boolean[] array) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMemFreeMergeSort(boolean[] array, int length) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelMemFreeMergeSort(boolean[] array, int from, int to) {
		if(SanityChecks.canParallelTask() && to - from >= PARALLEL_THRESHOLD) {
	 ...
	 * @return input array
	 */
	public static boolean[] quickSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void quickSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @param comp the Comparator that decides the sorting order
	 */
	public static void quickSort(boolean[] array, int from, int to, BooleanComparator comp) {
		int length = to - from;
		if(length <= 0) return;
	 ...
	 * @param length the maxmium size of the array to be sorted
	 */
	public static void quickSort(boolean[] array, int length) {
	 ...
	 * @param to where the array should be sorted to
	 */
	public static void quickSort(boolean[] array, int from, int to) {
		int length = to - from;
		if(length <= 0) return;
		if(length < BASE_THRESHOLD) {
		...
		boolean pivot = array[length > 128 ? subMedium(array, from, from + (length / 2), to - 1, length / 8) : medium(array, from, from + (length / 2), to - 1)];
		int a = from, b = a, c = to - 1, d = c;
		for(int comp = 0;;swap(array, b++, c--)) {
			for(;b<=c && (comp = Boolean.compare(array[b], pivot)) <= 0;b++) {
				if(comp == 0) swap(array, a++, b);
			}
			for(;c>=b && (comp = Boolean.compare(array[c], pivot)) >= 0;c--) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelQuickSort(boolean[] array, BooleanComparator comp) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelQuickSort(boolean[] array, int length, BooleanComparator comp) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelQuickSort(boolean[] array, int from, int to, BooleanComparator comp) {
		if(SanityChecks.canParallelTask() && to - from >= PARALLEL_THRESHOLD) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelQuickSort(boolean[] array, int length) {
	 ...
	 * @note This parallelization is invoked through {@link SanityChecks#invokeTask} which the threadpool can be changed as needed
	 */
	public static void parallelQuickSort(boolean[] array, int from, int to) {
		if(SanityChecks.canParallelTask() && to - from >= PARALLEL_THRESHOLD) {
	...
	static void swap(boolean[] a, int from, int to) {
		boolean t = a[from];
		a[from] = a[to];
		a[to] = t;
	}
	
	static void swap(boolean[] a, int from, int to, int length) {
		to -= length;
	...
	static int medium(boolean[] data, int a, int b, int c, BooleanComparator comp) {
	...
	static int subMedium(boolean[] data, int a, int b, int c, int length) {
		return medium(data, medium(data, a, a + length, a + (length * 2)), medium(data, b - length, b, b + length), medium(data, c - (length * 2), c - length, c));
	}
	
	static int medium(boolean[] data, int a, int b, int c) {
		return Boolean.compare(data[a], data[b]) < 0 ? (Boolean.compare(data[b], data[c]) < 0 ? b : Boolean.compare(data[a], data[c]) < 0 ? c : a) : (Boolean.compare(data[b], data[c]) > 0 ? b : Boolean.compare(data[a], data[c]) > 0 ? c : a);
	}
