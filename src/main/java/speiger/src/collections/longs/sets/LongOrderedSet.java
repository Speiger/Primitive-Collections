...
public interface LongOrderedSet extends LongSet
{
	 ...
	 */
	public default LongOrderedSet synchronize() { return LongSets.synchronize(this); }
	 ...
	 * @see LongSets#synchronize
	 */
	public default LongOrderedSet synchronize(Object mutex) { return LongSets.synchronize(this, mutex); }
	 ...
	 */
	public default LongOrderedSet unmodifiable() { return LongSets.unmodifiable(this); }
