...
public interface LongTask extends RunnableFuture<Long> {
	...
	@Override
	@Deprecated
	public default Long get() throws InterruptedException, ExecutionException { return Long.valueOf(getLong()); }
	
	@Override
	@Deprecated
	public default Long get(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException { return Long.valueOf(getLong(timeout, unit)); }
}