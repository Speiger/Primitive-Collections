...
public class Long2DoubleMaps
{
	...
	public static class SingletonMap extends AbstractLong2DoubleMap {
		...
		@Override
		public double computeDoubleNonDefault(long key, LongDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public double computeDoubleIfAbsentNonDefault(long key, Long2DoubleFunction mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public double computeDoubleIfPresentNonDefault(long key, LongDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public double supplyDoubleIfAbsentNonDefault(long key, DoubleSupplier valueProvider) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Long2DoubleOrderedMap {
		...
		@Override
		public double putFirst(long key, double value) { throw new UnsupportedOperationException(); }
		@Override
		public double putLast(long key, double value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Long2DoubleMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Long2DoubleMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Long2DoubleMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Long2DoubleMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2DoubleMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Long2DoubleMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Long2DoubleMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Long2DoubleMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2DoubleMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Long2DoubleOrderedMap {
		...
		@Override
		public double putFirst(long key, double value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public double putLast(long key, double value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractLong2DoubleMap implements Long2DoubleMap {
		...
		@Override
		public double computeDoubleNonDefault(long key, LongDoubleUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeDoubleNonDefault(key, mappingFunction); } }
		@Override
		public double computeDoubleIfAbsentNonDefault(long key, Long2DoubleFunction mappingFunction) { synchronized(mutex) { return map.computeDoubleIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public double computeDoubleIfPresentNonDefault(long key, LongDoubleUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeDoubleIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public double supplyDoubleIfAbsentNonDefault(long key, DoubleSupplier valueProvider) { synchronized(mutex) { return map.supplyDoubleIfAbsentNonDefault(key, valueProvider); } }
		@Override
