...
public class Long2ObjectMaps
{
	...
	public static class UnmodifyableOrderedMap<V> extends UnmodifyableMap<V> implements Long2ObjectOrderedMap<V> {
		...
		@Override
		public Long2ObjectMap.Entry<V> firstEntry() { return map.firstEntry(); }
		@Override
		public Long2ObjectMap.Entry<V> lastEntry() { return map.lastEntry(); }
		@Override
		public Long2ObjectMap.Entry<V> pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Long2ObjectMap.Entry<V> pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet<V> extends UnmodifyableEntrySet<V> implements ObjectOrderedSet<Long2ObjectMap.Entry<V>>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Long2ObjectMap.Entry<V> getFirst() { return set.getFirst(); }
		@Override
		public Long2ObjectMap.Entry<V> removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2ObjectMap.Entry<V> getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap<V> extends SynchronizedMap<V> implements Long2ObjectOrderedMap<V> {
		...
		@Override
		public V putFirst(long key, V value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public V putLast(long key, V value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
