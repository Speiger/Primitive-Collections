...
public class LongAsyncBuilder
{
	 ...
	 */
	public <E> ObjectAsyncBuilder<E> map(Long2ObjectFunction<E> mapper) {
	 ...
	 * @return a new Builder Object with the mapped Iterable
	 */
	public <E, V extends Iterable<E>> ObjectAsyncBuilder<E> flatMap(Long2ObjectFunction<V> mapper) {
	 ...
	 * @return a new Builder Object with the mapped Iterable
	 */
	public <E> ObjectAsyncBuilder<E> arrayflatMap(Long2ObjectFunction<E[]> mapper) {
	 ...
	 */
	public LongAsyncBuilder filter(Long2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchAny(Long2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchNone(Long2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchAll(Long2BooleanFunction filter) {
	 ...
	 */
	public LongAsyncBuilder findFirst(Long2BooleanFunction filter) {
	 ...
	 */
	public IntAsyncBuilder count(Long2BooleanFunction filter) {
	...
	private static class MatchTask extends BaseBooleanTask
	{
		...
		public MatchTask(LongIterator iter, Long2BooleanFunction filter, int type) {
			this.iter = iter;
			this.filter = filter;
			this.type = type;
	...
	private static class FindFirstTask extends BaseLongTask
	{
		...
		public FindFirstTask(LongIterator iter, Long2BooleanFunction filter) {
			this.iter = iter;
			this.filter = filter;
		}
	...
	private static class CountTask extends BaseIntTask
	{
		...
		public CountTask(LongIterator iter, Long2BooleanFunction filter) {
			this.iter = iter;
			this.filter = filter;
		}
