...
public class Long2FloatMaps
{
	...
	public static class SingletonMap extends AbstractLong2FloatMap {
		...
		@Override
		public float computeFloatNonDefault(long key, LongFloatUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public float computeFloatIfAbsentNonDefault(long key, Long2FloatFunction mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public float computeFloatIfPresentNonDefault(long key, LongFloatUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public float supplyFloatIfAbsentNonDefault(long key, FloatSupplier valueProvider) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Long2FloatOrderedMap {
		...
		@Override
		public float putFirst(long key, float value) { throw new UnsupportedOperationException(); }
		@Override
		public float putLast(long key, float value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Long2FloatMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Long2FloatMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Long2FloatMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Long2FloatMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2FloatMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Long2FloatMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Long2FloatMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Long2FloatMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2FloatMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Long2FloatOrderedMap {
		...
		@Override
		public float putFirst(long key, float value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public float putLast(long key, float value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractLong2FloatMap implements Long2FloatMap {
		...
		@Override
		public float computeFloatNonDefault(long key, LongFloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatNonDefault(key, mappingFunction); } }
		@Override
		public float computeFloatIfAbsentNonDefault(long key, Long2FloatFunction mappingFunction) { synchronized(mutex) { return map.computeFloatIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public float computeFloatIfPresentNonDefault(long key, LongFloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public float supplyFloatIfAbsentNonDefault(long key, FloatSupplier valueProvider) { synchronized(mutex) { return map.supplyFloatIfAbsentNonDefault(key, valueProvider); } }
		@Override
