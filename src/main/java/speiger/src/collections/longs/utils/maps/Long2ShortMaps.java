...
public class Long2ShortMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Long2ShortOrderedMap {
		...
		@Override
		public short putFirst(long key, short value) { throw new UnsupportedOperationException(); }
		@Override
		public short putLast(long key, short value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Long2ShortMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Long2ShortMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Long2ShortMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Long2ShortMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2ShortMap.Entry>
	{
		...
		@Override
		public void addFirst(Long2ShortMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public void addLast(Long2ShortMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public ObjectBidirectionalIterator<Long2ShortMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Long2ShortMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Long2ShortMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2ShortMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Long2ShortOrderedMap {
		...
		@Override
		public short putFirst(long key, short value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public short putLast(long key, short value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractLong2ShortMap implements Long2ShortMap {
		...
		@Override
		public short computeShortNonDefault(long key, LongShortUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeShortNonDefault(key, mappingFunction); } }
		@Override
		public short computeShortIfAbsentNonDefault(long key, Long2ShortFunction mappingFunction) { synchronized(mutex) { return map.computeShortIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public short computeShortIfPresentNonDefault(long key, LongShortUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeShortIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public short supplyShortIfAbsentNonDefault(long key, ShortSupplier valueProvider) { synchronized(mutex) { return map.supplyShortIfAbsentNonDefault(key, valueProvider); } }
		@Override
