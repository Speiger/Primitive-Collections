...
public class Long2LongMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Long2LongOrderedMap {
		...
		@Override
		public long putFirst(long key, long value) { throw new UnsupportedOperationException(); }
		@Override
		public long putLast(long key, long value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Long2LongMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Long2LongMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Long2LongMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Long2LongMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2LongMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Long2LongMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Long2LongMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Long2LongMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2LongMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Long2LongOrderedMap {
		...
		@Override
		public long putFirst(long key, long value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public long putLast(long key, long value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractLong2LongMap implements Long2LongMap {
		...
		@Override
		public long computeLongIfAbsent(long key, LongUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeLongIfAbsent(key, mappingFunction); } }
		@Override
		...
		@Override
		public long computeLongNonDefault(long key, LongLongUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeLongNonDefault(key, mappingFunction); } }
		@Override
		public long computeLongIfAbsentNonDefault(long key, LongUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeLongIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public long computeLongIfPresentNonDefault(long key, LongLongUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeLongIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public long supplyLongIfAbsentNonDefault(long key, LongSupplier valueProvider) { synchronized(mutex) { return map.supplyLongIfAbsentNonDefault(key, valueProvider); } }
		@Override
