...
public class Long2ByteLinkedOpenCustomHashMap extends Long2ByteOpenCustomHashMap implements Long2ByteOrderedMap
{
	...
	public Long2ByteMap.Entry pollFirstEntry() {
		...
		size--;
		if(strategy.equals(result.getLongKey(), 0L)) {
			containsNull = false;
			keys[nullIndex] = 0L;
			values[nullIndex] = (byte)0;
		}
	...
	private class Values extends AbstractByteCollection implements ByteOrderedCollection {
		...
		@Override
		public int size() { return Long2ByteLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Long2ByteLinkedOpenCustomHashMap.this.clear(); }
		@Override
