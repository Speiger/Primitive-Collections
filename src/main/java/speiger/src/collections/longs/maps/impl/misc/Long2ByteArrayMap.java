...
public class Long2ByteArrayMap extends AbstractLong2ByteMap implements Long2ByteOrderedMap
{
	...
	public Long2ByteArrayMap(Long2ByteMap map) {
		this(map.size());
		for(ObjectIterator<Long2ByteMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
	...
	@Override
	public byte putFirst(long key, byte value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(0, key, value);
			size++;
	...
	@Override
	public byte putLast(long key, byte value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(size++, key, value);
			return getDefaultReturnValue();
	...
	private class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteOrderedMap.FastOrderedSet {
		@Override
		public void addFirst(Long2ByteMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public void addLast(Long2ByteMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Long2ByteMap.Entry getFirst() {
			return new BasicEntry(firstLongKey(), firstByteValue());
		}
		
		@Override
		public Long2ByteMap.Entry getLast() {
			return new BasicEntry(lastLongKey(), lastByteValue());
		}
		
		@Override
		public Long2ByteMap.Entry removeFirst() {
		...
		@Override
		public Long2ByteMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Long2ByteMap.Entry> reverseIterator() {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Long2ByteMap.Entry) {
					...
					return keys[index] == entry.getLongKey() && getByteValue() == entry.getByteValue();
				}
