...
public class Long2IntLinkedOpenCustomHashMap extends Long2IntOpenCustomHashMap implements Long2IntOrderedMap
{
	...
	private class MapEntrySet extends AbstractObjectSet<Long2IntMap.Entry> implements Long2IntOrderedMap.FastOrderedSet {
		...
		@Override
		public Long2IntMap.Entry getFirst() {
			return new BasicEntry(firstLongKey(), firstIntValue());
		}
		
		@Override
		public Long2IntMap.Entry getLast() {
			return new BasicEntry(lastLongKey(), lastIntValue());
		}
		
		@Override
		public Long2IntMap.Entry removeFirst() {
		...
		@Override
		public Long2IntMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Long2IntMap.Entry> reverseIterator() {
	...
	private class Values extends AbstractIntCollection implements IntOrderedCollection {
		...
		@Override
		public int size() { return Long2IntLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Long2IntLinkedOpenCustomHashMap.this.clear(); }
		@Override
