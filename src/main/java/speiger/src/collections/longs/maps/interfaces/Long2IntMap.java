...
public interface Long2IntMap extends Map<Long, Integer>, Long2IntFunction
{
	...
	/**
	 * A Helper method that allows to put int a Long2IntMap.Entry into a map.
	 ...
	 * @return the last present value or default return	value.
	 */
	public default Integer put(Map.Entry<Long, Integer> entry) {
		return put(entry.getKey().longValue(), entry.getValue().intValue());
	}
	...
	@Override
	public default int applyAsInt(long key) {
		return get(key);
	}
	/**
