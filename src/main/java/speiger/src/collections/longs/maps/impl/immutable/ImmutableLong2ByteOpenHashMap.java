...
public class ImmutableLong2ByteOpenHashMap extends AbstractLong2ByteMap implements Long2ByteOrderedMap
{
	...
	public ImmutableLong2ByteOpenHashMap(Long2ByteMap map, float loadFactor) {
		...
		byte[] values = new byte[keys.length];
		int index = 0;
		for(Long2ByteMap.Entry entry : getFastIterable(map)) {
	...
	@Override
	public byte putFirst(long key, byte value) { throw new UnsupportedOperationException(); }
	@Override
	public byte putLast(long key, byte value) { throw new UnsupportedOperationException(); }
	@Override
	...
	private class Values extends AbstractByteCollection implements ByteOrderedCollection {
		...
		@Override
		public int size() { return ImmutableLong2ByteOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
