...
public class Char2DoubleArrayMap extends AbstractChar2DoubleMap implements Char2DoubleOrderedMap
{
	...
	public Char2DoubleArrayMap(Char2DoubleMap map) {
		this(map.size());
		for(ObjectIterator<Char2DoubleMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
	...
	private class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements Char2DoubleOrderedMap.FastOrderedSet {
		...
		@Override
		public Char2DoubleMap.Entry removeFirst() {
		...
		@Override
		public Char2DoubleMap.Entry removeLast() {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Char2DoubleMap.Entry) {
					...
					return keys[index] == entry.getCharKey() && Double.doubleToLongBits(getDoubleValue()) == Double.doubleToLongBits(entry.getDoubleValue());
				}
