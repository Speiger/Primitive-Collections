...
public class ImmutableChar2DoubleOpenHashMap extends AbstractChar2DoubleMap implements Char2DoubleOrderedMap
{
	...
	public ImmutableChar2DoubleOpenHashMap(Char2DoubleMap map, float loadFactor) {
		...
		double[] values = new double[keys.length];
		int index = 0;
		for(Char2DoubleMap.Entry entry : getFastIterable(map)) {
	...
	private class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements Char2DoubleOrderedMap.FastOrderedSet {
		...
		@Override
		public Char2DoubleMap.Entry getFirst() {
			return new BasicEntry(firstCharKey(), firstDoubleValue());
		}
		
		@Override
		public Char2DoubleMap.Entry getLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Char2DoubleMap.Entry> reverseIterator() {
	...
	private class Values extends AbstractDoubleCollection implements DoubleOrderedCollection {
		...
		@Override
		public int size() { return ImmutableChar2DoubleOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
