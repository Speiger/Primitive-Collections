...
public class Char2ShortLinkedOpenCustomHashMap extends Char2ShortOpenCustomHashMap implements Char2ShortOrderedMap
{
	...
	public Char2ShortMap.Entry pollFirstEntry() {
		...
		size--;
		if(strategy.equals(result.getCharKey(), (char)0)) {
			containsNull = false;
			keys[nullIndex] = (char)0;
			values[nullIndex] = (short)0;
		}
	...
	private class MapEntrySet extends AbstractObjectSet<Char2ShortMap.Entry> implements Char2ShortOrderedMap.FastOrderedSet {
		...
		@Override
		public Char2ShortMap.Entry removeFirst() {
		...
		@Override
		public Char2ShortMap.Entry removeLast() {
	...
	private class Values extends AbstractShortCollection implements ShortOrderedCollection {
		...
		@Override
		public int size() { return Char2ShortLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Char2ShortLinkedOpenCustomHashMap.this.clear(); }
		@Override
