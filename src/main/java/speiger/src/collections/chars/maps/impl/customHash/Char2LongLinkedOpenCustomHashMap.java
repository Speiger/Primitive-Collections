...
public class Char2LongLinkedOpenCustomHashMap extends Char2LongOpenCustomHashMap implements Char2LongOrderedMap
{
	...
	@Override
	public long putFirst(char key, long value) {
		if(strategy.equals(key, (char)0)) {
	...
	@Override
	public long putLast(char key, long value) {
		if(strategy.equals(key, (char)0)) {
			if(containsNull) return values[nullIndex];
			values[nullIndex] = value;
			containsNull = true;
	...
	private class MapEntrySet extends AbstractObjectSet<Char2LongMap.Entry> implements Char2LongOrderedMap.FastOrderedSet {
		...
		@Override
		public Char2LongMap.Entry getFirst() {
			return new BasicEntry(firstCharKey(), firstLongValue());
		}
		
		@Override
		public Char2LongMap.Entry getLast() {
			return new BasicEntry(lastCharKey(), lastLongValue());
		}
		
		@Override
		public Char2LongMap.Entry removeFirst() {
		...
		@Override
		public Char2LongMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Char2LongMap.Entry> reverseIterator() {
	...
	private class Values extends AbstractLongCollection implements LongOrderedCollection {
		...
		@Override
		public int size() { return Char2LongLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Char2LongLinkedOpenCustomHashMap.this.clear(); }
		@Override
