...
public class Char2ObjectRBTreeMap<V> extends AbstractChar2ObjectMap<V> implements Char2ObjectNavigableMap<V>
{
	...
	static abstract class NavigableSubMap<V> extends AbstractChar2ObjectMap<V> implements Char2ObjectNavigableMap<V>
	{
		...
		protected char lowKeyOrNull(Node<V> entry) { return entry == null ? (char)0 : entry.key; }
		protected char highKeyOrNull(Node<V> entry) { return entry == null ? (char)0 : entry.key; }
