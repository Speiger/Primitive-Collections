...
public class Char2ObjectLinkedOpenCustomHashMap<V> extends Char2ObjectOpenCustomHashMap<V> implements Char2ObjectOrderedMap<V>
{
	...
	private class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements Char2ObjectOrderedMap.FastOrderedSet<V> {
		...
		@Override
		public Char2ObjectMap.Entry<V> removeFirst() {
		...
		@Override
		public Char2ObjectMap.Entry<V> removeLast() {
	...
	private class Values extends AbstractObjectCollection<V> implements ObjectOrderedCollection<V> {
		...
		@Override
		public int size() { return Char2ObjectLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Char2ObjectLinkedOpenCustomHashMap.this.clear(); }
		@Override
