...
public class Char2IntLinkedOpenCustomHashMap extends Char2IntOpenCustomHashMap implements Char2IntOrderedMap
{
	...
	private class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntOrderedMap.FastOrderedSet {
		...
		@Override
		public Char2IntMap.Entry removeFirst() {
		...
		@Override
		public Char2IntMap.Entry removeLast() {
	...
	private class Values extends AbstractIntCollection implements IntOrderedCollection {
		...
		@Override
		public int size() { return Char2IntLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Char2IntLinkedOpenCustomHashMap.this.clear(); }
		@Override
