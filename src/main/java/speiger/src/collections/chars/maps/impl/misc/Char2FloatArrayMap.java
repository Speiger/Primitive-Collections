...
public class Char2FloatArrayMap extends AbstractChar2FloatMap implements Char2FloatOrderedMap
{
	...
	public Char2FloatArrayMap(Char2FloatMap map) {
		this(map.size());
		for(ObjectIterator<Char2FloatMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Char2FloatMap.Entry) {
					...
					return keys[index] == entry.getCharKey() && Float.floatToIntBits(getFloatValue()) == Float.floatToIntBits(entry.getFloatValue());
				}
