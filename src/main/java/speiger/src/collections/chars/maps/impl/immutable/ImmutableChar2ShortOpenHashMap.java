...
public class ImmutableChar2ShortOpenHashMap extends AbstractChar2ShortMap implements Char2ShortOrderedMap
{
	...
	public ImmutableChar2ShortOpenHashMap(Char2ShortMap map, float loadFactor) {
		...
		short[] values = new short[keys.length];
		int index = 0;
		for(Char2ShortMap.Entry entry : getFastIterable(map)) {
	...
	private class MapEntrySet extends AbstractObjectSet<Char2ShortMap.Entry> implements Char2ShortOrderedMap.FastOrderedSet {
		...
		@Override
		public Char2ShortMap.Entry getFirst() {
			return new BasicEntry(firstCharKey(), firstShortValue());
		}
		
		@Override
		public Char2ShortMap.Entry getLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Char2ShortMap.Entry> reverseIterator() {
	...
	private class Values extends AbstractShortCollection implements ShortOrderedCollection {
		...
		@Override
		public int size() { return ImmutableChar2ShortOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
