...
public class ImmutableChar2IntOpenHashMap extends AbstractChar2IntMap implements Char2IntOrderedMap
{
	...
	public ImmutableChar2IntOpenHashMap(Char2IntMap map, float loadFactor) {
		...
		int[] values = new int[keys.length];
		int index = 0;
		for(Char2IntMap.Entry entry : getFastIterable(map)) {
	...
	private class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntOrderedMap.FastOrderedSet {
		...
		@Override
		public Char2IntMap.Entry getFirst() {
			return new BasicEntry(firstCharKey(), firstIntValue());
		}
		
		@Override
		public Char2IntMap.Entry getLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Char2IntMap.Entry> reverseIterator() {
	...
	private class Values extends AbstractIntCollection implements IntOrderedCollection {
		...
		@Override
		public int size() { return ImmutableChar2IntOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
