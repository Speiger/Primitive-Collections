...
public class Char2LongMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Char2LongOrderedMap {
		...
		@Override
		public long putFirst(char key, long value) { throw new UnsupportedOperationException(); }
		@Override
		public long putLast(char key, long value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Char2LongMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Char2LongMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Char2LongMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Char2LongMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Char2LongMap.Entry>
	{
		...
		@Override
		public void addFirst(Char2LongMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public void addLast(Char2LongMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public ObjectBidirectionalIterator<Char2LongMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Char2LongMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Char2LongMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Char2LongMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Char2LongOrderedMap {
		...
		@Override
		public long putFirst(char key, long value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public long putLast(char key, long value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractChar2LongMap implements Char2LongMap {
		...
		@Override
		public long computeLongNonDefault(char key, CharLongUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeLongNonDefault(key, mappingFunction); } }
		@Override
		public long computeLongIfAbsentNonDefault(char key, Char2LongFunction mappingFunction) { synchronized(mutex) { return map.computeLongIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public long computeLongIfPresentNonDefault(char key, CharLongUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeLongIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public long supplyLongIfAbsentNonDefault(char key, LongSupplier valueProvider) { synchronized(mutex) { return map.supplyLongIfAbsentNonDefault(key, valueProvider); } }
		@Override
