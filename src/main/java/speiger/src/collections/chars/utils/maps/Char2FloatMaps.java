...
public class Char2FloatMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Char2FloatOrderedMap {
		...
		@Override
		public float putFirst(char key, float value) { throw new UnsupportedOperationException(); }
		@Override
		public float putLast(char key, float value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Char2FloatMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Char2FloatMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Char2FloatMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Char2FloatMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Char2FloatMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Char2FloatMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Char2FloatMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Char2FloatMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Char2FloatMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Char2FloatOrderedMap {
		...
		@Override
		public float putFirst(char key, float value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public float putLast(char key, float value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractChar2FloatMap implements Char2FloatMap {
		...
		@Override
		public float computeFloatNonDefault(char key, CharFloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatNonDefault(key, mappingFunction); } }
		@Override
		public float computeFloatIfAbsentNonDefault(char key, Char2FloatFunction mappingFunction) { synchronized(mutex) { return map.computeFloatIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public float computeFloatIfPresentNonDefault(char key, CharFloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public float supplyFloatIfAbsentNonDefault(char key, FloatSupplier valueProvider) { synchronized(mutex) { return map.supplyFloatIfAbsentNonDefault(key, valueProvider); } }
		@Override
