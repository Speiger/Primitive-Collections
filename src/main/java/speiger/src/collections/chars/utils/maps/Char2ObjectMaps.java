...
public class Char2ObjectMaps
{
	...
	public static class SynchronizedMap<V> extends AbstractChar2ObjectMap<V> implements Char2ObjectMap<V> {
		...
		@Override
		public V computeNonDefault(char key, CharObjectUnaryOperator<V> mappingFunction) { synchronized(mutex) { return map.computeNonDefault(key, mappingFunction); } }
		@Override
		...
		@Override
		public V computeIfAbsentNonDefault(char key, CharFunction<V> mappingFunction) { synchronized(mutex) { return map.computeIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		...
		@Override
		public V computeIfPresentNonDefault(char key, CharObjectUnaryOperator<V> mappingFunction) { synchronized(mutex) { return map.computeIfPresentNonDefault(key, mappingFunction); } }
		@Override
		...
		@Override
		public V supplyIfAbsentNonDefault(char key, ObjectSupplier<V> valueProvider) { synchronized(mutex) { return map.supplyIfAbsentNonDefault(key, valueProvider); } }
		@Override
