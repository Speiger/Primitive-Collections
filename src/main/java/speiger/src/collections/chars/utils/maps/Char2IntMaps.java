...
public class Char2IntMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Char2IntOrderedMap {
		...
		@Override
		public int putFirst(char key, int value) { throw new UnsupportedOperationException(); }
		@Override
		public int putLast(char key, int value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Char2IntMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Char2IntMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Char2IntMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Char2IntMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Char2IntMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Char2IntMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Char2IntMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Char2IntMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Char2IntMap.Entry getLast() { return set.getLast(); }
		@Override
		public Char2IntMap.Entry removeLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Char2IntOrderedMap {
		...
		@Override
		public int putFirst(char key, int value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public int putLast(char key, int value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractChar2IntMap implements Char2IntMap {
		...
		@Override
		public int computeIntNonDefault(char key, CharIntUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeIntNonDefault(key, mappingFunction); } }
		@Override
		public int computeIntIfAbsentNonDefault(char key, Char2IntFunction mappingFunction) { synchronized(mutex) { return map.computeIntIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public int computeIntIfPresentNonDefault(char key, CharIntUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeIntIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public int supplyIntIfAbsentNonDefault(char key, IntSupplier valueProvider) { synchronized(mutex) { return map.supplyIntIfAbsentNonDefault(key, valueProvider); } }
		@Override
