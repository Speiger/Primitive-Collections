...
public interface CharTask extends RunnableFuture<Character> {
	...
	@Override
	@Deprecated
	public default Character get() throws InterruptedException, ExecutionException { return Character.valueOf(getChar()); }
	
	@Override
	@Deprecated
	public default Character get(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException { return Character.valueOf(getChar(timeout, unit)); }
}