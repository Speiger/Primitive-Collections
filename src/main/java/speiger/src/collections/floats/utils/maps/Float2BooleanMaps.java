...
public class Float2BooleanMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Float2BooleanOrderedMap {
		...
		@Override
		public boolean putFirst(float key, boolean value) { throw new UnsupportedOperationException(); }
		@Override
		public boolean putLast(float key, boolean value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Float2BooleanMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Float2BooleanMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Float2BooleanMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Float2BooleanMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Float2BooleanMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Float2BooleanMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Float2BooleanMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Float2BooleanMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Float2BooleanMap.Entry getLast() { return set.getLast(); }
		@Override
		public Float2BooleanMap.Entry removeLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Float2BooleanOrderedMap {
		...
		@Override
		public boolean putFirst(float key, boolean value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public boolean putLast(float key, boolean value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
