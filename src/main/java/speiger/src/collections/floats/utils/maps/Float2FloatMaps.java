...
public class Float2FloatMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Float2FloatOrderedMap {
		...
		@Override
		public Float2FloatMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Float2FloatMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Float2FloatMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Float2FloatMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Float2FloatMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Float2FloatMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Float2FloatMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Float2FloatMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Float2FloatMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Float2FloatOrderedMap {
		...
		@Override
		public float putFirst(float key, float value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public float putLast(float key, float value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractFloat2FloatMap implements Float2FloatMap {
		...
		@Override
		public float computeFloatIfAbsent(float key, FloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatIfAbsent(key, mappingFunction); } }
		@Override
		...
		@Override
		public float computeFloatNonDefault(float key, FloatFloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatNonDefault(key, mappingFunction); } }
		@Override
		public float computeFloatIfAbsentNonDefault(float key, FloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public float computeFloatIfPresentNonDefault(float key, FloatFloatUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeFloatIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public float supplyFloatIfAbsentNonDefault(float key, FloatSupplier valueProvider) { synchronized(mutex) { return map.supplyFloatIfAbsentNonDefault(key, valueProvider); } }
		@Override
