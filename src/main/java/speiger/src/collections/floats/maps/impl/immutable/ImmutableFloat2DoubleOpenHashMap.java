...
public class ImmutableFloat2DoubleOpenHashMap extends AbstractFloat2DoubleMap implements Float2DoubleOrderedMap
{
	...
	public ImmutableFloat2DoubleOpenHashMap(Float2DoubleMap map, float loadFactor) {
		...
		double[] values = new double[keys.length];
		int index = 0;
		for(Float2DoubleMap.Entry entry : getFastIterable(map)) {
	...
	private class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry> implements Float2DoubleOrderedMap.FastOrderedSet {
		...
		@Override
		public Optional<Float2DoubleMap.Entry> reduce(ObjectObjectUnaryOperator<Float2DoubleMap.Entry, Float2DoubleMap.Entry> operator) {
			Objects.requireNonNull(operator);
		...
		@Override
		public Optional<Float2DoubleMap.Entry> findFirst(Predicate<Float2DoubleMap.Entry> filter) {
			Objects.requireNonNull(filter);
	...
	private class Values extends AbstractDoubleCollection implements DoubleOrderedCollection {
		...
		@Override
		public int size() { return ImmutableFloat2DoubleOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
