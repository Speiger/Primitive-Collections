...
public class Float2ShortArrayMap extends AbstractFloat2ShortMap implements Float2ShortOrderedMap
{
	...
	public Float2ShortArrayMap(Float2ShortMap map) {
		this(map.size());
		for(ObjectIterator<Float2ShortMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
	...
	private class MapEntrySet extends AbstractObjectSet<Float2ShortMap.Entry> implements Float2ShortOrderedMap.FastOrderedSet {
		...
		@Override
		public Float2ShortMap.Entry getFirst() {
			return new BasicEntry(firstFloatKey(), firstShortValue());
		}
		
		@Override
		public Float2ShortMap.Entry getLast() {
			return new BasicEntry(lastFloatKey(), lastShortValue());
		}
		
		@Override
		public Float2ShortMap.Entry removeFirst() {
		...
		@Override
		public Float2ShortMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Float2ShortMap.Entry> reverseIterator() {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Float2ShortMap.Entry) {
					...
					return Float.floatToIntBits(keys[index]) == Float.floatToIntBits(entry.getFloatKey()) && getShortValue() == entry.getShortValue();
				}
