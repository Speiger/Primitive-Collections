...
public abstract class AbstractFloat2ByteMap extends AbstractMap<Float, Byte> implements Float2ByteMap
{
	...
	protected ObjectIterable<Float2ByteMap.Entry> getFastIterable(Float2ByteMap map) {
		return Float2ByteMaps.fastIterable(map);
	}
	
	protected ObjectIterator<Float2ByteMap.Entry> getFastIterator(Float2ByteMap map) {
		return Float2ByteMaps.fastIterator(map);
	}
	...
	public void addToAll(Float2ByteMap m) {
		for(Float2ByteMap.Entry entry : getFastIterable(m))
			addTo(entry.getFloatKey(), entry.getByteValue());
	}
	
	@Override
	public void putAll(Float2ByteMap m) {
		for(ObjectIterator<Float2ByteMap.Entry> iter = getFastIterator(m);iter.hasNext();) {
	...
	public void replaceBytes(FloatByteUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Float2ByteMap.Entry> iter = getFastIterator(this);iter.hasNext();) {
			Float2ByteMap.Entry entry = iter.next();
		...
		return new AbstractFloatSet() {
			...
			public FloatIterator iterator() {
				return new FloatIterator() {
					ObjectIterator<Float2ByteMap.Entry> iter = getFastIterator(AbstractFloat2ByteMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Float2ByteMap.Entry> iter = getFastIterator(this);
