...
public class Float2ByteArrayMap extends AbstractFloat2ByteMap implements Float2ByteOrderedMap
{
	...
	public Float2ByteArrayMap(Float2ByteMap map) {
		this(map.size());
		for(ObjectIterator<Float2ByteMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
	...
	private class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteOrderedMap.FastOrderedSet {
		...
		@Override
		public Float2ByteMap.Entry removeFirst() {
		...
		@Override
		public Float2ByteMap.Entry removeLast() {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Float2ByteMap.Entry) {
					...
					return Float.floatToIntBits(keys[index]) == Float.floatToIntBits(entry.getFloatKey()) && getByteValue() == entry.getByteValue();
				}
