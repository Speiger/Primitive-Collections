...
public class Float2BooleanLinkedOpenCustomHashMap extends Float2BooleanOpenCustomHashMap implements Float2BooleanOrderedMap
{
	...
	@Override
	public boolean putFirst(float key, boolean value) {
		if(strategy.equals(key, 0F)) {
	...
	@Override
	public boolean putLast(float key, boolean value) {
		if(strategy.equals(key, 0F)) {
			if(containsNull) return values[nullIndex];
			values[nullIndex] = value;
			containsNull = true;
	...
	private class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements Float2BooleanOrderedMap.FastOrderedSet {
		...
		@Override
		public Float2BooleanMap.Entry removeFirst() {
		...
		@Override
		public Float2BooleanMap.Entry removeLast() {
	...
	private class Values extends AbstractBooleanCollection implements BooleanOrderedCollection {
		...
		@Override
		public int size() { return Float2BooleanLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Float2BooleanLinkedOpenCustomHashMap.this.clear(); }
		@Override
