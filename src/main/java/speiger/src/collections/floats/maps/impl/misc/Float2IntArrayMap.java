...
public class Float2IntArrayMap extends AbstractFloat2IntMap implements Float2IntOrderedMap
{
	...
	public Float2IntArrayMap(Float2IntMap map) {
		this(map.size());
		for(ObjectIterator<Float2IntMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
	...
	@Override
	public int putFirst(float key, int value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(0, key, value);
			size++;
	...
	@Override
	public int putLast(float key, int value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(size++, key, value);
			return getDefaultReturnValue();
	...
	private class MapEntrySet extends AbstractObjectSet<Float2IntMap.Entry> implements Float2IntOrderedMap.FastOrderedSet {
		...
		@Override
		public Float2IntMap.Entry getFirst() {
			return new BasicEntry(firstFloatKey(), firstIntValue());
		}
		
		@Override
		public Float2IntMap.Entry getLast() {
			return new BasicEntry(lastFloatKey(), lastIntValue());
		}
		
		@Override
		public Float2IntMap.Entry removeFirst() {
		...
		@Override
		public Float2IntMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Float2IntMap.Entry> reverseIterator() {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Float2IntMap.Entry) {
					...
					return Float.floatToIntBits(keys[index]) == Float.floatToIntBits(entry.getFloatKey()) && getIntValue() == entry.getIntValue();
				}
