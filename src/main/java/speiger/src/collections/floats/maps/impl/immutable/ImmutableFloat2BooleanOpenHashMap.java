...
public class ImmutableFloat2BooleanOpenHashMap extends AbstractFloat2BooleanMap implements Float2BooleanOrderedMap
{
	...
	public ImmutableFloat2BooleanOpenHashMap(Float2BooleanMap map, float loadFactor) {
		...
		boolean[] values = new boolean[keys.length];
		int index = 0;
		for(Float2BooleanMap.Entry entry : getFastIterable(map)) {
	...
	private class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements Float2BooleanOrderedMap.FastOrderedSet {
		...
		@Override
		public Float2BooleanMap.Entry getFirst() {
			return new BasicEntry(firstFloatKey(), firstBooleanValue());
		}
		
		@Override
		public Float2BooleanMap.Entry getLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Float2BooleanMap.Entry> reverseIterator() {
	...
	private class Values extends AbstractBooleanCollection implements BooleanOrderedCollection {
		...
		@Override
		public int size() { return ImmutableFloat2BooleanOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
