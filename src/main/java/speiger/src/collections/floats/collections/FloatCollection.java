...
public interface FloatCollection extends Collection<Float>, FloatIterable, ISizeProvider
{
	 ...
	 */
	public default boolean addAll(float... e) { return addAll(e, 0, e.length); }
	 ...
	 * @return if the collection was modified
	 */
	public default boolean addAll(float[] e, int length) { return addAll(e, 0, length); }
	 ...
	 * @return if the collection was modified
	 */
	public default boolean addAll(float[] e, int offset, int length) {
	...
	/**
	 * A Type-Specific toArray function that delegates to {@link #toFloatArray(float[])} with a newly created array.
	...
	@Override
	@Deprecated
	public default boolean removeIf(Predicate<? super Float> filter) {
		Objects.requireNonNull(filter);
		return remIf(v -> filter.test(Float.valueOf(SanityChecks.castToFloat(v))));
	}
	...
	@Override
	@Deprecated
	public default boolean add(Float o) { return add(o.floatValue()); }
	...
	@Override
	@Deprecated
	public default boolean contains(Object o) { return o != null && contains(((Float)o).floatValue()); }
	...
	@Override
	@Deprecated
	public default boolean remove(Object o) { return o != null && remFloat(((Float)o).floatValue()); }
	 ...
	 * @see FloatCollections#synchronize
	 */
	public default FloatCollection synchronize() { return FloatCollections.synchronize(this); }
	 ...
	 * @see FloatCollections#synchronize
	 */
	public default FloatCollection synchronize(Object mutex) { return FloatCollections.synchronize(this, mutex); }
	
	/**
	 * Creates a Wrapped Collection that is unmodifiable
	 * @return a new Collection Wrapper that is unmodifiable
	 * @see FloatCollections#unmodifiable
	 */
	public default FloatCollection unmodifiable() { return FloatCollections.unmodifiable(this); }
	
	/**
	 * Returns a Java-Type-Specific Stream to reduce boxing/unboxing.
	 * @return a Stream of the closest java type
	 */
	default DoubleStream primitiveStream() { return StreamSupport.doubleStream(FloatSplititerators.createJavaSplititerator(this, 0), false); }
	
	/**
	 * Returns a Java-Type-Specific Parallel Stream to reduce boxing/unboxing.
	 * @return a Stream of the closest java type
	 */
	default DoubleStream parallelPrimitiveStream() { return StreamSupport.doubleStream(FloatSplititerators.createJavaSplititerator(this, 0), true); }
