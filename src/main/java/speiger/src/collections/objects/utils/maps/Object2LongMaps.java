...
public class Object2LongMaps
{
	...
	public static class UnmodifyableOrderedMap<T> extends UnmodifyableMap<T> implements Object2LongOrderedMap<T> {
		...
		@Override
		public Object2LongMap.Entry<T> firstEntry() { return map.firstEntry(); }
		@Override
		public Object2LongMap.Entry<T> lastEntry() { return map.lastEntry(); }
		@Override
		public Object2LongMap.Entry<T> pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Object2LongMap.Entry<T> pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet<T> extends UnmodifyableEntrySet<T> implements ObjectOrderedSet<Object2LongMap.Entry<T>>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Object2LongMap.Entry<T>> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Object2LongMap.Entry<T> getFirst() { return set.getFirst(); }
		@Override
		public Object2LongMap.Entry<T> removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Object2LongMap.Entry<T> getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap<T> extends SynchronizedMap<T> implements Object2LongOrderedMap<T> {
		...
		@Override
		public long putFirst(T key, long value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public long putLast(T key, long value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
