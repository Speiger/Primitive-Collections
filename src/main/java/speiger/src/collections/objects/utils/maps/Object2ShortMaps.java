...
public class Object2ShortMaps
{
	...
	public static class SingletonMap<T> extends AbstractObject2ShortMap<T> {
		...
		@Override
		public short computeShortIfAbsent(T key, ToShortFunction<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public short computeShortNonDefault(T key, ObjectShortUnaryOperator<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public short computeShortIfAbsentNonDefault(T key, ToShortFunction<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public short computeShortIfPresentNonDefault(T key, ObjectShortUnaryOperator<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public short supplyShortIfAbsentNonDefault(T key, ShortSupplier valueProvider) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class UnmodifyableOrderedMap<T> extends UnmodifyableMap<T> implements Object2ShortOrderedMap<T> {
		...
		@Override
		public short putFirst(T key, short value) { throw new UnsupportedOperationException(); }
		@Override
		public short putLast(T key, short value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Object2ShortMap.Entry<T> firstEntry() { return map.firstEntry(); }
		@Override
		public Object2ShortMap.Entry<T> lastEntry() { return map.lastEntry(); }
		@Override
		public Object2ShortMap.Entry<T> pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Object2ShortMap.Entry<T> pollLastEntry() { throw new UnsupportedOperationException(); }
		...
		public ShortOrderedCollection values() {
			...
			return (ShortOrderedCollection)values;
		}
		@Override
	...
	public static class UnmodifyableOrderedEntrySet<T> extends UnmodifyableEntrySet<T> implements ObjectOrderedSet<Object2ShortMap.Entry<T>>
	{
		...
		@Override
		public void addFirst(Object2ShortMap.Entry<T> o) { throw new UnsupportedOperationException(); }
		@Override
		public void addLast(Object2ShortMap.Entry<T> o) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public ObjectBidirectionalIterator<Object2ShortMap.Entry<T>> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Object2ShortMap.Entry<T> getFirst() { return set.getFirst(); }
		@Override
		public Object2ShortMap.Entry<T> removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Object2ShortMap.Entry<T> getLast() { return set.getLast(); }
		@Override
		public Object2ShortMap.Entry<T> removeLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedOrderedMap<T> extends SynchronizedMap<T> implements Object2ShortOrderedMap<T> {
		...
		@Override
		public short putFirst(T key, short value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public short putLast(T key, short value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap<T> extends AbstractObject2ShortMap<T> implements Object2ShortMap<T> {
		...
		@Override
		public short computeShortIfAbsent(T key, ToShortFunction<T> mappingFunction) { synchronized(mutex) { return map.computeShortIfAbsent(key, mappingFunction); } }
		@Override
		...
		@Override
		public short computeShortNonDefault(T key, ObjectShortUnaryOperator<T> mappingFunction) { synchronized(mutex) { return map.computeShortNonDefault(key, mappingFunction); } }
		@Override
		public short computeShortIfAbsentNonDefault(T key, ToShortFunction<T> mappingFunction) { synchronized(mutex) { return map.computeShortIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public short computeShortIfPresentNonDefault(T key, ObjectShortUnaryOperator<T> mappingFunction) { synchronized(mutex) { return map.computeShortIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public short supplyShortIfAbsentNonDefault(T key, ShortSupplier valueProvider) { synchronized(mutex) { return map.supplyShortIfAbsentNonDefault(key, valueProvider); } }
		@Override
