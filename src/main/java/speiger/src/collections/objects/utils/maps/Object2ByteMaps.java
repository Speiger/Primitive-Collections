...
public class Object2ByteMaps
{
	...
	public static class UnmodifyableOrderedMap<T> extends UnmodifyableMap<T> implements Object2ByteOrderedMap<T> {
		...
		@Override
		public byte putFirst(T key, byte value) { throw new UnsupportedOperationException(); }
		@Override
		public byte putLast(T key, byte value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Object2ByteMap.Entry<T> firstEntry() { return map.firstEntry(); }
		@Override
		public Object2ByteMap.Entry<T> lastEntry() { return map.lastEntry(); }
		@Override
		public Object2ByteMap.Entry<T> pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Object2ByteMap.Entry<T> pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet<T> extends UnmodifyableEntrySet<T> implements ObjectOrderedSet<Object2ByteMap.Entry<T>>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Object2ByteMap.Entry<T>> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Object2ByteMap.Entry<T> getFirst() { return set.getFirst(); }
		@Override
		public Object2ByteMap.Entry<T> removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Object2ByteMap.Entry<T> getLast() { return set.getLast(); }
		@Override
		public Object2ByteMap.Entry<T> removeLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedOrderedMap<T> extends SynchronizedMap<T> implements Object2ByteOrderedMap<T> {
		...
		@Override
		public byte putFirst(T key, byte value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public byte putLast(T key, byte value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap<T> extends AbstractObject2ByteMap<T> implements Object2ByteMap<T> {
		...
		@Override
		public byte computeByteIfAbsent(T key, ToByteFunction<T> mappingFunction) { synchronized(mutex) { return map.computeByteIfAbsent(key, mappingFunction); } }
		@Override
		...
		@Override
		public byte computeByteNonDefault(T key, ObjectByteUnaryOperator<T> mappingFunction) { synchronized(mutex) { return map.computeByteNonDefault(key, mappingFunction); } }
		@Override
		public byte computeByteIfAbsentNonDefault(T key, ToByteFunction<T> mappingFunction) { synchronized(mutex) { return map.computeByteIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public byte computeByteIfPresentNonDefault(T key, ObjectByteUnaryOperator<T> mappingFunction) { synchronized(mutex) { return map.computeByteIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public byte supplyByteIfAbsentNonDefault(T key, ByteSupplier valueProvider) { synchronized(mutex) { return map.supplyByteIfAbsentNonDefault(key, valueProvider); } }
		@Override
