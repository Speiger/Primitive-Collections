...
public interface ObjectOrderedSet<T> extends ObjectSet<T>
{
	 ...
	 */
	public default ObjectOrderedSet<T> synchronize() { return ObjectSets.synchronize(this); }
	 ...
	 * @see ObjectSets#synchronize
	 */
	public default ObjectOrderedSet<T> synchronize(Object mutex) { return ObjectSets.synchronize(this, mutex); }
	 ...
	 */
	public default ObjectOrderedSet<T> unmodifiable() { return ObjectSets.unmodifiable(this); }
