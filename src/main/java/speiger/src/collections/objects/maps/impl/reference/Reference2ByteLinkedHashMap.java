 ...
 */
public class Reference2ByteLinkedHashMap<T> extends Reference2ByteHashMap<T> implements Object2ByteOrderedMap<T>
{
	 ...
	 * Default Constructor
	 */
	public Reference2ByteLinkedHashMap() {
	 ...
	 */
	public Reference2ByteLinkedHashMap(int minCapacity) {
	 ...
	 */
	public Reference2ByteLinkedHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Reference2ByteLinkedHashMap(T[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2ByteLinkedHashMap(T[] keys, Byte[] values, float loadFactor) {
	 ...
	 */
	public Reference2ByteLinkedHashMap(Map<? extends T, ? extends Byte> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2ByteLinkedHashMap(Map<? extends T, ? extends Byte> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Reference2ByteLinkedHashMap(Object2ByteMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Reference2ByteLinkedHashMap(Object2ByteMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Reference2ByteLinkedHashMap<T> copy() {
		Reference2ByteLinkedHashMap<T> map = new Reference2ByteLinkedHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2ByteMap.Entry<T>> implements Object2ByteOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2ByteMap.Entry<T> o) {
			return Reference2ByteLinkedHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2ByteMap.Entry<T> o) {
			return Reference2ByteLinkedHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ByteMap.Entry) {
					...
					int index = Reference2ByteLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getByteValue() == Reference2ByteLinkedHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Reference2ByteLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Reference2ByteLinkedHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ByteMap.Entry) {
					Object2ByteMap.Entry<T> entry = (Object2ByteMap.Entry<T>)o;
					return Reference2ByteLinkedHashMap.this.remove(entry.getKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Reference2ByteLinkedHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Reference2ByteLinkedHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Reference2ByteLinkedHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Reference2ByteLinkedHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Reference2ByteLinkedHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Reference2ByteLinkedHashMap.this.moveToLast(o);
		}
	...
	private class Values extends AbstractByteCollection implements ByteOrderedCollection {
		...
		@Override
		public int size() { return Reference2ByteLinkedHashMap.this.size(); }
		@Override
		public void clear() { Reference2ByteLinkedHashMap.this.clear(); }
		@Override
