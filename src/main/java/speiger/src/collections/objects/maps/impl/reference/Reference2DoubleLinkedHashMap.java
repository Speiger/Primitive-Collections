 ...
 */
public class Reference2DoubleLinkedHashMap<T> extends Reference2DoubleHashMap<T> implements Object2DoubleOrderedMap<T>
{
	 ...
	 * Default Constructor
	 */
	public Reference2DoubleLinkedHashMap() {
	 ...
	 */
	public Reference2DoubleLinkedHashMap(int minCapacity) {
	 ...
	 */
	public Reference2DoubleLinkedHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Reference2DoubleLinkedHashMap(T[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2DoubleLinkedHashMap(T[] keys, Double[] values, float loadFactor) {
	 ...
	 */
	public Reference2DoubleLinkedHashMap(Map<? extends T, ? extends Double> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2DoubleLinkedHashMap(Map<? extends T, ? extends Double> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Reference2DoubleLinkedHashMap(Object2DoubleMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Reference2DoubleLinkedHashMap(Object2DoubleMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Reference2DoubleLinkedHashMap<T> copy() {
		Reference2DoubleLinkedHashMap<T> map = new Reference2DoubleLinkedHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry<T>> implements Object2DoubleOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2DoubleMap.Entry<T> o) {
			return Reference2DoubleLinkedHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2DoubleMap.Entry<T> o) {
			return Reference2DoubleLinkedHashMap.this.moveToLast(o.getKey());
		}
		
		@Override
		public Object2DoubleMap.Entry<T> getFirst() {
			return new BasicEntry<>(firstKey(), firstDoubleValue());
		}
		
		@Override
		public Object2DoubleMap.Entry<T> getLast() {
			return new BasicEntry<>(lastKey(), lastDoubleValue());
		}
		
		@Override
		public Object2DoubleMap.Entry<T> removeFirst() {
		...
		@Override
		public Object2DoubleMap.Entry<T> removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Object2DoubleMap.Entry<T>> reverseIterator() {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2DoubleMap.Entry) {
					...
					int index = Reference2DoubleLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Reference2DoubleLinkedHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Reference2DoubleLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Reference2DoubleLinkedHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2DoubleMap.Entry) {
					Object2DoubleMap.Entry<T> entry = (Object2DoubleMap.Entry<T>)o;
					return Reference2DoubleLinkedHashMap.this.remove(entry.getKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Reference2DoubleLinkedHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Reference2DoubleLinkedHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Reference2DoubleLinkedHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Reference2DoubleLinkedHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Reference2DoubleLinkedHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Reference2DoubleLinkedHashMap.this.moveToLast(o);
		}
	...
	private class Values extends AbstractDoubleCollection implements DoubleOrderedCollection {
		...
		@Override
		public int size() { return Reference2DoubleLinkedHashMap.this.size(); }
		@Override
		public void clear() { Reference2DoubleLinkedHashMap.this.clear(); }
		@Override
