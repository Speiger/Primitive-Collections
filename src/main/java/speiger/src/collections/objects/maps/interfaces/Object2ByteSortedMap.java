...
public interface Object2ByteSortedMap<T> extends SortedMap<T, Byte>, Object2ByteMap<T>
{
	...
	@Override
	public default Object2ByteSortedMap<T> subMap(T fromKey, T toKey) { return subMap(fromKey, toKey); }
	@Override
	public default Object2ByteSortedMap<T> headMap(T toKey) { return headMap(toKey); }
	@Override
	public default Object2ByteSortedMap<T> tailMap(T fromKey) { return tailMap(fromKey); }
