 ...
 */
public class Reference2BooleanLinkedHashMap<T> extends Reference2BooleanHashMap<T> implements Object2BooleanOrderedMap<T>
{
	 ...
	 * Default Constructor
	 */
	public Reference2BooleanLinkedHashMap() {
	 ...
	 */
	public Reference2BooleanLinkedHashMap(int minCapacity) {
	 ...
	 */
	public Reference2BooleanLinkedHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Reference2BooleanLinkedHashMap(T[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2BooleanLinkedHashMap(T[] keys, Boolean[] values, float loadFactor) {
	 ...
	 */
	public Reference2BooleanLinkedHashMap(Map<? extends T, ? extends Boolean> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2BooleanLinkedHashMap(Map<? extends T, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Reference2BooleanLinkedHashMap(Object2BooleanMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Reference2BooleanLinkedHashMap(Object2BooleanMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Reference2BooleanLinkedHashMap<T> copy() {
		Reference2BooleanLinkedHashMap<T> map = new Reference2BooleanLinkedHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2BooleanMap.Entry<T>> implements Object2BooleanOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2BooleanMap.Entry<T> o) {
			return Reference2BooleanLinkedHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2BooleanMap.Entry<T> o) {
			return Reference2BooleanLinkedHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2BooleanMap.Entry) {
					...
					int index = Reference2BooleanLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getBooleanValue() == Reference2BooleanLinkedHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Reference2BooleanLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Reference2BooleanLinkedHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2BooleanMap.Entry) {
					Object2BooleanMap.Entry<T> entry = (Object2BooleanMap.Entry<T>)o;
					return Reference2BooleanLinkedHashMap.this.remove(entry.getKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Reference2BooleanLinkedHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Reference2BooleanLinkedHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Reference2BooleanLinkedHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Reference2BooleanLinkedHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Reference2BooleanLinkedHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Reference2BooleanLinkedHashMap.this.moveToLast(o);
		}
	...
	private class Values extends AbstractBooleanCollection implements BooleanOrderedCollection {
		...
		@Override
		public int size() { return Reference2BooleanLinkedHashMap.this.size(); }
		@Override
		public void clear() { Reference2BooleanLinkedHashMap.this.clear(); }
		@Override
