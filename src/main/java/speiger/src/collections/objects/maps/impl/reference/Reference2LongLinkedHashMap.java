 ...
 */
public class Reference2LongLinkedHashMap<T> extends Reference2LongHashMap<T> implements Object2LongOrderedMap<T>
{
	 ...
	 * Default Constructor
	 */
	public Reference2LongLinkedHashMap() {
	 ...
	 */
	public Reference2LongLinkedHashMap(int minCapacity) {
	 ...
	 */
	public Reference2LongLinkedHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Reference2LongLinkedHashMap(T[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2LongLinkedHashMap(T[] keys, Long[] values, float loadFactor) {
	 ...
	 */
	public Reference2LongLinkedHashMap(Map<? extends T, ? extends Long> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2LongLinkedHashMap(Map<? extends T, ? extends Long> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Reference2LongLinkedHashMap(Object2LongMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Reference2LongLinkedHashMap(Object2LongMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Reference2LongLinkedHashMap<T> copy() {
		Reference2LongLinkedHashMap<T> map = new Reference2LongLinkedHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2LongMap.Entry<T>> implements Object2LongOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2LongMap.Entry<T> o) {
			return Reference2LongLinkedHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2LongMap.Entry<T> o) {
			return Reference2LongLinkedHashMap.this.moveToLast(o.getKey());
		}
		...
		@Override
		public Object2LongMap.Entry<T> removeFirst() {
		...
		@Override
		public Object2LongMap.Entry<T> removeLast() {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2LongMap.Entry) {
					...
					int index = Reference2LongLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getLongValue() == Reference2LongLinkedHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Reference2LongLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Reference2LongLinkedHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2LongMap.Entry) {
					Object2LongMap.Entry<T> entry = (Object2LongMap.Entry<T>)o;
					return Reference2LongLinkedHashMap.this.remove(entry.getKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Reference2LongLinkedHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Reference2LongLinkedHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Reference2LongLinkedHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Reference2LongLinkedHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Reference2LongLinkedHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Reference2LongLinkedHashMap.this.moveToLast(o);
		}
	...
	private class Values extends AbstractLongCollection implements LongOrderedCollection {
		...
		@Override
		public int size() { return Reference2LongLinkedHashMap.this.size(); }
		@Override
		public void clear() { Reference2LongLinkedHashMap.this.clear(); }
		@Override
