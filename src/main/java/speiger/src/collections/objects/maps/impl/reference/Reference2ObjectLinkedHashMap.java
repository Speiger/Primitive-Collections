 ...
 */
public class Reference2ObjectLinkedHashMap<T, V> extends Reference2ObjectHashMap<T, V> implements Object2ObjectOrderedMap<T, V>
{
	 ...
	 * Default Constructor
	 */
	public Reference2ObjectLinkedHashMap() {
	 ...
	 */
	public Reference2ObjectLinkedHashMap(int minCapacity) {
	 ...
	 */
	public Reference2ObjectLinkedHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Reference2ObjectLinkedHashMap(T[] keys, V[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2ObjectLinkedHashMap(T[] keys, V[] values, float loadFactor) {
	 ...
	 */
	public Reference2ObjectLinkedHashMap(Map<? extends T, ? extends V> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2ObjectLinkedHashMap(Map<? extends T, ? extends V> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Reference2ObjectLinkedHashMap(Object2ObjectMap<T, V> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Reference2ObjectLinkedHashMap(Object2ObjectMap<T, V> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Reference2ObjectLinkedHashMap<T, V> copy() {
		Reference2ObjectLinkedHashMap<T, V> map = new Reference2ObjectLinkedHashMap<>(0, loadFactor);
	...
	public Object2ObjectMap.Entry<T, V> pollFirstEntry() {
		...
		int pos = firstIndex;
		onNodeRemoved(pos);
		BasicEntry<T, V> result = new BasicEntry<>(keys[pos].get(), values[pos]);
		size--;
		shiftKeys(pos);
		if(capacity > minCapacity && size < maxFill / 4 && capacity > HashUtil.DEFAULT_MIN_CAPACITY) rehash(capacity / 2);
		return result;
	...
	private class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<T, V>> implements Object2ObjectOrderedMap.FastOrderedSet<T, V> {
		...
		public boolean moveToFirst(Object2ObjectMap.Entry<T, V> o) {
			return Reference2ObjectLinkedHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2ObjectMap.Entry<T, V> o) {
			return Reference2ObjectLinkedHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ObjectMap.Entry) {
					...
					int index = Reference2ObjectLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Reference2ObjectLinkedHashMap.this.values[index]);
				}
				else {
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ObjectMap.Entry) {
					Object2ObjectMap.Entry<T, V> entry = (Object2ObjectMap.Entry<T, V>)o;
					return Reference2ObjectLinkedHashMap.this.remove(entry.getKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Reference2ObjectLinkedHashMap.this.remove(entry.getKey(), entry.getValue());
			}
		...
		@Override
		public int size() {
			return Reference2ObjectLinkedHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Reference2ObjectLinkedHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Reference2ObjectLinkedHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Reference2ObjectLinkedHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Reference2ObjectLinkedHashMap.this.moveToLast(o);
		}
	...
	private class Values extends AbstractObjectCollection<V> implements ObjectOrderedCollection<V> {
		...
		@Override
		public int size() { return Reference2ObjectLinkedHashMap.this.size(); }
		@Override
		public void clear() { Reference2ObjectLinkedHashMap.this.clear(); }
		@Override
