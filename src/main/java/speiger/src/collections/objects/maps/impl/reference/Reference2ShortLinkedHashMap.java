 ...
 */
public class Reference2ShortLinkedHashMap<T> extends Reference2ShortHashMap<T> implements Object2ShortOrderedMap<T>
{
	 ...
	 * Default Constructor
	 */
	public Reference2ShortLinkedHashMap() {
	 ...
	 */
	public Reference2ShortLinkedHashMap(int minCapacity) {
	 ...
	 */
	public Reference2ShortLinkedHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Reference2ShortLinkedHashMap(T[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2ShortLinkedHashMap(T[] keys, Short[] values, float loadFactor) {
	 ...
	 */
	public Reference2ShortLinkedHashMap(Map<? extends T, ? extends Short> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2ShortLinkedHashMap(Map<? extends T, ? extends Short> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Reference2ShortLinkedHashMap(Object2ShortMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Reference2ShortLinkedHashMap(Object2ShortMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Reference2ShortLinkedHashMap<T> copy() {
		Reference2ShortLinkedHashMap<T> map = new Reference2ShortLinkedHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<T>> implements Object2ShortOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2ShortMap.Entry<T> o) {
			return Reference2ShortLinkedHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2ShortMap.Entry<T> o) {
			return Reference2ShortLinkedHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ShortMap.Entry) {
					...
					int index = Reference2ShortLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getShortValue() == Reference2ShortLinkedHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Reference2ShortLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Reference2ShortLinkedHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ShortMap.Entry) {
					Object2ShortMap.Entry<T> entry = (Object2ShortMap.Entry<T>)o;
					return Reference2ShortLinkedHashMap.this.remove(entry.getKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Reference2ShortLinkedHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Reference2ShortLinkedHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Reference2ShortLinkedHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Reference2ShortLinkedHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Reference2ShortLinkedHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Reference2ShortLinkedHashMap.this.moveToLast(o);
		}
	...
	private class Values extends AbstractShortCollection implements ShortOrderedCollection {
		...
		@Override
		public int size() { return Reference2ShortLinkedHashMap.this.size(); }
		@Override
		public void clear() { Reference2ShortLinkedHashMap.this.clear(); }
		@Override
