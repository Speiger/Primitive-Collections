 ...
 */
public class Reference2FloatLinkedHashMap<T> extends Reference2FloatHashMap<T> implements Object2FloatOrderedMap<T>
{
	 ...
	 * Default Constructor
	 */
	public Reference2FloatLinkedHashMap() {
	 ...
	 */
	public Reference2FloatLinkedHashMap(int minCapacity) {
	 ...
	 */
	public Reference2FloatLinkedHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Reference2FloatLinkedHashMap(T[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2FloatLinkedHashMap(T[] keys, Float[] values, float loadFactor) {
	 ...
	 */
	public Reference2FloatLinkedHashMap(Map<? extends T, ? extends Float> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2FloatLinkedHashMap(Map<? extends T, ? extends Float> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Reference2FloatLinkedHashMap(Object2FloatMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Reference2FloatLinkedHashMap(Object2FloatMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public float putFirst(T key, float value) {
		Objects.requireNonNull(key);
		int pos = HashUtil.mix(Objects.hashCode(key)) & mask;
		while(keys[pos] != null) {
	...
	@Override
	public float putLast(T key, float value) {
		Objects.requireNonNull(key);
		int pos = HashUtil.mix(Objects.hashCode(key)) & mask;
		while(keys[pos] != null) {
			if(Objects.equals(keys[pos].get(), key)) return values[pos];
	...
	@Override
	public Reference2FloatLinkedHashMap<T> copy() {
		Reference2FloatLinkedHashMap<T> map = new Reference2FloatLinkedHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2FloatMap.Entry<T>> implements Object2FloatOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2FloatMap.Entry<T> o) {
			return Reference2FloatLinkedHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2FloatMap.Entry<T> o) {
			return Reference2FloatLinkedHashMap.this.moveToLast(o.getKey());
		}
		
		@Override
		public Object2FloatMap.Entry<T> getFirst() {
			return new BasicEntry<>(firstKey(), firstFloatValue());
		}
		
		@Override
		public Object2FloatMap.Entry<T> getLast() {
			return new BasicEntry<>(lastKey(), lastFloatValue());
		}
		
		@Override
		public Object2FloatMap.Entry<T> removeFirst() {
		...
		@Override
		public Object2FloatMap.Entry<T> removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Object2FloatMap.Entry<T>> reverseIterator() {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2FloatMap.Entry) {
					...
					int index = Reference2FloatLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Float.floatToIntBits(entry.getFloatValue()) == Float.floatToIntBits(Reference2FloatLinkedHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Reference2FloatLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float.valueOf(Reference2FloatLinkedHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2FloatMap.Entry) {
					Object2FloatMap.Entry<T> entry = (Object2FloatMap.Entry<T>)o;
					return Reference2FloatLinkedHashMap.this.remove(entry.getKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Reference2FloatLinkedHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Reference2FloatLinkedHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Reference2FloatLinkedHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Reference2FloatLinkedHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Reference2FloatLinkedHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Reference2FloatLinkedHashMap.this.moveToLast(o);
		}
	...
	private class Values extends AbstractFloatCollection implements FloatOrderedCollection {
		...
		@Override
		public int size() { return Reference2FloatLinkedHashMap.this.size(); }
		@Override
		public void clear() { Reference2FloatLinkedHashMap.this.clear(); }
		@Override
