 ...
 */
public class Reference2CharLinkedHashMap<T> extends Reference2CharHashMap<T> implements Object2CharOrderedMap<T>
{
	 ...
	 * Default Constructor
	 */
	public Reference2CharLinkedHashMap() {
	 ...
	 */
	public Reference2CharLinkedHashMap(int minCapacity) {
	 ...
	 */
	public Reference2CharLinkedHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Reference2CharLinkedHashMap(T[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2CharLinkedHashMap(T[] keys, Character[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Reference2CharLinkedHashMap(T[] keys, char[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2CharLinkedHashMap(T[] keys, char[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Reference2CharLinkedHashMap(Map<? extends T, ? extends Character> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Reference2CharLinkedHashMap(Map<? extends T, ? extends Character> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Reference2CharLinkedHashMap(Object2CharMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Reference2CharLinkedHashMap(Object2CharMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public char putFirst(T key, char value) {
		Objects.requireNonNull(key);
		int pos = HashUtil.mix(Objects.hashCode(key)) & mask;
		while(keys[pos] != null) {
	...
	@Override
	public char putLast(T key, char value) {
		Objects.requireNonNull(key);
		int pos = HashUtil.mix(Objects.hashCode(key)) & mask;
		while(keys[pos] != null) {
			if(Objects.equals(keys[pos].get(), key)) return values[pos];
	...
	@Override
	public Reference2CharLinkedHashMap<T> copy() {
		Reference2CharLinkedHashMap<T> map = new Reference2CharLinkedHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2CharMap.Entry<T>> implements Object2CharOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2CharMap.Entry<T> o) {
			return Reference2CharLinkedHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2CharMap.Entry<T> o) {
			return Reference2CharLinkedHashMap.this.moveToLast(o.getKey());
		}
		
		@Override
		public Object2CharMap.Entry<T> getFirst() {
			return new BasicEntry<>(firstKey(), firstCharValue());
		}
		
		@Override
		public Object2CharMap.Entry<T> getLast() {
			return new BasicEntry<>(lastKey(), lastCharValue());
		}
		
		@Override
		public Object2CharMap.Entry<T> removeFirst() {
		...
		@Override
		public Object2CharMap.Entry<T> removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Object2CharMap.Entry<T>> reverseIterator() {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2CharMap.Entry) {
					...
					int index = Reference2CharLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getCharValue() == Reference2CharLinkedHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Reference2CharLinkedHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Reference2CharLinkedHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2CharMap.Entry) {
					Object2CharMap.Entry<T> entry = (Object2CharMap.Entry<T>)o;
					return Reference2CharLinkedHashMap.this.remove(entry.getKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Reference2CharLinkedHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Reference2CharLinkedHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Reference2CharLinkedHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Reference2CharLinkedHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Reference2CharLinkedHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Reference2CharLinkedHashMap.this.moveToLast(o);
		}
	...
	private class Values extends AbstractCharCollection implements CharOrderedCollection {
		...
		@Override
		public int size() { return Reference2CharLinkedHashMap.this.size(); }
		@Override
		public void clear() { Reference2CharLinkedHashMap.this.clear(); }
		@Override
