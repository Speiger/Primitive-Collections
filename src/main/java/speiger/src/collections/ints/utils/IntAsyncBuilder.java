...
public class IntAsyncBuilder
{
	 ...
	 */
	public <E> ObjectAsyncBuilder<E> map(Int2ObjectFunction<E> mapper) {
	 ...
	 * @return a new Builder Object with the mapped Iterable
	 */
	public <E, V extends Iterable<E>> ObjectAsyncBuilder<E> flatMap(Int2ObjectFunction<V> mapper) {
	 ...
	 * @return a new Builder Object with the mapped Iterable
	 */
	public <E> ObjectAsyncBuilder<E> arrayflatMap(Int2ObjectFunction<E[]> mapper) {
	 ...
	 */
	public IntAsyncBuilder filter(Int2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchAny(Int2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchNone(Int2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchAll(Int2BooleanFunction filter) {
	 ...
	 */
	public IntAsyncBuilder findFirst(Int2BooleanFunction filter) {
	 ...
	 */
	public IntAsyncBuilder count(Int2BooleanFunction filter) {
	...
	private static class MatchTask extends BaseBooleanTask
	{
		...
		public MatchTask(IntIterator iter, Int2BooleanFunction filter, int type) {
			this.iter = iter;
			this.filter = filter;
			this.type = type;
	...
	private static class FindFirstTask extends BaseIntTask
	{
		...
		public FindFirstTask(IntIterator iter, Int2BooleanFunction filter) {
			this.iter = iter;
			this.filter = filter;
		}
	...
	private static class CountTask extends BaseIntTask
	{
		...
		public CountTask(IntIterator iter, Int2BooleanFunction filter) {
			this.iter = iter;
			this.filter = filter;
		}
