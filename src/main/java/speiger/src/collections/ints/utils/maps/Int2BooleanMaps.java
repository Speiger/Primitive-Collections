...
public class Int2BooleanMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Int2BooleanOrderedMap {
		...
		@Override
		public boolean putFirst(int key, boolean value) { throw new UnsupportedOperationException(); }
		@Override
		public boolean putLast(int key, boolean value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Int2BooleanMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Int2BooleanMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Int2BooleanMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Int2BooleanMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Int2BooleanMap.Entry>
	{
		...
		@Override
		public void addFirst(Int2BooleanMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public void addLast(Int2BooleanMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public ObjectBidirectionalIterator<Int2BooleanMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Int2BooleanMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Int2BooleanMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Int2BooleanMap.Entry getLast() { return set.getLast(); }
		@Override
		public Int2BooleanMap.Entry removeLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Int2BooleanOrderedMap {
		...
		@Override
		public boolean putFirst(int key, boolean value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public boolean putLast(int key, boolean value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractInt2BooleanMap implements Int2BooleanMap {
		...
		@Override
		public boolean computeBooleanIfAbsent(int key, IntPredicate mappingFunction) { synchronized(mutex) { return map.computeBooleanIfAbsent(key, mappingFunction); } }
		@Override
		...
		@Override
		public boolean computeBooleanNonDefault(int key, IntBooleanUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeBooleanNonDefault(key, mappingFunction); } }
		@Override
		public boolean computeBooleanIfAbsentNonDefault(int key, IntPredicate mappingFunction) { synchronized(mutex) { return map.computeBooleanIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public boolean computeBooleanIfPresentNonDefault(int key, IntBooleanUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeBooleanIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public boolean supplyBooleanIfAbsentNonDefault(int key, BooleanSupplier valueProvider) { synchronized(mutex) { return map.supplyBooleanIfAbsentNonDefault(key, valueProvider); } }
		@Override
