...
public class Int2ShortMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Int2ShortOrderedMap {
		...
		@Override
		public short putFirst(int key, short value) { throw new UnsupportedOperationException(); }
		@Override
		public short putLast(int key, short value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Int2ShortMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Int2ShortMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Int2ShortMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Int2ShortMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Int2ShortMap.Entry>
	{
		...
		@Override
		public void addFirst(Int2ShortMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public void addLast(Int2ShortMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public ObjectBidirectionalIterator<Int2ShortMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Int2ShortMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Int2ShortMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Int2ShortMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Int2ShortOrderedMap {
		...
		@Override
		public short putFirst(int key, short value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public short putLast(int key, short value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractInt2ShortMap implements Int2ShortMap {
		...
		@Override
		public short computeShortNonDefault(int key, IntShortUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeShortNonDefault(key, mappingFunction); } }
		@Override
		public short computeShortIfAbsentNonDefault(int key, Int2ShortFunction mappingFunction) { synchronized(mutex) { return map.computeShortIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public short computeShortIfPresentNonDefault(int key, IntShortUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeShortIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public short supplyShortIfAbsentNonDefault(int key, ShortSupplier valueProvider) { synchronized(mutex) { return map.supplyShortIfAbsentNonDefault(key, valueProvider); } }
		@Override
