...
public class Int2ByteMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Int2ByteOrderedMap {
		...
		@Override
		public byte putFirst(int key, byte value) { throw new UnsupportedOperationException(); }
		@Override
		public byte putLast(int key, byte value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Int2ByteMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Int2ByteMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Int2ByteMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Int2ByteMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Int2ByteMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Int2ByteMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Int2ByteMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Int2ByteMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Int2ByteMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Int2ByteOrderedMap {
		...
		@Override
		public byte putFirst(int key, byte value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public byte putLast(int key, byte value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractInt2ByteMap implements Int2ByteMap {
		...
		@Override
		public byte computeByteNonDefault(int key, IntByteUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeByteNonDefault(key, mappingFunction); } }
		@Override
		public byte computeByteIfAbsentNonDefault(int key, Int2ByteFunction mappingFunction) { synchronized(mutex) { return map.computeByteIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public byte computeByteIfPresentNonDefault(int key, IntByteUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeByteIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public byte supplyByteIfAbsentNonDefault(int key, ByteSupplier valueProvider) { synchronized(mutex) { return map.supplyByteIfAbsentNonDefault(key, valueProvider); } }
		@Override
