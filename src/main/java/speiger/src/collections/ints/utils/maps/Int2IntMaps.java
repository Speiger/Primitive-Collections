...
public class Int2IntMaps
{
	...
	public static class SingletonMap extends AbstractInt2IntMap {
		...
		@Override
		public int computeIntIfAbsent(int key, IntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public int computeIntNonDefault(int key, IntIntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public int computeIntIfAbsentNonDefault(int key, IntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public int computeIntIfPresentNonDefault(int key, IntIntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public int supplyIntIfAbsentNonDefault(int key, IntSupplier valueProvider) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Int2IntOrderedMap {
		...
		@Override
		public int putFirst(int key, int value) { throw new UnsupportedOperationException(); }
		@Override
		public int putLast(int key, int value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Int2IntMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Int2IntMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Int2IntMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Int2IntMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Int2IntMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Int2IntMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Int2IntMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Int2IntMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Int2IntMap.Entry getLast() { return set.getLast(); }
		@Override
		public Int2IntMap.Entry removeLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Int2IntOrderedMap {
		...
		@Override
		public int putFirst(int key, int value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public int putLast(int key, int value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractInt2IntMap implements Int2IntMap {
		...
		@Override
		public int computeIntIfAbsent(int key, IntUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeIntIfAbsent(key, mappingFunction); } }
		@Override
		...
		@Override
		public int computeIntNonDefault(int key, IntIntUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeIntNonDefault(key, mappingFunction); } }
		@Override
		public int computeIntIfAbsentNonDefault(int key, IntUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeIntIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		public int computeIntIfPresentNonDefault(int key, IntIntUnaryOperator mappingFunction) { synchronized(mutex) { return map.computeIntIfPresentNonDefault(key, mappingFunction); } }
		@Override
		public int supplyIntIfAbsentNonDefault(int key, IntSupplier valueProvider) { synchronized(mutex) { return map.supplyIntIfAbsentNonDefault(key, valueProvider); } }
		@Override
