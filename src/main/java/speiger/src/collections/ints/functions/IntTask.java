 ...
 */
public interface IntTask extends RunnableFuture<Integer> {
	/**
	...
	@Override
	@Deprecated
	public default Integer get() throws InterruptedException, ExecutionException { return Integer.valueOf(getInt()); }
	
	@Override
	@Deprecated
	public default Integer get(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException { return Integer.valueOf(getInt(timeout, unit)); }
}