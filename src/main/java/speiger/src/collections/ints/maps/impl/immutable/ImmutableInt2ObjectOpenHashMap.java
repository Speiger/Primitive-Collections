...
public class ImmutableInt2ObjectOpenHashMap<V> extends AbstractInt2ObjectMap<V> implements Int2ObjectOrderedMap<V>
{
	...
	public ImmutableInt2ObjectOpenHashMap(Int2ObjectMap<V> map, float loadFactor) {
		...
		V[] values = (V[])new Object[keys.length];
		int index = 0;
		for(Int2ObjectMap.Entry<V> entry : getFastIterable(map)) {
	...
	private class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectOrderedMap.FastOrderedSet<V> {
		@Override
		public void addFirst(Int2ObjectMap.Entry<V> o) { throw new UnsupportedOperationException(); }
		@Override
		public void addLast(Int2ObjectMap.Entry<V> o) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Int2ObjectMap.Entry<V> getFirst() {
			return new BasicEntry<>(firstIntKey(), firstValue());
		}
		
		@Override
		public Int2ObjectMap.Entry<V> getLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> reverseIterator() {
	...
	private class Values extends AbstractObjectCollection<V> implements ObjectOrderedCollection<V> {
		...
		@Override
		public int size() { return ImmutableInt2ObjectOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
