...
public interface Int2ByteMap extends Map<Integer, Byte>, Int2ByteFunction
{
	...
	/**
	 * A Helper method that allows to put int a Int2ByteMap.Entry into a map.
	 ...
	 * @return the last present value or default return	value.
	 */
	public default Byte put(Map.Entry<Integer, Byte> entry) {
		return put(entry.getKey().intValue(), entry.getValue().byteValue());
	}
	...
	@Override
	public default byte applyAsByte(int key) {
		return get(key);
	}
	/**
