...
public class Int2LongLinkedOpenCustomHashMap extends Int2LongOpenCustomHashMap implements Int2LongOrderedMap
{
	...
	private class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry> implements Int2LongOrderedMap.FastOrderedSet {
		...
		@Override
		public Int2LongMap.Entry removeFirst() {
		...
		@Override
		public Int2LongMap.Entry removeLast() {
	...
	private class Values extends AbstractLongCollection implements LongOrderedCollection {
		...
		@Override
		public int size() { return Int2LongLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Int2LongLinkedOpenCustomHashMap.this.clear(); }
		@Override
