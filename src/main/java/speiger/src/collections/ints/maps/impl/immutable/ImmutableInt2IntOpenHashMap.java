...
public class ImmutableInt2IntOpenHashMap extends AbstractInt2IntMap implements Int2IntOrderedMap
{
	...
	/** Values cache */
	protected transient IntOrderedCollection valuesC;
	...
	public ImmutableInt2IntOpenHashMap(Int2IntMap map, float loadFactor) {
		...
		int[] values = new int[keys.length];
		int index = 0;
		for(Int2IntMap.Entry entry : getFastIterable(map)) {
	...
	private class Values extends AbstractIntCollection implements IntOrderedCollection {
		...
		@Override
		public int size() { return ImmutableInt2IntOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
