...
public class ImmutableInt2LongOpenHashMap extends AbstractInt2LongMap implements Int2LongOrderedMap
{
	...
	public ImmutableInt2LongOpenHashMap(Int2LongMap map, float loadFactor) {
		...
		long[] values = new long[keys.length];
		int index = 0;
		for(Int2LongMap.Entry entry : getFastIterable(map)) {
	...
	private class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry> implements Int2LongOrderedMap.FastOrderedSet {
		...
		@Override
		public Int2LongMap.Entry getFirst() {
			return new BasicEntry(firstIntKey(), firstLongValue());
		}
		
		@Override
		public Int2LongMap.Entry getLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Int2LongMap.Entry> reverseIterator() {
	...
	private class Values extends AbstractLongCollection implements LongOrderedCollection {
		...
		@Override
		public int size() { return ImmutableInt2LongOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
