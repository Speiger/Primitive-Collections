...
public class Int2ObjectLinkedOpenCustomHashMap<V> extends Int2ObjectOpenCustomHashMap<V> implements Int2ObjectOrderedMap<V>
{
	...
	private class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectOrderedMap.FastOrderedSet<V> {
		...
		@Override
		public Int2ObjectMap.Entry<V> removeFirst() {
		...
		@Override
		public Int2ObjectMap.Entry<V> removeLast() {
	...
	private class Values extends AbstractObjectCollection<V> implements ObjectOrderedCollection<V> {
		...
		@Override
		public int size() { return Int2ObjectLinkedOpenCustomHashMap.this.size(); }
		@Override
		public void clear() { Int2ObjectLinkedOpenCustomHashMap.this.clear(); }
		@Override
