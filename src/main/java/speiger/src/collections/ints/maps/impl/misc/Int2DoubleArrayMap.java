...
public class Int2DoubleArrayMap extends AbstractInt2DoubleMap implements Int2DoubleOrderedMap
{
	...
	public Int2DoubleArrayMap(Int2DoubleMap map) {
		this(map.size());
		for(ObjectIterator<Int2DoubleMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Int2DoubleMap.Entry) {
					...
					return keys[index] == entry.getIntKey() && Double.doubleToLongBits(getDoubleValue()) == Double.doubleToLongBits(entry.getDoubleValue());
				}
