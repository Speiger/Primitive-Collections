...
public interface IntOrderedSet extends IntSet
{
	 ...
	 */
	public default IntOrderedSet synchronize() { return IntSets.synchronize(this); }
	 ...
	 * @see IntSets#synchronize
	 */
	public default IntOrderedSet synchronize(Object mutex) { return IntSets.synchronize(this, mutex); }
	 ...
	 */
	public default IntOrderedSet unmodifiable() { return IntSets.unmodifiable(this); }
