...
public interface DoubleTask extends RunnableFuture<Double> {
	...
	@Override
	@Deprecated
	public default Double get() throws InterruptedException, ExecutionException { return Double.valueOf(getDouble()); }
	
	@Override
	@Deprecated
	public default Double get(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException { return Double.valueOf(getDouble(timeout, unit)); }
}