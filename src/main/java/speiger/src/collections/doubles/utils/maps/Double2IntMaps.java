...
public class Double2IntMaps
{
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Double2IntOrderedMap {
		...
		@Override
		public int putFirst(double key, int value) { throw new UnsupportedOperationException(); }
		@Override
		public int putLast(double key, int value) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Double2IntMap.Entry firstEntry() { return map.firstEntry(); }
		@Override
		public Double2IntMap.Entry lastEntry() { return map.lastEntry(); }
		@Override
		public Double2IntMap.Entry pollFirstEntry() { throw new UnsupportedOperationException(); }
		@Override
		public Double2IntMap.Entry pollLastEntry() { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Double2IntMap.Entry>
	{
		...
		@Override
		public ObjectBidirectionalIterator<Double2IntMap.Entry> reverseIterator() { return ObjectIterators.unmodifiable(set.reverseIterator()); }
		@Override
		...
		@Override
		public Double2IntMap.Entry getFirst() { return set.getFirst(); }
		@Override
		public Double2IntMap.Entry removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Double2IntMap.Entry getLast() { return set.getLast(); }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Double2IntOrderedMap {
		...
		@Override
		public int putFirst(double key, int value) { synchronized(mutex) { return map.putFirst(key, value); } }
		@Override
		public int putLast(double key, int value) { synchronized(mutex) { return map.putLast(key, value); } }
		@Override
