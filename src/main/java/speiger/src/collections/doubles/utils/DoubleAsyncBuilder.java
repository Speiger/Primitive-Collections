...
public class DoubleAsyncBuilder
{
	 ...
	 */
	public <E> ObjectAsyncBuilder<E> map(Double2ObjectFunction<E> mapper) {
	 ...
	 * @return a new Builder Object with the mapped Iterable
	 */
	public <E, V extends Iterable<E>> ObjectAsyncBuilder<E> flatMap(Double2ObjectFunction<V> mapper) {
	 ...
	 * @return a new Builder Object with the mapped Iterable
	 */
	public <E> ObjectAsyncBuilder<E> arrayflatMap(Double2ObjectFunction<E[]> mapper) {
	 ...
	 */
	public DoubleAsyncBuilder filter(Double2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchAny(Double2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchNone(Double2BooleanFunction filter) {
	 ...
	 */
	public BooleanAsyncBuilder matchAll(Double2BooleanFunction filter) {
	 ...
	 */
	public DoubleAsyncBuilder findFirst(Double2BooleanFunction filter) {
	 ...
	 */
	public IntAsyncBuilder count(Double2BooleanFunction filter) {
	...
	private static class MatchTask extends BaseBooleanTask
	{
		...
		public MatchTask(DoubleIterator iter, Double2BooleanFunction filter, int type) {
			this.iter = iter;
			this.filter = filter;
			this.type = type;
	...
	private static class FindFirstTask extends BaseDoubleTask
	{
		...
		public FindFirstTask(DoubleIterator iter, Double2BooleanFunction filter) {
			this.iter = iter;
			this.filter = filter;
		}
	...
	private static class CountTask extends BaseIntTask
	{
		...
		public CountTask(DoubleIterator iter, Double2BooleanFunction filter) {
			this.iter = iter;
			this.filter = filter;
		}
