...
public class Double2ObjectMaps
{
	...
	public static class SynchronizedMap<V> extends AbstractDouble2ObjectMap<V> implements Double2ObjectMap<V> {
		...
		@Override
		public V computeNonDefault(double key, DoubleObjectUnaryOperator<V> mappingFunction) { synchronized(mutex) { return map.computeNonDefault(key, mappingFunction); } }
		@Override
		...
		@Override
		public V computeIfAbsentNonDefault(double key, DoubleFunction<V> mappingFunction) { synchronized(mutex) { return map.computeIfAbsentNonDefault(key, mappingFunction); } }
		@Override
		...
		@Override
		public V computeIfPresentNonDefault(double key, DoubleObjectUnaryOperator<V> mappingFunction) { synchronized(mutex) { return map.computeIfPresentNonDefault(key, mappingFunction); } }
		@Override
		...
		@Override
		public V supplyIfAbsentNonDefault(double key, ObjectSupplier<V> valueProvider) { synchronized(mutex) { return map.supplyIfAbsentNonDefault(key, valueProvider); } }
		@Override
