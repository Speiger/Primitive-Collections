...
public class Double2ObjectArrayMap<V> extends AbstractDouble2ObjectMap<V> implements Double2ObjectOrderedMap<V>
{
	...
	@Override
	public V putFirst(double key, V value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(0, key, value);
			size++;
	...
	@Override
	public V putLast(double key, V value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(size++, key, value);
			return getDefaultReturnValue();
	...
	private class MapEntrySet extends AbstractObjectSet<Double2ObjectMap.Entry<V>> implements Double2ObjectOrderedMap.FastOrderedSet<V> {
		@Override
		public void addFirst(Double2ObjectMap.Entry<V> o) { throw new UnsupportedOperationException(); }
		@Override
		public void addLast(Double2ObjectMap.Entry<V> o) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public Double2ObjectMap.Entry<V> getFirst() {
			return new BasicEntry<>(firstDoubleKey(), firstValue());
		}
		
		@Override
		public Double2ObjectMap.Entry<V> getLast() {
			return new BasicEntry<>(lastDoubleKey(), lastValue());
		}
		
		@Override
		public Double2ObjectMap.Entry<V> removeFirst() {
		...
		@Override
		public Double2ObjectMap.Entry<V> removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> reverseIterator() {
		...
		@Override
		public Optional<Double2ObjectMap.Entry<V>> reduce(ObjectObjectUnaryOperator<Double2ObjectMap.Entry<V>, Double2ObjectMap.Entry<V>> operator) {
			Objects.requireNonNull(operator);
		...
		@Override
		public Optional<Double2ObjectMap.Entry<V>> findFirst(Predicate<Double2ObjectMap.Entry<V>> filter) {
			Objects.requireNonNull(filter);
	...
	private class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		@Override
		public DoubleListIterator iterator() { return new KeyIterator(true); }
		@Override
		public DoubleListIterator reverseIterator() { return new KeyIterator(false); }
		@Override
		...
		@Override
		public double getFirstDouble() { return firstDoubleKey(); }
		@Override
		public double removeFirstDouble() { return pollFirstDoubleKey(); }
		@Override
		public double getLastDouble() { return lastDoubleKey(); }
		@Override
		public double removeLastDouble() { return pollLastDoubleKey(); }
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Double2ObjectMap.Entry<V>> {
		...
		public FastEntryIterator(double element) { super(element); }
	...
	private class EntryIterator extends MapIterator implements ObjectListIterator<Double2ObjectMap.Entry<V>> {
		...
		public EntryIterator(double element) { super(element); }
	...
	private class KeyIterator extends MapIterator implements DoubleListIterator {
		...
		public KeyIterator(double element) { super(element); }
	...
	private class ValueIterator extends MapIterator implements ObjectListIterator<V> {
		...
		public ValueIterator(double element) { super(element); }
