...
public class ImmutableDouble2ObjectOpenHashMap<V> extends AbstractDouble2ObjectMap<V> implements Double2ObjectOrderedMap<V>
{
	...
	/** Values cache */
	protected transient ObjectOrderedCollection<V> valuesC;
	...
	public ImmutableDouble2ObjectOpenHashMap(Double2ObjectMap<V> map, float loadFactor) {
		...
		V[] values = (V[])new Object[keys.length];
		int index = 0;
		for(Double2ObjectMap.Entry<V> entry : getFastIterable(map)) {
	...
	private class Values extends AbstractObjectCollection<V> implements ObjectOrderedCollection<V> {
		...
		@Override
		public int size() { return ImmutableDouble2ObjectOpenHashMap.this.size(); }
		@Override
		public void clear() { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public V removeFirst() { throw new UnsupportedOperationException(); }
		@Override
		public V getLast() { return lastValue(); }
		@Override
		public V removeLast() { throw new UnsupportedOperationException(); }
		@Override
