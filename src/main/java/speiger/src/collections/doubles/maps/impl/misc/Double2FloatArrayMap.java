...
public class Double2FloatArrayMap extends AbstractDouble2FloatMap implements Double2FloatOrderedMap
{
	...
	@Override
	public float putFirst(double key, float value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(0, key, value);
			size++;
	...
	@Override
	public float putLast(double key, float value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(size++, key, value);
			return getDefaultReturnValue();
	...
	private class MapEntrySet extends AbstractObjectSet<Double2FloatMap.Entry> implements Double2FloatOrderedMap.FastOrderedSet {
		...
		@Override
		public Double2FloatMap.Entry getFirst() {
			return new BasicEntry(firstDoubleKey(), firstFloatValue());
		}
		
		@Override
		public Double2FloatMap.Entry getLast() {
			return new BasicEntry(lastDoubleKey(), lastFloatValue());
		}
		
		@Override
		public Double2FloatMap.Entry removeFirst() {
		...
		@Override
		public Double2FloatMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Double2FloatMap.Entry> reverseIterator() {
