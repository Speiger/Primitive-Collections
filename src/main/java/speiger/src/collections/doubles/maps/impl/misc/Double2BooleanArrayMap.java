...
public class Double2BooleanArrayMap extends AbstractDouble2BooleanMap implements Double2BooleanOrderedMap
{
	...
	public Double2BooleanArrayMap(Double2BooleanMap map) {
		this(map.size());
		for(ObjectIterator<Double2BooleanMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Double2BooleanMap.Entry) {
					...
					return Double.doubleToLongBits(keys[index]) == Double.doubleToLongBits(entry.getDoubleKey()) && getBooleanValue() == entry.getBooleanValue();
				}
