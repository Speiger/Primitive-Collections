...
public class Double2CharArrayMap extends AbstractDouble2CharMap implements Double2CharOrderedMap
{
	...
	@Override
	public char putFirst(double key, char value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(0, key, value);
			size++;
	...
	@Override
	public char putLast(double key, char value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(size++, key, value);
			return getDefaultReturnValue();
	...
	private class MapEntrySet extends AbstractObjectSet<Double2CharMap.Entry> implements Double2CharOrderedMap.FastOrderedSet {
		...
		@Override
		public Double2CharMap.Entry getFirst() {
			return new BasicEntry(firstDoubleKey(), firstCharValue());
		}
		
		@Override
		public Double2CharMap.Entry getLast() {
			return new BasicEntry(lastDoubleKey(), lastCharValue());
		}
		
		@Override
		public Double2CharMap.Entry removeFirst() {
		...
		@Override
		public Double2CharMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Double2CharMap.Entry> reverseIterator() {
