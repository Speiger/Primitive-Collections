...
public class Double2ByteArrayMap extends AbstractDouble2ByteMap implements Double2ByteOrderedMap
{
	...
	public Double2ByteArrayMap(Double2ByteMap map) {
		this(map.size());
		for(ObjectIterator<Double2ByteMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
	...
	@Override
	public byte putFirst(double key, byte value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(0, key, value);
			size++;
	...
	@Override
	public byte putLast(double key, byte value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(size++, key, value);
			return getDefaultReturnValue();
	...
	private class MapEntrySet extends AbstractObjectSet<Double2ByteMap.Entry> implements Double2ByteOrderedMap.FastOrderedSet {
		...
		@Override
		public Double2ByteMap.Entry getFirst() {
			return new BasicEntry(firstDoubleKey(), firstByteValue());
		}
		
		@Override
		public Double2ByteMap.Entry getLast() {
			return new BasicEntry(lastDoubleKey(), lastByteValue());
		}
		
		@Override
		public Double2ByteMap.Entry removeFirst() {
		...
		@Override
		public Double2ByteMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Double2ByteMap.Entry> reverseIterator() {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Double2ByteMap.Entry) {
					...
					return Double.doubleToLongBits(keys[index]) == Double.doubleToLongBits(entry.getDoubleKey()) && getByteValue() == entry.getByteValue();
				}
