...
public interface Double2IntMap extends Map<Double, Integer>, Double2IntFunction
{
	...
	/**
	 * A Helper method that allows to put int a Double2IntMap.Entry into a map.
	 ...
	 * @return the last present value or default return	value.
	 */
	public default Integer put(Map.Entry<Double, Integer> entry) {
		return put(entry.getKey().doubleValue(), entry.getValue().intValue());
	}
	...
	@Override
	public default int applyAsInt(double key) {
		return get(key);
	}
	/**
