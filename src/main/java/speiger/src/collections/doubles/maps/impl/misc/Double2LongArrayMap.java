...
public class Double2LongArrayMap extends AbstractDouble2LongMap implements Double2LongOrderedMap
{
	...
	public Double2LongArrayMap(Double2LongMap map) {
		this(map.size());
		for(ObjectIterator<Double2LongMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
	...
	@Override
	public long putFirst(double key, long value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(0, key, value);
			size++;
	...
	@Override
	public long putLast(double key, long value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(size++, key, value);
			return getDefaultReturnValue();
	...
	private class MapEntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongOrderedMap.FastOrderedSet {
		...
		@Override
		public Double2LongMap.Entry getFirst() {
			return new BasicEntry(firstDoubleKey(), firstLongValue());
		}
		
		@Override
		public Double2LongMap.Entry getLast() {
			return new BasicEntry(lastDoubleKey(), lastLongValue());
		}
		
		@Override
		public Double2LongMap.Entry removeFirst() {
		...
		@Override
		public Double2LongMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Double2LongMap.Entry> reverseIterator() {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Double2LongMap.Entry) {
					...
					return Double.doubleToLongBits(keys[index]) == Double.doubleToLongBits(entry.getDoubleKey()) && getLongValue() == entry.getLongValue();
				}
