...
public class Double2IntArrayMap extends AbstractDouble2IntMap implements Double2IntOrderedMap
{
	...
	public Double2IntArrayMap(Double2IntMap map) {
		this(map.size());
		for(ObjectIterator<Double2IntMap.Entry> iter = getFastIterator(map);iter.hasNext();size++) {
	...
	@Override
	public int putFirst(double key, int value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(0, key, value);
			size++;
	...
	@Override
	public int putLast(double key, int value) {
		int index = findIndex(key);
		if(index < 0) {
			insertIndex(size++, key, value);
			return getDefaultReturnValue();
	...
	private class MapEntrySet extends AbstractObjectSet<Double2IntMap.Entry> implements Double2IntOrderedMap.FastOrderedSet {
		...
		@Override
		public Double2IntMap.Entry getFirst() {
			return new BasicEntry(firstDoubleKey(), firstIntValue());
		}
		
		@Override
		public Double2IntMap.Entry getLast() {
			return new BasicEntry(lastDoubleKey(), lastIntValue());
		}
		
		@Override
		public Double2IntMap.Entry removeFirst() {
		...
		@Override
		public Double2IntMap.Entry removeLast() {
		...
		@Override
		public ObjectBidirectionalIterator<Double2IntMap.Entry> reverseIterator() {
		...
		@Override
		public Optional<Double2IntMap.Entry> reduce(ObjectObjectUnaryOperator<Double2IntMap.Entry, Double2IntMap.Entry> operator) {
			Objects.requireNonNull(operator);
		...
		@Override
		public Optional<Double2IntMap.Entry> findFirst(Predicate<Double2IntMap.Entry> filter) {
			Objects.requireNonNull(filter);
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Double2IntMap.Entry) {
					...
					return Double.doubleToLongBits(keys[index]) == Double.doubleToLongBits(entry.getDoubleKey()) && getIntValue() == entry.getIntValue();
				}
