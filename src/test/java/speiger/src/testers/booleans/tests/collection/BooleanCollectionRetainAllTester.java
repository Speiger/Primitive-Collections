...
public class BooleanCollectionRetainAllTester extends AbstractBooleanCollectionTester
{
	...
	private class Target {
		...
		private final BooleanCollection inverse = BooleanArrayList.wrap(createSamplesArray());
		private final String description;

		private Target(BooleanCollection toRetain, String description) {
	...
	public void setUp() throws Exception {
		...
		disjoint = new Target(BooleanArrayList.wrap(e3(), e4()), "disjoint");
		superset = new Target(MinimalBooleanCollection.of(e0(), e1(), e2(), e3(), e4()), "superset");
		nonEmptyProperSubset = new Target(MinimalBooleanCollection.of(e1()), "subset");
		sameElements = new Target(BooleanArrayList.wrap(createSamplesArray()), "sameElements");
		containsDuplicates = new Target(MinimalBooleanCollection.of(e0(), e0(), e3(), e3()), "containsDuplicates");
		partialOverlap = new Target(MinimalBooleanCollection.of(e2(), e3()), "partialOverlap");
	}
	...
	private void expectReturnsTrueExtra(Target target) {
		...
		BooleanHelpers.assertEqualIgnoringOrder(target.inverse, list);
	}
