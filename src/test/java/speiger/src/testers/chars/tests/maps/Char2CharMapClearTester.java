...
public class Char2CharMapClearTester extends AbstractChar2CharMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().char2CharEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().char2CharEntrySet().iterator();
			getMap().clear();
			iterator.next();
