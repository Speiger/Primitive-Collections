...
public class Char2IntMapEntrySetTester extends AbstractChar2IntMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Char2IntMap.Entry> entrySet = getMap().char2IntEntrySet();
		Iterator<Char2IntMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Char2IntMap.Entry entry : getMap().char2IntEntrySet()) {
