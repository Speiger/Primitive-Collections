...
public class Char2DoubleMapEntrySetTester extends AbstractChar2DoubleMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Char2DoubleMap.Entry> entrySet = getMap().char2DoubleEntrySet();
		Iterator<Char2DoubleMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Char2DoubleMap.Entry entry : getMap().char2DoubleEntrySet()) {
