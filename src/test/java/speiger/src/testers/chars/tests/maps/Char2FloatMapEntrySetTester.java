...
@Ignore
public class Char2FloatMapEntrySetTester extends AbstractChar2FloatMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Char2FloatMap.Entry> entrySet = getMap().char2FloatEntrySet();
		Iterator<Char2FloatMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Char2FloatMap.Entry entry : getMap().char2FloatEntrySet()) {
