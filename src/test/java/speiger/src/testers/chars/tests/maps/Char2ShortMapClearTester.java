...
public class Char2ShortMapClearTester extends AbstractChar2ShortMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().char2ShortEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().char2ShortEntrySet().iterator();
			getMap().clear();
			iterator.next();
