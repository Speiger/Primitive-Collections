...
public class Char2FloatMapClearTester extends AbstractChar2FloatMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().char2FloatEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().char2FloatEntrySet().iterator();
			getMap().clear();
			iterator.next();
