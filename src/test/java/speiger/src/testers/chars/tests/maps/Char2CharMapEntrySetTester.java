...
public class Char2CharMapEntrySetTester extends AbstractChar2CharMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Char2CharMap.Entry> entrySet = getMap().char2CharEntrySet();
		Iterator<Char2CharMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Char2CharMap.Entry entry : getMap().char2CharEntrySet()) {
