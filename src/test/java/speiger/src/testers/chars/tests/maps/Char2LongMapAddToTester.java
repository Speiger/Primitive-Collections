...
@Ignore
public class Char2LongMapAddToTester extends AbstractChar2LongMapTester
{	@MapFeature.Require(SUPPORTS_PUT)
	...
	private long addTo(Char2LongMap.Entry entry) {
		return getMap().addTo(entry.getCharKey(), entry.getLongValue());
	}
}