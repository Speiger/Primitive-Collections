...
@Ignore
public class Char2ShortNavigableMapNavigationTester extends AbstractChar2ShortMapTester
{
	private Char2ShortNavigableMap navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Char2ShortNavigableMap) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.char2ShortEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.char2ShortEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry> descending = new ObjectArrayList<>(navigableMap.descendingMap().char2ShortEntrySet());
