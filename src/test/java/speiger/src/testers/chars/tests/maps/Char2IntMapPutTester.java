...
public class Char2IntMapPutTester extends AbstractChar2IntMapTester
{	
	...
	private int put(Char2IntMap.Entry entry) {
		return getMap().put(entry.getCharKey(), entry.getIntValue());
	}
}