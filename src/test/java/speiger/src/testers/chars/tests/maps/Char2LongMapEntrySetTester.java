...
@Ignore
public class Char2LongMapEntrySetTester extends AbstractChar2LongMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Char2LongMap.Entry> entrySet = getMap().char2LongEntrySet();
		Iterator<Char2LongMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Char2LongMap.Entry entry : getMap().char2LongEntrySet()) {
