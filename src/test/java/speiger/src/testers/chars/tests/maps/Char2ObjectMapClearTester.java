...
@Ignore
public class Char2ObjectMapClearTester<V> extends AbstractChar2ObjectMapTester<V> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().char2ObjectEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<V>> iterator = getMap().char2ObjectEntrySet().iterator();
			getMap().clear();
			iterator.next();
