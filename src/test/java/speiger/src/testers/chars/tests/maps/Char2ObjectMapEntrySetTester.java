...
@Ignore
public class Char2ObjectMapEntrySetTester<V> extends AbstractChar2ObjectMapTester<V>
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Char2ObjectMap.Entry<V>> entrySet = getMap().char2ObjectEntrySet();
		Iterator<Char2ObjectMap.Entry<V>> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Char2ObjectMap.Entry<V> entry : getMap().char2ObjectEntrySet()) {
