...
public class Char2BooleanMapEntrySetTester extends AbstractChar2BooleanMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Char2BooleanMap.Entry> entrySet = getMap().char2BooleanEntrySet();
		Iterator<Char2BooleanMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Char2BooleanMap.Entry entry : getMap().char2BooleanEntrySet()) {
