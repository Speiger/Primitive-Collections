...
@Ignore
public class Char2ShortMapPutTester extends AbstractChar2ShortMapTester
{	
	...
	private short put(Char2ShortMap.Entry entry) {
		return getMap().put(entry.getCharKey(), entry.getShortValue());
	}
}