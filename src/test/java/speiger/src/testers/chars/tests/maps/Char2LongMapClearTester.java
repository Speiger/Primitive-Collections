...
@Ignore
public class Char2LongMapClearTester extends AbstractChar2LongMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().char2LongEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().char2LongEntrySet().iterator();
			getMap().clear();
			iterator.next();
