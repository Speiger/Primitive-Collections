...
public class Char2ByteMapClearTester extends AbstractChar2ByteMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().char2ByteEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().char2ByteEntrySet().iterator();
			getMap().clear();
			iterator.next();
