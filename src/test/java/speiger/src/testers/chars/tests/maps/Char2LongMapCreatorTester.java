...
public class Char2LongMapCreatorTester extends AbstractChar2LongMapTester
{
	...
	private Char2LongMap.Entry[] getEntriesMultipleNonNullKeys() {
		Char2LongMap.Entry[] entries = createSamplesArray();
		entries[0] = entry(k1(), v0());
		return entries;
	}

	private void expectFirstRemoved(Char2LongMap.Entry[] entries) {
		resetMap(entries);
