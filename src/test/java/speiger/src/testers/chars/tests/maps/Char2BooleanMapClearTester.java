...
public class Char2BooleanMapClearTester extends AbstractChar2BooleanMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().char2BooleanEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().char2BooleanEntrySet().iterator();
			getMap().clear();
			iterator.next();
