...
@Ignore
public class Char2ByteMapPutTester extends AbstractChar2ByteMapTester
{	
	...
	private byte put(Char2ByteMap.Entry entry) {
		return getMap().put(entry.getCharKey(), entry.getByteValue());
	}
}