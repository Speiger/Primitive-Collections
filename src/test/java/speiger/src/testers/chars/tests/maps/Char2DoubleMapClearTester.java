...
@Ignore
public class Char2DoubleMapClearTester extends AbstractChar2DoubleMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().char2DoubleEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().char2DoubleEntrySet().iterator();
			getMap().clear();
			iterator.next();
