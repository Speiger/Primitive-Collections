...
public class Char2BooleanNavigableMapNavigationTester extends AbstractChar2BooleanMapTester
{
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Char2BooleanNavigableMap) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.char2BooleanEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.char2BooleanEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry> descending = new ObjectArrayList<>(navigableMap.descendingMap().char2BooleanEntrySet());
