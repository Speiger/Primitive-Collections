...
public class Char2ByteMapEntrySetTester extends AbstractChar2ByteMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Char2ByteMap.Entry> entrySet = getMap().char2ByteEntrySet();
		Iterator<Char2ByteMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Char2ByteMap.Entry entry : getMap().char2ByteEntrySet()) {
