...
import speiger.src.testers.chars.tests.maps.Char2IntSortedMapNavigationTester;
...
public class Char2IntSortedMapTestSuiteBuilder extends Char2IntMapTestSuiteBuilder {
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Char2IntSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Character, Integer>, Map.Entry<Character, Integer>>> parentBuilder, Bound from, Bound to) {
	...
	Char2IntSortedMapTestSuiteBuilder newBuilderUsing(TestChar2IntSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedChar2IntMapGenerators.SortedMapGenerator(delegate, to, from));
	}
