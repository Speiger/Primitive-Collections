...
import speiger.src.testers.chars.tests.maps.Char2FloatSortedMapNavigationTester;
...
public class Char2FloatSortedMapTestSuiteBuilder extends Char2FloatMapTestSuiteBuilder {
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Char2FloatSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Character, Float>, Map.Entry<Character, Float>>> parentBuilder, Bound from, Bound to) {
	...
	Char2FloatSortedMapTestSuiteBuilder newBuilderUsing(TestChar2FloatSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedChar2FloatMapGenerators.SortedMapGenerator(delegate, to, from));
	}
