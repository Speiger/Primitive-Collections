...
import speiger.src.testers.chars.tests.maps.Char2ByteSortedMapNavigationTester;
...
public class Char2ByteSortedMapTestSuiteBuilder extends Char2ByteMapTestSuiteBuilder {
	public static Char2ByteSortedMapTestSuiteBuilder using(TestChar2ByteSortedMapGenerator generator) {
		return (Char2ByteSortedMapTestSuiteBuilder) new Char2ByteSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Char2ByteSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Character, Byte>, Map.Entry<Character, Byte>>> parentBuilder, Bound from, Bound to) {
	...
	Char2ByteSortedMapTestSuiteBuilder newBuilderUsing(TestChar2ByteSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedChar2ByteMapGenerators.SortedMapGenerator(delegate, to, from));
	}
