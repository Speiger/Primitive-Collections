...
import speiger.src.testers.chars.tests.maps.Char2DoubleSortedMapNavigationTester;
...
public class Char2DoubleSortedMapTestSuiteBuilder extends Char2DoubleMapTestSuiteBuilder {
	public static Char2DoubleSortedMapTestSuiteBuilder using(TestChar2DoubleSortedMapGenerator generator) {
		return (Char2DoubleSortedMapTestSuiteBuilder) new Char2DoubleSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Char2DoubleSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Character, Double>, Map.Entry<Character, Double>>> parentBuilder, Bound from, Bound to) {
	...
	Char2DoubleSortedMapTestSuiteBuilder newBuilderUsing(TestChar2DoubleSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedChar2DoubleMapGenerators.SortedMapGenerator(delegate, to, from));
	}
