...
public class Object2LongNavigableMapTestSuiteBuilder<T> extends Object2LongSortedMapTestSuiteBuilder<T>
{
	public static <T> Object2LongNavigableMapTestSuiteBuilder<T> using(TestObject2LongSortedMapGenerator<T> generator) {
		return (Object2LongNavigableMapTestSuiteBuilder<T>)new Object2LongNavigableMapTestSuiteBuilder<T>().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Object2LongNavigableMapNavigationTester.class);
		return testers;
	}
	...
	@Override
	Object2LongNavigableMapTestSuiteBuilder<T> newBuilderUsing(TestObject2LongSortedMapGenerator<T> delegate, Bound to, Bound from) {
		return Object2LongNavigableMapTestSuiteBuilder.using(new DerivedObject2LongMapGenerators.NavigableMapGenerator<>(delegate, to, from));
	}

	private TestSuite createDescendingSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<T, Long>, Map.Entry<T, Long>>> parentBuilder) {
		...
		return Object2LongNavigableMapTestSuiteBuilder.using(new DerivedObject2LongMapGenerators.DescendingTestMapGenerator<>(delegate))
