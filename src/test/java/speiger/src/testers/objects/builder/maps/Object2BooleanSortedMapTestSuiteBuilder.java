...
import speiger.src.testers.objects.tests.maps.Object2BooleanSortedMapNavigationTester;
...
public class Object2BooleanSortedMapTestSuiteBuilder<T> extends Object2BooleanMapTestSuiteBuilder<T> {
	public static <T> Object2BooleanSortedMapTestSuiteBuilder<T> using(TestObject2BooleanSortedMapGenerator<T> generator) {
		return (Object2BooleanSortedMapTestSuiteBuilder<T>) new Object2BooleanSortedMapTestSuiteBuilder<T>().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Object2BooleanSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<T, Boolean>, Map.Entry<T, Boolean>>> parentBuilder, Bound from, Bound to) {
	...
	Object2BooleanSortedMapTestSuiteBuilder<T> newBuilderUsing(TestObject2BooleanSortedMapGenerator<T> delegate, Bound to, Bound from) {
		return using(new DerivedObject2BooleanMapGenerators.SortedMapGenerator<>(delegate, to, from));
	}
