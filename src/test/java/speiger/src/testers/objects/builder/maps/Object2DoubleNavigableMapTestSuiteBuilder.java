...
public class Object2DoubleNavigableMapTestSuiteBuilder<T> extends Object2DoubleSortedMapTestSuiteBuilder<T>
{
	public static <T> Object2DoubleNavigableMapTestSuiteBuilder<T> using(TestObject2DoubleSortedMapGenerator<T> generator) {
		return (Object2DoubleNavigableMapTestSuiteBuilder<T>)new Object2DoubleNavigableMapTestSuiteBuilder<T>().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Object2DoubleNavigableMapNavigationTester.class);
		return testers;
	}
	...
	@Override
	Object2DoubleNavigableMapTestSuiteBuilder<T> newBuilderUsing(TestObject2DoubleSortedMapGenerator<T> delegate, Bound to, Bound from) {
		return Object2DoubleNavigableMapTestSuiteBuilder.using(new DerivedObject2DoubleMapGenerators.NavigableMapGenerator<>(delegate, to, from));
	}

	private TestSuite createDescendingSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<T, Double>, Map.Entry<T, Double>>> parentBuilder) {
		...
		return Object2DoubleNavigableMapTestSuiteBuilder.using(new DerivedObject2DoubleMapGenerators.DescendingTestMapGenerator<>(delegate))
