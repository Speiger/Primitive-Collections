...
import speiger.src.testers.objects.tests.maps.Object2FloatSortedMapNavigationTester;
...
public class Object2FloatSortedMapTestSuiteBuilder<T> extends Object2FloatMapTestSuiteBuilder<T> {
	public static <T> Object2FloatSortedMapTestSuiteBuilder<T> using(TestObject2FloatSortedMapGenerator<T> generator) {
		return (Object2FloatSortedMapTestSuiteBuilder<T>) new Object2FloatSortedMapTestSuiteBuilder<T>().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Object2FloatSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<T, Float>, Map.Entry<T, Float>>> parentBuilder, Bound from, Bound to) {
	...
	Object2FloatSortedMapTestSuiteBuilder<T> newBuilderUsing(TestObject2FloatSortedMapGenerator<T> delegate, Bound to, Bound from) {
		return using(new DerivedObject2FloatMapGenerators.SortedMapGenerator<>(delegate, to, from));
	}
