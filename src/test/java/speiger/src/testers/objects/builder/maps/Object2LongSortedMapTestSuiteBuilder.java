...
import speiger.src.testers.objects.tests.maps.Object2LongSortedMapNavigationTester;
...
public class Object2LongSortedMapTestSuiteBuilder<T> extends Object2LongMapTestSuiteBuilder<T> {
	public static <T> Object2LongSortedMapTestSuiteBuilder<T> using(TestObject2LongSortedMapGenerator<T> generator) {
		return (Object2LongSortedMapTestSuiteBuilder<T>) new Object2LongSortedMapTestSuiteBuilder<T>().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Object2LongSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<T, Long>, Map.Entry<T, Long>>> parentBuilder, Bound from, Bound to) {
		TestObject2LongSortedMapGenerator<T> delegate = (TestObject2LongSortedMapGenerator<T>) parentBuilder.getSubjectGenerator().getInnerGenerator();
	...
	Object2LongSortedMapTestSuiteBuilder<T> newBuilderUsing(TestObject2LongSortedMapGenerator<T> delegate, Bound to, Bound from) {
		return using(new DerivedObject2LongMapGenerators.SortedMapGenerator<>(delegate, to, from));
	}
