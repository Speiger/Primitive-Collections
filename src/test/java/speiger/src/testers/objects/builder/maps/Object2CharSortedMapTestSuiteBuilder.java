...
import speiger.src.testers.objects.tests.maps.Object2CharSortedMapNavigationTester;
...
public class Object2CharSortedMapTestSuiteBuilder<T> extends Object2CharMapTestSuiteBuilder<T> {
	public static <T> Object2CharSortedMapTestSuiteBuilder<T> using(TestObject2CharSortedMapGenerator<T> generator) {
		return (Object2CharSortedMapTestSuiteBuilder<T>) new Object2CharSortedMapTestSuiteBuilder<T>().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Object2CharSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<T, Character>, Map.Entry<T, Character>>> parentBuilder, Bound from, Bound to) {
	...
	Object2CharSortedMapTestSuiteBuilder<T> newBuilderUsing(TestObject2CharSortedMapGenerator<T> delegate, Bound to, Bound from) {
		return using(new DerivedObject2CharMapGenerators.SortedMapGenerator<>(delegate, to, from));
	}
