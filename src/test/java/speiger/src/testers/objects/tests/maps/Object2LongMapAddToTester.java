...
@Ignore
public class Object2LongMapAddToTester<T> extends AbstractObject2LongMapTester<T>
{	@MapFeature.Require(SUPPORTS_PUT)
	...
	private long addTo(Object2LongMap.Entry<T> entry) {
		return getMap().addTo(entry.getKey(), entry.getLongValue());
	}
}