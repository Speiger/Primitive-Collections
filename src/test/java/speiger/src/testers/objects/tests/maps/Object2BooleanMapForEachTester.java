...
@Ignore
public class Object2BooleanMapForEachTester<T> extends AbstractObject2BooleanMapTester<T>
{
	@CollectionFeature.Require(KNOWN_ORDER)
	public void testForEachKnownOrder() {
		ObjectList<Object2BooleanMap.Entry<T>> entries = new ObjectArrayList<>();
	...
	public void testForEachUnknownOrder() {
		List<Object2BooleanMap.Entry<T>> entries = new ObjectArrayList<>();
		getMap().forEach((k, v) -> entries.add(entry(k, v)));
