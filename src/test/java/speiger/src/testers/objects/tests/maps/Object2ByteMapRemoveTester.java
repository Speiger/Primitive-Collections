...
@Ignore
public class Object2ByteMapRemoveTester<T> extends AbstractObject2ByteMapTester<T>
{
	...
	public void testRemove_notPresent() {
		assertEquals("remove(notPresent) should return (byte)-1", (byte)-1, getMap().rem(k3()));
		expectUnchanged();
	}
	...
	public void testRemove_unsupportedNotPresent() {
		try {
			assertEquals("remove(notPresent) should return (byte)-1 or throw UnsupportedOperationException", (byte)-1, getMap().rem(k3()));
