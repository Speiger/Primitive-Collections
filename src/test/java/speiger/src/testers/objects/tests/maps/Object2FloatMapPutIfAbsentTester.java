...
@Ignore
public class Object2FloatMapPutIfAbsentTester<T> extends AbstractObject2FloatMapTester<T>
{
	@MapFeature.Require(SUPPORTS_PUT)
	public void testPutIfAbsent_supportedAbsent() {
		assertEquals("putIfAbsent(notPresent, value) should return -1F", -1F, getMap().putIfAbsent(k3(), v3()));
		expectAdded(e3());
	}
