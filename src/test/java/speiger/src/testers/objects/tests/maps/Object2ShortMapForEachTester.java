...
@Ignore
public class Object2ShortMapForEachTester<T> extends AbstractObject2ShortMapTester<T>
{
	@CollectionFeature.Require(KNOWN_ORDER)
	public void testForEachKnownOrder() {
		ObjectList<Object2ShortMap.Entry<T>> entries = new ObjectArrayList<>();
	...
	public void testForEachUnknownOrder() {
		List<Object2ShortMap.Entry<T>> entries = new ObjectArrayList<>();
		getMap().forEach((k, v) -> entries.add(entry(k, v)));
