...
@Ignore
public class Object2DoubleMapPutIfAbsentTester<T> extends AbstractObject2DoubleMapTester<T>
{
	@MapFeature.Require(SUPPORTS_PUT)
	public void testPutIfAbsent_supportedAbsent() {
		assertEquals("putIfAbsent(notPresent, value) should return -1D", -1D, getMap().putIfAbsent(k3(), v3()));
		expectAdded(e3());
	}
