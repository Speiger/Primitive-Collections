...
public class Object2ByteNavigableMapNavigationTester<T> extends AbstractObject2ByteMapTester<T>
{
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Object2ByteNavigableMap<T>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.object2ByteEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.object2ByteEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<T>> descending = new ObjectArrayList<>(navigableMap.descendingMap().object2ByteEntrySet());
