...
@Ignore
public class Object2DoubleMapForEachTester<T> extends AbstractObject2DoubleMapTester<T>
{
	@CollectionFeature.Require(KNOWN_ORDER)
	public void testForEachKnownOrder() {
		ObjectList<Object2DoubleMap.Entry<T>> entries = new ObjectArrayList<>();
	...
	public void testForEachUnknownOrder() {
		List<Object2DoubleMap.Entry<T>> entries = new ObjectArrayList<>();
		getMap().forEach((k, v) -> entries.add(entry(k, v)));
