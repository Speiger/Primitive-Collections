...
@Ignore
public class Object2ByteMapEntrySetTester<T> extends AbstractObject2ByteMapTester<T>
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Object2ByteMap.Entry<T>> entrySet = getMap().object2ByteEntrySet();
		Iterator<Object2ByteMap.Entry<T>> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Object2ByteMap.Entry<T> entry : getMap().object2ByteEntrySet()) {
