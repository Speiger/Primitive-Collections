...
public class Object2DoubleMapPutTester<T> extends AbstractObject2DoubleMapTester<T>
{	
	...
	private double put(Object2DoubleMap.Entry<T> entry) {
		return getMap().put(entry.getKey(), entry.getDoubleValue());
	}
}