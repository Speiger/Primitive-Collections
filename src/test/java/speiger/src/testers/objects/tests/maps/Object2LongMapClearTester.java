...
@Ignore
public class Object2LongMapClearTester<T> extends AbstractObject2LongMapTester<T> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().object2LongEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<T>> iterator = getMap().object2LongEntrySet().iterator();
			getMap().clear();
			iterator.next();
