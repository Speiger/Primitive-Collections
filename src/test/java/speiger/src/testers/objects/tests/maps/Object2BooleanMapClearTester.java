...
public class Object2BooleanMapClearTester<T> extends AbstractObject2BooleanMapTester<T> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().object2BooleanEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<T>> iterator = getMap().object2BooleanEntrySet().iterator();
			getMap().clear();
			iterator.next();
