...
public class Object2FloatMapEntrySetTester<T> extends AbstractObject2FloatMapTester<T>
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Object2FloatMap.Entry<T>> entrySet = getMap().object2FloatEntrySet();
		Iterator<Object2FloatMap.Entry<T>> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Object2FloatMap.Entry<T> entry : getMap().object2FloatEntrySet()) {
