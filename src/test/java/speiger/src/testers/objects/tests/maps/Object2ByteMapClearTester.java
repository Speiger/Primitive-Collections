...
public class Object2ByteMapClearTester<T> extends AbstractObject2ByteMapTester<T> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().object2ByteEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<T>> iterator = getMap().object2ByteEntrySet().iterator();
			getMap().clear();
			iterator.next();
