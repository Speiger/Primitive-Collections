...
@Ignore
public class Object2ShortMapPutIfAbsentTester<T> extends AbstractObject2ShortMapTester<T>
{
	@MapFeature.Require(SUPPORTS_PUT)
	public void testPutIfAbsent_supportedAbsent() {
		assertEquals("putIfAbsent(notPresent, value) should return (short)-1", (short)-1, getMap().putIfAbsent(k3(), v3()));
		expectAdded(e3());
	}
