...
@Ignore
public class Object2LongMapPutIfAbsentTester<T> extends AbstractObject2LongMapTester<T>
{
	@MapFeature.Require(SUPPORTS_PUT)
	public void testPutIfAbsent_supportedAbsent() {
		assertEquals("putIfAbsent(notPresent, value) should return -1L", -1L, getMap().putIfAbsent(k3(), v3()));
		expectAdded(e3());
	}
