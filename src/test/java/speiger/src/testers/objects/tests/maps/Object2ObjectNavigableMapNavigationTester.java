...
public class Object2ObjectNavigableMapNavigationTester<T, V> extends AbstractObject2ObjectMapTester<T, V>
{
	private Object2ObjectNavigableMap<T, V> navigableMap;
	private List<Entry<T, V>> entries;
	private Entry<T, V> a;
	private Entry<T, V> b;
	private Entry<T, V> c;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Object2ObjectNavigableMap<T, V>) getMap();
	...
	private void resetWithHole() {
		Entry<T, V>[] entries = new Entry[] { a, c };
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.object2ObjectEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.object2ObjectEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<T, V>> descending = new ObjectArrayList<>(navigableMap.descendingMap().object2ObjectEntrySet());
