...
@Ignore
public class Object2IntMapPutTester<T> extends AbstractObject2IntMapTester<T>
{	
	...
	private int put(Object2IntMap.Entry<T> entry) {
		return getMap().put(entry.getKey(), entry.getIntValue());
	}
}