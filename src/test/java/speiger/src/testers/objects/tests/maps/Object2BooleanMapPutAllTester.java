...
public class Object2BooleanMapPutAllTester<T> extends AbstractObject2BooleanMapTester<T>
{
	...
	private Object2BooleanMap<T> emptyMap() {
		return Object2BooleanMaps.empty();
	}
