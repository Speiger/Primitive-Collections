...
@Ignore
public class Object2DoubleNavigableMapNavigationTester<T> extends AbstractObject2DoubleMapTester<T>
{
	private Object2DoubleNavigableMap<T> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Object2DoubleNavigableMap<T>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.object2DoubleEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.object2DoubleEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<T>> descending = new ObjectArrayList<>(navigableMap.descendingMap().object2DoubleEntrySet());
