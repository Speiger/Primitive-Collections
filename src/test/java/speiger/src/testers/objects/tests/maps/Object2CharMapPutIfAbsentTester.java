...
public class Object2CharMapPutIfAbsentTester<T> extends AbstractObject2CharMapTester<T>
{
	@MapFeature.Require(SUPPORTS_PUT)
	public void testPutIfAbsent_supportedAbsent() {
		assertEquals("putIfAbsent(notPresent, value) should return (char)-1", (char)-1, getMap().putIfAbsent(k3(), v3()));
		expectAdded(e3());
	}
