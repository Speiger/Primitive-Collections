...
public class Object2FloatMapForEachTester<T> extends AbstractObject2FloatMapTester<T>
{
	@CollectionFeature.Require(KNOWN_ORDER)
	public void testForEachKnownOrder() {
		ObjectList<Object2FloatMap.Entry<T>> entries = new ObjectArrayList<>();
	...
	public void testForEachUnknownOrder() {
		List<Object2FloatMap.Entry<T>> entries = new ObjectArrayList<>();
		getMap().forEach((k, v) -> entries.add(entry(k, v)));
