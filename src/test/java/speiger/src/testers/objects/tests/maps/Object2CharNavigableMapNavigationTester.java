...
@Ignore
public class Object2CharNavigableMapNavigationTester<T> extends AbstractObject2CharMapTester<T>
{
	private Object2CharNavigableMap<T> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Object2CharNavigableMap<T>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.object2CharEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.object2CharEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<T>> descending = new ObjectArrayList<>(navigableMap.descendingMap().object2CharEntrySet());
