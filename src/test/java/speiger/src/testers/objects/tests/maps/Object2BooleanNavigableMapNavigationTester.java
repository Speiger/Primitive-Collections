...
public class Object2BooleanNavigableMapNavigationTester<T> extends AbstractObject2BooleanMapTester<T>
{
	private Object2BooleanNavigableMap<T> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Object2BooleanNavigableMap<T>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.object2BooleanEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.object2BooleanEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<T>> descending = new ObjectArrayList<>(navigableMap.descendingMap().object2BooleanEntrySet());
