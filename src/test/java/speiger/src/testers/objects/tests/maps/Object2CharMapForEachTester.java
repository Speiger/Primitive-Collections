...
public class Object2CharMapForEachTester<T> extends AbstractObject2CharMapTester<T>
{
	@CollectionFeature.Require(KNOWN_ORDER)
	public void testForEachKnownOrder() {
		ObjectList<Object2CharMap.Entry<T>> entries = new ObjectArrayList<>();
	...
	public void testForEachUnknownOrder() {
		List<Object2CharMap.Entry<T>> entries = new ObjectArrayList<>();
		getMap().forEach((k, v) -> entries.add(entry(k, v)));
