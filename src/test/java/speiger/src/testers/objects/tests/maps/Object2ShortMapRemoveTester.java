...
@Ignore
public class Object2ShortMapRemoveTester<T> extends AbstractObject2ShortMapTester<T>
{
	...
	public void testRemove_notPresent() {
		assertEquals("remove(notPresent) should return (short)-1", (short)-1, getMap().rem(k3()));
		expectUnchanged();
	}
	...
	public void testRemove_unsupportedNotPresent() {
		try {
			assertEquals("remove(notPresent) should return (short)-1 or throw UnsupportedOperationException", (short)-1, getMap().rem(k3()));
