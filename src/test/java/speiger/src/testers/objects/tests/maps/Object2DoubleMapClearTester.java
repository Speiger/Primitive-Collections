...
public class Object2DoubleMapClearTester<T> extends AbstractObject2DoubleMapTester<T> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().object2DoubleEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<T>> iterator = getMap().object2DoubleEntrySet().iterator();
			getMap().clear();
			iterator.next();
