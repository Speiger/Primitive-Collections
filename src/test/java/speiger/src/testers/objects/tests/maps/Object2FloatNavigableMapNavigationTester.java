...
public class Object2FloatNavigableMapNavigationTester<T> extends AbstractObject2FloatMapTester<T>
{
	private Object2FloatNavigableMap<T> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Object2FloatNavigableMap<T>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.object2FloatEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.object2FloatEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<T>> descending = new ObjectArrayList<>(navigableMap.descendingMap().object2FloatEntrySet());
