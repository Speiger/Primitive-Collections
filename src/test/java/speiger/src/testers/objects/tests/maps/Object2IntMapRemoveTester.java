...
@Ignore
public class Object2IntMapRemoveTester<T> extends AbstractObject2IntMapTester<T>
{
	...
	public void testRemove_notPresent() {
		assertEquals("remove(notPresent) should return -1", -1, getMap().rem(k3()));
		expectUnchanged();
	}
	...
	public void testRemove_unsupportedNotPresent() {
		try {
			assertEquals("remove(notPresent) should return -1 or throw UnsupportedOperationException", -1, getMap().rem(k3()));
