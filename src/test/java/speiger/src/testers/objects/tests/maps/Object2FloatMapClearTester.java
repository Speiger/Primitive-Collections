...
public class Object2FloatMapClearTester<T> extends AbstractObject2FloatMapTester<T> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().object2FloatEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<T>> iterator = getMap().object2FloatEntrySet().iterator();
			getMap().clear();
			iterator.next();
