...
public class Object2IntMapCreatorTester<T> extends AbstractObject2IntMapTester<T>
{
	...
	private Object2IntMap.Entry<T>[] getEntriesMultipleNonNullKeys() {
		Object2IntMap.Entry<T>[] entries = createSamplesArray();
		entries[0] = entry(k1(), v0());
		return entries;
	}

	private void expectFirstRemoved(Object2IntMap.Entry<T>[] entries) {
		resetMap(entries);
