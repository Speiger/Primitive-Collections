...
public class Object2LongMapRemoveTester<T> extends AbstractObject2LongMapTester<T>
{
	...
	public void testRemove_notPresent() {
		assertEquals("remove(notPresent) should return -1L", -1L, getMap().rem(k3()));
		expectUnchanged();
	}
	...
	public void testRemove_unsupportedNotPresent() {
		try {
			assertEquals("remove(notPresent) should return -1L or throw UnsupportedOperationException", -1L, getMap().rem(k3()));
