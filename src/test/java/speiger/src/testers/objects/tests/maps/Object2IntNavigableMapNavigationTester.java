...
public class Object2IntNavigableMapNavigationTester<T> extends AbstractObject2IntMapTester<T>
{
	private Object2IntNavigableMap<T> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Object2IntNavigableMap<T>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.object2IntEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.object2IntEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<T>> descending = new ObjectArrayList<>(navigableMap.descendingMap().object2IntEntrySet());
