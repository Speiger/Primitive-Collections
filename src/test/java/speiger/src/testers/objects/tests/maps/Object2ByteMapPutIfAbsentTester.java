...
public class Object2ByteMapPutIfAbsentTester<T> extends AbstractObject2ByteMapTester<T>
{
	@MapFeature.Require(SUPPORTS_PUT)
	public void testPutIfAbsent_supportedAbsent() {
		assertEquals("putIfAbsent(notPresent, value) should return (byte)-1", (byte)-1, getMap().putIfAbsent(k3(), v3()));
		expectAdded(e3());
	}
