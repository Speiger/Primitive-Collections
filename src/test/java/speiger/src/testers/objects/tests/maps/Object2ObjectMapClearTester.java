...
@Ignore
public class Object2ObjectMapClearTester<T, V> extends AbstractObject2ObjectMapTester<T, V> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().object2ObjectEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<T, V>> iterator = getMap().object2ObjectEntrySet().iterator();
			getMap().clear();
			iterator.next();
