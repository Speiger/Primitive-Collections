...
public class Object2DoubleMapRemoveTester<T> extends AbstractObject2DoubleMapTester<T>
{
	...
	public void testRemove_notPresent() {
		assertEquals("remove(notPresent) should return -1D", -1D, getMap().rem(k3()));
		expectUnchanged();
	}
	...
	public void testRemove_unsupportedNotPresent() {
		try {
			assertEquals("remove(notPresent) should return -1D or throw UnsupportedOperationException", -1D, getMap().rem(k3()));
