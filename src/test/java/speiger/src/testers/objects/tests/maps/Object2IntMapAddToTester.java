...
public class Object2IntMapAddToTester<T> extends AbstractObject2IntMapTester<T>
{	@MapFeature.Require(SUPPORTS_PUT)
	...
	public void testAddToAbsentConcurrentWithEntrySetIteration() {
		try {
			Iterator<Object2IntMap.Entry<T>> iterator = getMap().object2IntEntrySet().iterator();
			addTo(e3());
			iterator.next();
	...
	private int addTo(Object2IntMap.Entry<T> entry) {
		return getMap().addTo(entry.getKey(), entry.getIntValue());
	}
}