...
public class Object2BooleanMapToStringTester<T> extends AbstractObject2BooleanMapTester<T>
{
	...
	public void testToString_formatting() {
		assertEquals("map.toString() incorrect", expectedToString(getMap().object2BooleanEntrySet()), getMap().toString());
	}

	private String expectedToString(Set<Object2BooleanMap.Entry<T>> entries) {
		Object2BooleanMap<T> reference = new Object2BooleanLinkedOpenHashMap<>();
		for (Object2BooleanMap.Entry<T> entry : entries) {
			reference.put(entry.getKey(), entry.getBooleanValue());
		}
