...
public class Object2ShortMapPutTester<T> extends AbstractObject2ShortMapTester<T>
{	
	...
	private short put(Object2ShortMap.Entry<T> entry) {
		return getMap().put(entry.getKey(), entry.getShortValue());
	}
}