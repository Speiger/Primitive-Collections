...
@Ignore
public class Object2ObjectMapRemoveTester<T, V> extends AbstractObject2ObjectMapTester<T, V>
{
	...
	public void testRemove_notPresent() {
		assertEquals("remove(notPresent) should return null", null, getMap().rem(k3()));
		expectUnchanged();
	}
	...
	public void testRemove_unsupportedNotPresent() {
		try {
			assertEquals("remove(notPresent) should return null or throw UnsupportedOperationException", null, getMap().rem(k3()));
