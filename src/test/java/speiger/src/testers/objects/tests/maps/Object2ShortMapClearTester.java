...
public class Object2ShortMapClearTester<T> extends AbstractObject2ShortMapTester<T> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().object2ShortEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<T>> iterator = getMap().object2ShortEntrySet().iterator();
			getMap().clear();
			iterator.next();
