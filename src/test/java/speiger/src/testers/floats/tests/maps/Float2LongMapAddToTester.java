...
@Ignore
public class Float2LongMapAddToTester extends AbstractFloat2LongMapTester
{	@MapFeature.Require(SUPPORTS_PUT)
	...
	private long addTo(Float2LongMap.Entry entry) {
		return getMap().addTo(entry.getFloatKey(), entry.getLongValue());
	}
}