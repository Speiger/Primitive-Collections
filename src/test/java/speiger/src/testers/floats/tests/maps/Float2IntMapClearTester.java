...
@Ignore
public class Float2IntMapClearTester extends AbstractFloat2IntMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().float2IntEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().float2IntEntrySet().iterator();
			getMap().clear();
			iterator.next();
