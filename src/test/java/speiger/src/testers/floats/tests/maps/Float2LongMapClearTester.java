...
@Ignore
public class Float2LongMapClearTester extends AbstractFloat2LongMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().float2LongEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().float2LongEntrySet().iterator();
			getMap().clear();
			iterator.next();
