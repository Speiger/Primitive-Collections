...
public class FloatCollectionRetainAllTester extends AbstractFloatCollectionTester {
	...
	private class Target {
		...
		private final FloatCollection inverse = FloatArrayList.wrap(createSamplesArray());
		private final String description;

		private Target(FloatCollection toRetain, String description) {
	...
	public void setUp() throws Exception {
		...
		disjoint = new Target(FloatArrayList.wrap(e3(), e4()), "disjoint");
		superset = new Target(MinimalFloatCollection.of(e0(), e1(), e2(), e3(), e4()), "superset");
		nonEmptyProperSubset = new Target(MinimalFloatCollection.of(e1()), "subset");
		sameElements = new Target(FloatArrayList.wrap(createSamplesArray()), "sameElements");
		containsDuplicates = new Target(MinimalFloatCollection.of(e0(), e0(), e3(), e3()), "containsDuplicates");
		partialOverlap = new Target(MinimalFloatCollection.of(e2(), e3()), "partialOverlap");
	}
	...
	private void expectReturnsTrueExtra(Target target) {
		...
		FloatHelpers.assertEqualIgnoringOrder(target.inverse, list);
	}
