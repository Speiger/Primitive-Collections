...
public class Float2DoubleMapClearTester extends AbstractFloat2DoubleMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().float2DoubleEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().float2DoubleEntrySet().iterator();
			getMap().clear();
			iterator.next();
