...
@Ignore
public class Float2DoubleMapPutTester extends AbstractFloat2DoubleMapTester
{	
	...
	private double put(Float2DoubleMap.Entry entry) {
		return getMap().put(entry.getFloatKey(), entry.getDoubleValue());
	}
}