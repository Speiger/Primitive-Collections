...
public class Float2BooleanMapClearTester extends AbstractFloat2BooleanMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().float2BooleanEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().float2BooleanEntrySet().iterator();
			getMap().clear();
			iterator.next();
