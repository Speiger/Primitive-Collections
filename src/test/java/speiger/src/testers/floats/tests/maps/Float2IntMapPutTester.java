...
public class Float2IntMapPutTester extends AbstractFloat2IntMapTester
{	
	...
	private int put(Float2IntMap.Entry entry) {
		return getMap().put(entry.getFloatKey(), entry.getIntValue());
	}
}