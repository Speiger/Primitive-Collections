...
@Ignore
public class Float2ByteMapPutTester extends AbstractFloat2ByteMapTester
{	
	...
	private byte put(Float2ByteMap.Entry entry) {
		return getMap().put(entry.getFloatKey(), entry.getByteValue());
	}
}