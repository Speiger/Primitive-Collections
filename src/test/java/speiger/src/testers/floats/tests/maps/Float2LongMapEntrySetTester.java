...
public class Float2LongMapEntrySetTester extends AbstractFloat2LongMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Float2LongMap.Entry> entrySet = getMap().float2LongEntrySet();
		Iterator<Float2LongMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Float2LongMap.Entry entry : getMap().float2LongEntrySet()) {
