...
public class Float2ObjectNavigableMapNavigationTester<V> extends AbstractFloat2ObjectMapTester<V>
{
	private Float2ObjectNavigableMap<V> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Float2ObjectNavigableMap<V>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.float2ObjectEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.float2ObjectEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<V>> descending = new ObjectArrayList<>(navigableMap.descendingMap().float2ObjectEntrySet());
