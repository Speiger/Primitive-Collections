...
public class Float2DoubleNavigableMapNavigationTester extends AbstractFloat2DoubleMapTester
{
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Float2DoubleNavigableMap) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.float2DoubleEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.float2DoubleEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry> descending = new ObjectArrayList<>(navigableMap.descendingMap().float2DoubleEntrySet());
