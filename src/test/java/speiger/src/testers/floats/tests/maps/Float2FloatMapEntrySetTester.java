...
public class Float2FloatMapEntrySetTester extends AbstractFloat2FloatMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Float2FloatMap.Entry> entrySet = getMap().float2FloatEntrySet();
		Iterator<Float2FloatMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Float2FloatMap.Entry entry : getMap().float2FloatEntrySet()) {
