...
public class FloatListAddAllArrayAtIndexTester extends AbstractFloatListTester {
	...
	public void testAddAllArrayAtIndex_supportedAllPresent() {
		getList().addElements(0, new float[]{e0()});
	...
	public void testAddAllArrayAtIndex_supportedSomePresent() {
		getList().addElements(0, new float[]{e0(), e3()});
	...
	public void testAddAllArrayAtIndex_withDuplicates() {
		getList().addElements(0, new float[]{e0(), e1(), e0(), e1()});
	...
	public void testAddAllArrayAtIndex_negative() {
		try {
			getList().addElements(-1, new float[]{e3()});
	...
	public void testAddAllArrayAtIndex_tooLarge() {
		try {
			getList().addElements(getNumElements() + 1, new float[]{e3()});
