...
public class Float2ObjectMapEntrySetTester<V> extends AbstractFloat2ObjectMapTester<V>
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Float2ObjectMap.Entry<V>> entrySet = getMap().float2ObjectEntrySet();
		Iterator<Float2ObjectMap.Entry<V>> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Float2ObjectMap.Entry<V> entry : getMap().float2ObjectEntrySet()) {
