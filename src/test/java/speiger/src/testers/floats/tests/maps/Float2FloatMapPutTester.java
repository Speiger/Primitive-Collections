...
public class Float2FloatMapPutTester extends AbstractFloat2FloatMapTester
{	
	...
	private float put(Float2FloatMap.Entry entry) {
		return getMap().put(entry.getFloatKey(), entry.getFloatValue());
	}
}