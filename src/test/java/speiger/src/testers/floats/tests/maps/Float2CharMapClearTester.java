...
public class Float2CharMapClearTester extends AbstractFloat2CharMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().float2CharEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().float2CharEntrySet().iterator();
			getMap().clear();
			iterator.next();
