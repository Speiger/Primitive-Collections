...
@Ignore
public class Float2CharMapEntrySetTester extends AbstractFloat2CharMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Float2CharMap.Entry> entrySet = getMap().float2CharEntrySet();
		Iterator<Float2CharMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Float2CharMap.Entry entry : getMap().float2CharEntrySet()) {
