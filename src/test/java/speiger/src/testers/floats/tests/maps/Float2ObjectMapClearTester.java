...
public class Float2ObjectMapClearTester<V> extends AbstractFloat2ObjectMapTester<V> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().float2ObjectEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<V>> iterator = getMap().float2ObjectEntrySet().iterator();
			getMap().clear();
			iterator.next();
