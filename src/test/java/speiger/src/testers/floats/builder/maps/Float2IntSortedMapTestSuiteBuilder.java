...
import speiger.src.testers.floats.tests.maps.Float2IntSortedMapNavigationTester;
...
public class Float2IntSortedMapTestSuiteBuilder extends Float2IntMapTestSuiteBuilder {
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Float2IntSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Float, Integer>, Map.Entry<Float, Integer>>> parentBuilder, Bound from, Bound to) {
	...
	Float2IntSortedMapTestSuiteBuilder newBuilderUsing(TestFloat2IntSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedFloat2IntMapGenerators.SortedMapGenerator(delegate, to, from));
	}
