...
import speiger.src.testers.floats.tests.maps.Float2BooleanSortedMapNavigationTester;
...
public class Float2BooleanSortedMapTestSuiteBuilder extends Float2BooleanMapTestSuiteBuilder {
	public static Float2BooleanSortedMapTestSuiteBuilder using(TestFloat2BooleanSortedMapGenerator generator) {
		return (Float2BooleanSortedMapTestSuiteBuilder) new Float2BooleanSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Float2BooleanSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Float, Boolean>, Map.Entry<Float, Boolean>>> parentBuilder, Bound from, Bound to) {
	...
	Float2BooleanSortedMapTestSuiteBuilder newBuilderUsing(TestFloat2BooleanSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedFloat2BooleanMapGenerators.SortedMapGenerator(delegate, to, from));
	}
