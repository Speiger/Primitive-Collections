...
import speiger.src.testers.floats.tests.maps.Float2ByteSortedMapNavigationTester;
...
public class Float2ByteSortedMapTestSuiteBuilder extends Float2ByteMapTestSuiteBuilder {
	public static Float2ByteSortedMapTestSuiteBuilder using(TestFloat2ByteSortedMapGenerator generator) {
		return (Float2ByteSortedMapTestSuiteBuilder) new Float2ByteSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Float2ByteSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Float, Byte>, Map.Entry<Float, Byte>>> parentBuilder, Bound from, Bound to) {
		TestFloat2ByteSortedMapGenerator delegate = (TestFloat2ByteSortedMapGenerator) parentBuilder.getSubjectGenerator().getInnerGenerator();
	...
	Float2ByteSortedMapTestSuiteBuilder newBuilderUsing(TestFloat2ByteSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedFloat2ByteMapGenerators.SortedMapGenerator(delegate, to, from));
	}
