...
public class Float2ByteNavigableMapTestSuiteBuilder extends Float2ByteSortedMapTestSuiteBuilder
{
	public static Float2ByteNavigableMapTestSuiteBuilder using(TestFloat2ByteSortedMapGenerator generator) {
		return (Float2ByteNavigableMapTestSuiteBuilder)new Float2ByteNavigableMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Float2ByteNavigableMapNavigationTester.class);
		return testers;
	}
	...
	@Override
	Float2ByteNavigableMapTestSuiteBuilder newBuilderUsing(TestFloat2ByteSortedMapGenerator delegate, Bound to, Bound from) {
		return Float2ByteNavigableMapTestSuiteBuilder.using(new DerivedFloat2ByteMapGenerators.NavigableMapGenerator(delegate, to, from));
	}

	private TestSuite createDescendingSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Float, Byte>, Map.Entry<Float, Byte>>> parentBuilder) {
		...
		return Float2ByteNavigableMapTestSuiteBuilder.using(new DerivedFloat2ByteMapGenerators.DescendingTestMapGenerator(delegate))
