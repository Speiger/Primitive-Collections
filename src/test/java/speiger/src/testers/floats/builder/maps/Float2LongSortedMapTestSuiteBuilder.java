...
import speiger.src.testers.floats.tests.maps.Float2LongSortedMapNavigationTester;
...
public class Float2LongSortedMapTestSuiteBuilder extends Float2LongMapTestSuiteBuilder {
	public static Float2LongSortedMapTestSuiteBuilder using(TestFloat2LongSortedMapGenerator generator) {
		return (Float2LongSortedMapTestSuiteBuilder) new Float2LongSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Float2LongSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Float, Long>, Map.Entry<Float, Long>>> parentBuilder, Bound from, Bound to) {
	...
	Float2LongSortedMapTestSuiteBuilder newBuilderUsing(TestFloat2LongSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedFloat2LongMapGenerators.SortedMapGenerator(delegate, to, from));
	}
