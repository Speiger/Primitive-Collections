...
import speiger.src.testers.floats.tests.maps.Float2ShortSortedMapNavigationTester;
...
public class Float2ShortSortedMapTestSuiteBuilder extends Float2ShortMapTestSuiteBuilder {
	public static Float2ShortSortedMapTestSuiteBuilder using(TestFloat2ShortSortedMapGenerator generator) {
		return (Float2ShortSortedMapTestSuiteBuilder) new Float2ShortSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Float2ShortSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Float, Short>, Map.Entry<Float, Short>>> parentBuilder, Bound from, Bound to) {
	...
	Float2ShortSortedMapTestSuiteBuilder newBuilderUsing(TestFloat2ShortSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedFloat2ShortMapGenerators.SortedMapGenerator(delegate, to, from));
	}
