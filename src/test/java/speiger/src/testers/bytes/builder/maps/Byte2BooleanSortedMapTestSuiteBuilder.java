...
import speiger.src.testers.bytes.tests.maps.Byte2BooleanSortedMapNavigationTester;
...
public class Byte2BooleanSortedMapTestSuiteBuilder extends Byte2BooleanMapTestSuiteBuilder {
	public static Byte2BooleanSortedMapTestSuiteBuilder using(TestByte2BooleanSortedMapGenerator generator) {
		return (Byte2BooleanSortedMapTestSuiteBuilder) new Byte2BooleanSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Byte2BooleanSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Byte, Boolean>, Map.Entry<Byte, Boolean>>> parentBuilder, Bound from, Bound to) {
		TestByte2BooleanSortedMapGenerator delegate = (TestByte2BooleanSortedMapGenerator) parentBuilder.getSubjectGenerator().getInnerGenerator();
	...
	Byte2BooleanSortedMapTestSuiteBuilder newBuilderUsing(TestByte2BooleanSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedByte2BooleanMapGenerators.SortedMapGenerator(delegate, to, from));
	}
