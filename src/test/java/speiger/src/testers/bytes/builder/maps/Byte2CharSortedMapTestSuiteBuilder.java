...
import speiger.src.testers.bytes.tests.maps.Byte2CharSortedMapNavigationTester;
...
public class Byte2CharSortedMapTestSuiteBuilder extends Byte2CharMapTestSuiteBuilder {
	public static Byte2CharSortedMapTestSuiteBuilder using(TestByte2CharSortedMapGenerator generator) {
		return (Byte2CharSortedMapTestSuiteBuilder) new Byte2CharSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Byte2CharSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Byte, Character>, Map.Entry<Byte, Character>>> parentBuilder, Bound from, Bound to) {
	...
	Byte2CharSortedMapTestSuiteBuilder newBuilderUsing(TestByte2CharSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedByte2CharMapGenerators.SortedMapGenerator(delegate, to, from));
	}
