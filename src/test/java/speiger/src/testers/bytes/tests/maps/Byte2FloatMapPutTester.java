...
@Ignore
public class Byte2FloatMapPutTester extends AbstractByte2FloatMapTester
{	
	...
	private float put(Byte2FloatMap.Entry entry) {
		return getMap().put(entry.getByteKey(), entry.getFloatValue());
	}
}