...
public class Byte2ShortMapPutTester extends AbstractByte2ShortMapTester
{	
	...
	private short put(Byte2ShortMap.Entry entry) {
		return getMap().put(entry.getByteKey(), entry.getShortValue());
	}
}