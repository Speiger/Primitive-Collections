...
@Ignore
public class Byte2CharMapEntrySetTester extends AbstractByte2CharMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Byte2CharMap.Entry> entrySet = getMap().byte2CharEntrySet();
		Iterator<Byte2CharMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Byte2CharMap.Entry entry : getMap().byte2CharEntrySet()) {
