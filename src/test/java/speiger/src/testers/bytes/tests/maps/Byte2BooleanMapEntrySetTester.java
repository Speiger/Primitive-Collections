...
public class Byte2BooleanMapEntrySetTester extends AbstractByte2BooleanMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Byte2BooleanMap.Entry> entrySet = getMap().byte2BooleanEntrySet();
		Iterator<Byte2BooleanMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Byte2BooleanMap.Entry entry : getMap().byte2BooleanEntrySet()) {
