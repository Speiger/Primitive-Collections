...
public class Byte2BooleanMapClearTester extends AbstractByte2BooleanMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().byte2BooleanEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().byte2BooleanEntrySet().iterator();
			getMap().clear();
			iterator.next();
