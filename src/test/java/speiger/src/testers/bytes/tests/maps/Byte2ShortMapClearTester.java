...
public class Byte2ShortMapClearTester extends AbstractByte2ShortMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().byte2ShortEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().byte2ShortEntrySet().iterator();
			getMap().clear();
			iterator.next();
