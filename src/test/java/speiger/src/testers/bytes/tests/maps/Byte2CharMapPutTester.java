...
public class Byte2CharMapPutTester extends AbstractByte2CharMapTester
{	
	...
	private char put(Byte2CharMap.Entry entry) {
		return getMap().put(entry.getByteKey(), entry.getCharValue());
	}
}