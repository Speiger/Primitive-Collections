...
public class Byte2IntMapAddToTester extends AbstractByte2IntMapTester
{	@MapFeature.Require(SUPPORTS_PUT)
	...
	private int addTo(Byte2IntMap.Entry entry) {
		return getMap().addTo(entry.getByteKey(), entry.getIntValue());
	}
}