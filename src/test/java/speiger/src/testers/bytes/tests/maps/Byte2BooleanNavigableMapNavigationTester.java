...
public class Byte2BooleanNavigableMapNavigationTester extends AbstractByte2BooleanMapTester
{
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Byte2BooleanNavigableMap) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.byte2BooleanEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.byte2BooleanEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry> descending = new ObjectArrayList<>(navigableMap.descendingMap().byte2BooleanEntrySet());
