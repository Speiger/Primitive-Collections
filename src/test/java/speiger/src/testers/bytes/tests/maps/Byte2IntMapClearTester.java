...
public class Byte2IntMapClearTester extends AbstractByte2IntMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().byte2IntEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().byte2IntEntrySet().iterator();
			getMap().clear();
			iterator.next();
