...
public class Byte2ByteMapPutTester extends AbstractByte2ByteMapTester
{	
	...
	private byte put(Byte2ByteMap.Entry entry) {
		return getMap().put(entry.getByteKey(), entry.getByteValue());
	}
}