...
@Ignore
public class Byte2ObjectMapEntrySetTester<V> extends AbstractByte2ObjectMapTester<V>
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Byte2ObjectMap.Entry<V>> entrySet = getMap().byte2ObjectEntrySet();
		Iterator<Byte2ObjectMap.Entry<V>> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Byte2ObjectMap.Entry<V> entry : getMap().byte2ObjectEntrySet()) {
