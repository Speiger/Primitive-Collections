...
@Ignore
public class Byte2ObjectNavigableMapNavigationTester<V> extends AbstractByte2ObjectMapTester<V>
{
	private Byte2ObjectNavigableMap<V> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Byte2ObjectNavigableMap<V>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.byte2ObjectEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.byte2ObjectEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<V>> descending = new ObjectArrayList<>(navigableMap.descendingMap().byte2ObjectEntrySet());
