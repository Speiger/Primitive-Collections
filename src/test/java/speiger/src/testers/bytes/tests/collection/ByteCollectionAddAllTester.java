...
public class ByteCollectionAddAllTester extends AbstractByteCollectionTester {
	...
	public void testAddAll_supportedSomePresent() {
		assertTrue("addAll(somePresent) should return true", collection.addAll(MinimalByteCollection.of(e3(), e0())));
	...
	public void testAddAll_unsupportedSomePresent() {
		try {
			collection.addAll(MinimalByteCollection.of(e3(), e0()));
	...
	public void testAddAllConcurrentWithIteration() {
		try {
			...
			assertTrue(collection.addAll(MinimalByteCollection.of(e3(), e0())));
			iterator.nextByte();
	...
	public void testAddAll_unsupportedAllPresent() {
		try {
			assertFalse("addAll(allPresent) should return false or throw", collection.addAll(MinimalByteCollection.of(e0())));
		} catch (UnsupportedOperationException tolerated) {
		}
		expectUnchanged();
	}
