...
public class Byte2ByteMapEntrySetTester extends AbstractByte2ByteMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Byte2ByteMap.Entry> entrySet = getMap().byte2ByteEntrySet();
		Iterator<Byte2ByteMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Byte2ByteMap.Entry entry : getMap().byte2ByteEntrySet()) {
