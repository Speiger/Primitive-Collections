...
@Ignore
public class Byte2IntMapEntrySetTester extends AbstractByte2IntMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Byte2IntMap.Entry> entrySet = getMap().byte2IntEntrySet();
		Iterator<Byte2IntMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Byte2IntMap.Entry entry : getMap().byte2IntEntrySet()) {
