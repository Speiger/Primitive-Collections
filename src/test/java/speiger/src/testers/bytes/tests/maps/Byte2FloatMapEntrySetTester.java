...
@Ignore
public class Byte2FloatMapEntrySetTester extends AbstractByte2FloatMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Byte2FloatMap.Entry> entrySet = getMap().byte2FloatEntrySet();
		Iterator<Byte2FloatMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Byte2FloatMap.Entry entry : getMap().byte2FloatEntrySet()) {
