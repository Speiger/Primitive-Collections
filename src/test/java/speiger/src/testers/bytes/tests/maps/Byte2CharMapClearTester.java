...
public class Byte2CharMapClearTester extends AbstractByte2CharMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().byte2CharEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().byte2CharEntrySet().iterator();
			getMap().clear();
			iterator.next();
