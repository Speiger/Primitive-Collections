...
public class LongCollectionAddAllTester extends AbstractLongCollectionTester
{
	...
	public void testAddAll_supportedSomePresent() {
		assertTrue("addAll(somePresent) should return true", collection.addAll(MinimalLongCollection.of(e3(), e0())));
	...
	public void testAddAll_unsupportedSomePresent() {
		try {
			collection.addAll(MinimalLongCollection.of(e3(), e0()));
	...
	public void testAddAllConcurrentWithIteration() {
		try {
			...
			assertTrue(collection.addAll(MinimalLongCollection.of(e3(), e0())));
			iterator.nextLong();
	...
	public void testAddAll_unsupportedAllPresent() {
		try {
			assertFalse("addAll(allPresent) should return false or throw", collection.addAll(MinimalLongCollection.of(e0())));
		} catch (UnsupportedOperationException tolerated) {
		}
		expectUnchanged();
	}
