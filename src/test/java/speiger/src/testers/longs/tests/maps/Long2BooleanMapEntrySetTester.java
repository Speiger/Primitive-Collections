...
@Ignore
public class Long2BooleanMapEntrySetTester extends AbstractLong2BooleanMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Long2BooleanMap.Entry> entrySet = getMap().long2BooleanEntrySet();
		Iterator<Long2BooleanMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Long2BooleanMap.Entry entry : getMap().long2BooleanEntrySet()) {
