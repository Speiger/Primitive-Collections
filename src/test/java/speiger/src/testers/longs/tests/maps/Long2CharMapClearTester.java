...
@Ignore
public class Long2CharMapClearTester extends AbstractLong2CharMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().long2CharEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().long2CharEntrySet().iterator();
			getMap().clear();
			iterator.next();
