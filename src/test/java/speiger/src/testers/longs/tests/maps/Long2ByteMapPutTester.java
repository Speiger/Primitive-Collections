...
@Ignore
public class Long2ByteMapPutTester extends AbstractLong2ByteMapTester
{	
	...
	private byte put(Long2ByteMap.Entry entry) {
		return getMap().put(entry.getLongKey(), entry.getByteValue());
	}
}