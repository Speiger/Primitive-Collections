...
@Ignore
public class Long2IntMapClearTester extends AbstractLong2IntMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().long2IntEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().long2IntEntrySet().iterator();
			getMap().clear();
			iterator.next();
