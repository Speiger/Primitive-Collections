...
public class Long2BooleanNavigableMapNavigationTester extends AbstractLong2BooleanMapTester
{
	private Long2BooleanNavigableMap navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Long2BooleanNavigableMap) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.long2BooleanEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.long2BooleanEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry> descending = new ObjectArrayList<>(navigableMap.descendingMap().long2BooleanEntrySet());
