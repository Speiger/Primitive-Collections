...
public class LongCollectionRetainAllTester extends AbstractLongCollectionTester
{
	...
	private class Target {
		...
		private final LongCollection inverse = LongArrayList.wrap(createSamplesArray());
		private final String description;

		private Target(LongCollection toRetain, String description) {
	...
	public void setUp() throws Exception {
		...
		disjoint = new Target(LongArrayList.wrap(e3(), e4()), "disjoint");
		superset = new Target(MinimalLongCollection.of(e0(), e1(), e2(), e3(), e4()), "superset");
		nonEmptyProperSubset = new Target(MinimalLongCollection.of(e1()), "subset");
		sameElements = new Target(LongArrayList.wrap(createSamplesArray()), "sameElements");
		containsDuplicates = new Target(MinimalLongCollection.of(e0(), e0(), e3(), e3()), "containsDuplicates");
		partialOverlap = new Target(MinimalLongCollection.of(e2(), e3()), "partialOverlap");
	}
	...
	private void expectReturnsTrueExtra(Target target) {
		...
		LongHelpers.assertEqualIgnoringOrder(target.inverse, list);
	}
