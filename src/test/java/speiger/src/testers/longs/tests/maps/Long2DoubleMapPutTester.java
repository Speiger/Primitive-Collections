...
public class Long2DoubleMapPutTester extends AbstractLong2DoubleMapTester
{	
	...
	private double put(Long2DoubleMap.Entry entry) {
		return getMap().put(entry.getLongKey(), entry.getDoubleValue());
	}
}