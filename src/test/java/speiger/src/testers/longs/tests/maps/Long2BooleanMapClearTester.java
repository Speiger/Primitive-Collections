...
@Ignore
public class Long2BooleanMapClearTester extends AbstractLong2BooleanMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().long2BooleanEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().long2BooleanEntrySet().iterator();
			getMap().clear();
			iterator.next();
