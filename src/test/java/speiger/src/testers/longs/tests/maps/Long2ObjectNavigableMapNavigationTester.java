...
public class Long2ObjectNavigableMapNavigationTester<V> extends AbstractLong2ObjectMapTester<V>
{
	private Long2ObjectNavigableMap<V> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Long2ObjectNavigableMap<V>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.long2ObjectEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.long2ObjectEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<V>> descending = new ObjectArrayList<>(navigableMap.descendingMap().long2ObjectEntrySet());
