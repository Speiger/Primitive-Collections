...
public class Long2LongMapEntrySetTester extends AbstractLong2LongMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Long2LongMap.Entry> entrySet = getMap().long2LongEntrySet();
		Iterator<Long2LongMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Long2LongMap.Entry entry : getMap().long2LongEntrySet()) {
