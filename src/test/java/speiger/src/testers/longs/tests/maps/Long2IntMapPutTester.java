...
@Ignore
public class Long2IntMapPutTester extends AbstractLong2IntMapTester
{	
	...
	private int put(Long2IntMap.Entry entry) {
		return getMap().put(entry.getLongKey(), entry.getIntValue());
	}
}