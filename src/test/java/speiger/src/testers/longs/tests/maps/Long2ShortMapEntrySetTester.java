...
public class Long2ShortMapEntrySetTester extends AbstractLong2ShortMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Long2ShortMap.Entry> entrySet = getMap().long2ShortEntrySet();
		Iterator<Long2ShortMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Long2ShortMap.Entry entry : getMap().long2ShortEntrySet()) {
