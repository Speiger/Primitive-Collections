...
@Ignore
public class Long2LongMapAddToTester extends AbstractLong2LongMapTester
{	@MapFeature.Require(SUPPORTS_PUT)
	...
	private long addTo(Long2LongMap.Entry entry) {
		return getMap().addTo(entry.getLongKey(), entry.getLongValue());
	}
}