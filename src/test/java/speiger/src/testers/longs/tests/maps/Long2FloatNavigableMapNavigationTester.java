...
public class Long2FloatNavigableMapNavigationTester extends AbstractLong2FloatMapTester
{
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Long2FloatNavigableMap) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.long2FloatEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.long2FloatEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry> descending = new ObjectArrayList<>(navigableMap.descendingMap().long2FloatEntrySet());
