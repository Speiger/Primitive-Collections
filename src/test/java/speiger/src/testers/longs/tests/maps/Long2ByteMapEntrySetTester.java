...
public class Long2ByteMapEntrySetTester extends AbstractLong2ByteMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Long2ByteMap.Entry> entrySet = getMap().long2ByteEntrySet();
		Iterator<Long2ByteMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Long2ByteMap.Entry entry : getMap().long2ByteEntrySet()) {
