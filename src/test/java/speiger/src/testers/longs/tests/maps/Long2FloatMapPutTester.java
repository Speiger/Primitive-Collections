...
@Ignore
public class Long2FloatMapPutTester extends AbstractLong2FloatMapTester
{	
	...
	private float put(Long2FloatMap.Entry entry) {
		return getMap().put(entry.getLongKey(), entry.getFloatValue());
	}
}