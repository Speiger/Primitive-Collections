...
public class Long2ShortMapPutTester extends AbstractLong2ShortMapTester
{	
	...
	private short put(Long2ShortMap.Entry entry) {
		return getMap().put(entry.getLongKey(), entry.getShortValue());
	}
}