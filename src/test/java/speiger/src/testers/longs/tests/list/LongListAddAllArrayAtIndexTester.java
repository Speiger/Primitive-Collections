...
@Ignore
public class LongListAddAllArrayAtIndexTester extends AbstractLongListTester {
	@ListFeature.Require(SUPPORTS_ADD_WITH_INDEX)
	@CollectionSize.Require(absent = ZERO)
	public void testAddAllArrayAtIndex_supportedAllPresent() {
		getList().addElements(0, new long[]{e0()});
	...
	public void testAddAllArrayAtIndex_supportedSomePresent() {
		getList().addElements(0, new long[]{e0(), e3()});
	...
	public void testAddAllArrayAtIndex_withDuplicates() {
		getList().addElements(0, new long[]{e0(), e1(), e0(), e1()});
	...
	public void testAddAllArrayAtIndex_negative() {
		try {
			getList().addElements(-1, new long[]{e3()});
	...
	public void testAddAllArrayAtIndex_tooLarge() {
		try {
			getList().addElements(getNumElements() + 1, new long[]{e3()});
