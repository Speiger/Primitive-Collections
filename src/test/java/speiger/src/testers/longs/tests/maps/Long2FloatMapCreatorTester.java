...
public class Long2FloatMapCreatorTester extends AbstractLong2FloatMapTester
{
	...
	private Long2FloatMap.Entry[] getEntriesMultipleNonNullKeys() {
		Long2FloatMap.Entry[] entries = createSamplesArray();
		entries[0] = entry(k1(), v0());
		return entries;
	}

	private void expectFirstRemoved(Long2FloatMap.Entry[] entries) {
		resetMap(entries);
