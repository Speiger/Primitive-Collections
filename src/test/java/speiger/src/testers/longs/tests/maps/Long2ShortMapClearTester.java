...
public class Long2ShortMapClearTester extends AbstractLong2ShortMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().long2ShortEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().long2ShortEntrySet().iterator();
			getMap().clear();
			iterator.next();
