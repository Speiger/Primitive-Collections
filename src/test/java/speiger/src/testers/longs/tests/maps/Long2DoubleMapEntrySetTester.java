...
@Ignore
public class Long2DoubleMapEntrySetTester extends AbstractLong2DoubleMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Long2DoubleMap.Entry> entrySet = getMap().long2DoubleEntrySet();
		Iterator<Long2DoubleMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Long2DoubleMap.Entry entry : getMap().long2DoubleEntrySet()) {
