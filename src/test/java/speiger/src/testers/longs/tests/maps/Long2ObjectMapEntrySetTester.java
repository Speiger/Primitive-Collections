...
@Ignore
public class Long2ObjectMapEntrySetTester<V> extends AbstractLong2ObjectMapTester<V>
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Long2ObjectMap.Entry<V>> entrySet = getMap().long2ObjectEntrySet();
		Iterator<Long2ObjectMap.Entry<V>> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Long2ObjectMap.Entry<V> entry : getMap().long2ObjectEntrySet()) {
