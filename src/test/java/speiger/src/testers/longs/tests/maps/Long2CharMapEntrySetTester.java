...
public class Long2CharMapEntrySetTester extends AbstractLong2CharMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Long2CharMap.Entry> entrySet = getMap().long2CharEntrySet();
		Iterator<Long2CharMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Long2CharMap.Entry entry : getMap().long2CharEntrySet()) {
