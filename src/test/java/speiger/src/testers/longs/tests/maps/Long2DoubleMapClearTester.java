...
public class Long2DoubleMapClearTester extends AbstractLong2DoubleMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().long2DoubleEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().long2DoubleEntrySet().iterator();
			getMap().clear();
			iterator.next();
