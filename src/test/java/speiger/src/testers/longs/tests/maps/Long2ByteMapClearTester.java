...
@Ignore
public class Long2ByteMapClearTester extends AbstractLong2ByteMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().long2ByteEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().long2ByteEntrySet().iterator();
			getMap().clear();
			iterator.next();
