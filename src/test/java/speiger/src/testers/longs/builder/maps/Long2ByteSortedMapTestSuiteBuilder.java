...
import speiger.src.testers.longs.tests.maps.Long2ByteSortedMapNavigationTester;
...
public class Long2ByteSortedMapTestSuiteBuilder extends Long2ByteMapTestSuiteBuilder {
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Long2ByteSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Long, Byte>, Map.Entry<Long, Byte>>> parentBuilder, Bound from, Bound to) {
	...
	Long2ByteSortedMapTestSuiteBuilder newBuilderUsing(TestLong2ByteSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedLong2ByteMapGenerators.SortedMapGenerator(delegate, to, from));
	}
