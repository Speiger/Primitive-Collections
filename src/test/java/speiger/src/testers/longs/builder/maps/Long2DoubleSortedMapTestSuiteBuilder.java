...
import speiger.src.testers.longs.tests.maps.Long2DoubleSortedMapNavigationTester;
...
public class Long2DoubleSortedMapTestSuiteBuilder extends Long2DoubleMapTestSuiteBuilder {
	public static Long2DoubleSortedMapTestSuiteBuilder using(TestLong2DoubleSortedMapGenerator generator) {
		return (Long2DoubleSortedMapTestSuiteBuilder) new Long2DoubleSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Long2DoubleSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Long, Double>, Map.Entry<Long, Double>>> parentBuilder, Bound from, Bound to) {
	...
	Long2DoubleSortedMapTestSuiteBuilder newBuilderUsing(TestLong2DoubleSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedLong2DoubleMapGenerators.SortedMapGenerator(delegate, to, from));
	}
