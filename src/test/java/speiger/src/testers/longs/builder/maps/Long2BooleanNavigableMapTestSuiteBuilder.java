...
public class Long2BooleanNavigableMapTestSuiteBuilder extends Long2BooleanSortedMapTestSuiteBuilder
{
	public static Long2BooleanNavigableMapTestSuiteBuilder using(TestLong2BooleanSortedMapGenerator generator) {
		return (Long2BooleanNavigableMapTestSuiteBuilder)new Long2BooleanNavigableMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Long2BooleanNavigableMapNavigationTester.class);
		return testers;
	}
	...
	@Override
	Long2BooleanNavigableMapTestSuiteBuilder newBuilderUsing(TestLong2BooleanSortedMapGenerator delegate, Bound to, Bound from) {
		return Long2BooleanNavigableMapTestSuiteBuilder.using(new DerivedLong2BooleanMapGenerators.NavigableMapGenerator(delegate, to, from));
	}

	private TestSuite createDescendingSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Long, Boolean>, Map.Entry<Long, Boolean>>> parentBuilder) {
		...
		return Long2BooleanNavigableMapTestSuiteBuilder.using(new DerivedLong2BooleanMapGenerators.DescendingTestMapGenerator(delegate))
