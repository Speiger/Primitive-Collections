...
import speiger.src.testers.longs.tests.maps.Long2IntSortedMapNavigationTester;
...
public class Long2IntSortedMapTestSuiteBuilder extends Long2IntMapTestSuiteBuilder {
	public static Long2IntSortedMapTestSuiteBuilder using(TestLong2IntSortedMapGenerator generator) {
		return (Long2IntSortedMapTestSuiteBuilder) new Long2IntSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Long2IntSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Long, Integer>, Map.Entry<Long, Integer>>> parentBuilder, Bound from, Bound to) {
	...
	Long2IntSortedMapTestSuiteBuilder newBuilderUsing(TestLong2IntSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedLong2IntMapGenerators.SortedMapGenerator(delegate, to, from));
	}
