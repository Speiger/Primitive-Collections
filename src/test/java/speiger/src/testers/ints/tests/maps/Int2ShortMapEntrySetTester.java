...
public class Int2ShortMapEntrySetTester extends AbstractInt2ShortMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Int2ShortMap.Entry> entrySet = getMap().int2ShortEntrySet();
		Iterator<Int2ShortMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Int2ShortMap.Entry entry : getMap().int2ShortEntrySet()) {
