...
@Ignore
public class Int2ByteMapPutTester extends AbstractInt2ByteMapTester
{	
	...
	private byte put(Int2ByteMap.Entry entry) {
		return getMap().put(entry.getIntKey(), entry.getByteValue());
	}
}