...
public class Int2DoubleMapClearTester extends AbstractInt2DoubleMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().int2DoubleEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().int2DoubleEntrySet().iterator();
			getMap().clear();
			iterator.next();
