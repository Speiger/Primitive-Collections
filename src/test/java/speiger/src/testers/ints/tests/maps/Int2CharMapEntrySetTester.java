...
public class Int2CharMapEntrySetTester extends AbstractInt2CharMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Int2CharMap.Entry> entrySet = getMap().int2CharEntrySet();
		Iterator<Int2CharMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Int2CharMap.Entry entry : getMap().int2CharEntrySet()) {
