...
public class Int2DoubleMapPutTester extends AbstractInt2DoubleMapTester
{	
	...
	private double put(Int2DoubleMap.Entry entry) {
		return getMap().put(entry.getIntKey(), entry.getDoubleValue());
	}
}