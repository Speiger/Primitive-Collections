...
@Ignore
public class Int2ShortMapClearTester extends AbstractInt2ShortMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().int2ShortEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().int2ShortEntrySet().iterator();
			getMap().clear();
			iterator.next();
