...
@Ignore
public class Int2ByteMapClearTester extends AbstractInt2ByteMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().int2ByteEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().int2ByteEntrySet().iterator();
			getMap().clear();
			iterator.next();
