...
public class Int2LongMapClearTester extends AbstractInt2LongMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().int2LongEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().int2LongEntrySet().iterator();
			getMap().clear();
			iterator.next();
