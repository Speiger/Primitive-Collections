...
@Ignore
public class Int2CharMapPutTester extends AbstractInt2CharMapTester
{	
	...
	private char put(Int2CharMap.Entry entry) {
		return getMap().put(entry.getIntKey(), entry.getCharValue());
	}
}