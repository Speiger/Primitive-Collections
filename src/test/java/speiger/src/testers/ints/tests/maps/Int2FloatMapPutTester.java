...
public class Int2FloatMapPutTester extends AbstractInt2FloatMapTester
{	
	...
	private float put(Int2FloatMap.Entry entry) {
		return getMap().put(entry.getIntKey(), entry.getFloatValue());
	}
}