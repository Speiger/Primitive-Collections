...
public class Int2BooleanMapEntrySetTester extends AbstractInt2BooleanMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Int2BooleanMap.Entry> entrySet = getMap().int2BooleanEntrySet();
		Iterator<Int2BooleanMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Int2BooleanMap.Entry entry : getMap().int2BooleanEntrySet()) {
