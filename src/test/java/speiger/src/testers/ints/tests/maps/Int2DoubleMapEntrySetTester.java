...
public class Int2DoubleMapEntrySetTester extends AbstractInt2DoubleMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Int2DoubleMap.Entry> entrySet = getMap().int2DoubleEntrySet();
		Iterator<Int2DoubleMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Int2DoubleMap.Entry entry : getMap().int2DoubleEntrySet()) {
