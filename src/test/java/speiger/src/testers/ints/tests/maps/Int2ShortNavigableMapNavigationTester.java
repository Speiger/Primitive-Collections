...
@Ignore
public class Int2ShortNavigableMapNavigationTester extends AbstractInt2ShortMapTester
{
	private Int2ShortNavigableMap navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Int2ShortNavigableMap) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.int2ShortEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.int2ShortEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry> descending = new ObjectArrayList<>(navigableMap.descendingMap().int2ShortEntrySet());
