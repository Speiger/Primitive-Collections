...
public class Int2ObjectMapClearTester<V> extends AbstractInt2ObjectMapTester<V> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().int2ObjectEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<V>> iterator = getMap().int2ObjectEntrySet().iterator();
			getMap().clear();
			iterator.next();
