...
public class Int2LongNavigableMapNavigationTester extends AbstractInt2LongMapTester
{
	private Int2LongNavigableMap navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Int2LongNavigableMap) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.int2LongEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.int2LongEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry> descending = new ObjectArrayList<>(navigableMap.descendingMap().int2LongEntrySet());
