...
@Ignore
public class Int2LongMapPutTester extends AbstractInt2LongMapTester
{	
	...
	private long put(Int2LongMap.Entry entry) {
		return getMap().put(entry.getIntKey(), entry.getLongValue());
	}
}