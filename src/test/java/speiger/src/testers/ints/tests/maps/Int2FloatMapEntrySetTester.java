...
@Ignore
public class Int2FloatMapEntrySetTester extends AbstractInt2FloatMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Int2FloatMap.Entry> entrySet = getMap().int2FloatEntrySet();
		Iterator<Int2FloatMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Int2FloatMap.Entry entry : getMap().int2FloatEntrySet()) {
