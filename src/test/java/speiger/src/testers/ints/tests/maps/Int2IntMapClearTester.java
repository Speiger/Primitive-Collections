...
@Ignore
public class Int2IntMapClearTester extends AbstractInt2IntMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().int2IntEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().int2IntEntrySet().iterator();
			getMap().clear();
			iterator.next();
