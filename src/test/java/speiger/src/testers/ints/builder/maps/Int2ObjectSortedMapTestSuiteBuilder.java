...
import speiger.src.testers.ints.tests.maps.Int2ObjectSortedMapNavigationTester;
...
public class Int2ObjectSortedMapTestSuiteBuilder<V> extends Int2ObjectMapTestSuiteBuilder<V> {
	public static <V> Int2ObjectSortedMapTestSuiteBuilder<V> using(TestInt2ObjectSortedMapGenerator<V> generator) {
		return (Int2ObjectSortedMapTestSuiteBuilder<V>) new Int2ObjectSortedMapTestSuiteBuilder<V>().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Int2ObjectSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Integer, V>, Map.Entry<Integer, V>>> parentBuilder, Bound from, Bound to) {
	...
	Int2ObjectSortedMapTestSuiteBuilder<V> newBuilderUsing(TestInt2ObjectSortedMapGenerator<V> delegate, Bound to, Bound from) {
		return using(new DerivedInt2ObjectMapGenerators.SortedMapGenerator<>(delegate, to, from));
	}
