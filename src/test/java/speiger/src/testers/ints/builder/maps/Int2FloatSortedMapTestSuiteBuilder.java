...
import speiger.src.testers.ints.tests.maps.Int2FloatSortedMapNavigationTester;
...
public class Int2FloatSortedMapTestSuiteBuilder extends Int2FloatMapTestSuiteBuilder {
	public static Int2FloatSortedMapTestSuiteBuilder using(TestInt2FloatSortedMapGenerator generator) {
		return (Int2FloatSortedMapTestSuiteBuilder) new Int2FloatSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Int2FloatSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Integer, Float>, Map.Entry<Integer, Float>>> parentBuilder, Bound from, Bound to) {
	...
	Int2FloatSortedMapTestSuiteBuilder newBuilderUsing(TestInt2FloatSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedInt2FloatMapGenerators.SortedMapGenerator(delegate, to, from));
	}
