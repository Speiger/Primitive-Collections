...
import speiger.src.testers.ints.tests.maps.Int2DoubleSortedMapNavigationTester;
...
public class Int2DoubleSortedMapTestSuiteBuilder extends Int2DoubleMapTestSuiteBuilder {
	public static Int2DoubleSortedMapTestSuiteBuilder using(TestInt2DoubleSortedMapGenerator generator) {
		return (Int2DoubleSortedMapTestSuiteBuilder) new Int2DoubleSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Int2DoubleSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Integer, Double>, Map.Entry<Integer, Double>>> parentBuilder, Bound from, Bound to) {
	...
	Int2DoubleSortedMapTestSuiteBuilder newBuilderUsing(TestInt2DoubleSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedInt2DoubleMapGenerators.SortedMapGenerator(delegate, to, from));
	}
