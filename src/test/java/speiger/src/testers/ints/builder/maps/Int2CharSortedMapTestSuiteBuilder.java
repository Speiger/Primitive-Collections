...
import speiger.src.testers.ints.tests.maps.Int2CharSortedMapNavigationTester;
...
public class Int2CharSortedMapTestSuiteBuilder extends Int2CharMapTestSuiteBuilder {
	public static Int2CharSortedMapTestSuiteBuilder using(TestInt2CharSortedMapGenerator generator) {
		return (Int2CharSortedMapTestSuiteBuilder) new Int2CharSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Int2CharSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Integer, Character>, Map.Entry<Integer, Character>>> parentBuilder, Bound from, Bound to) {
	...
	Int2CharSortedMapTestSuiteBuilder newBuilderUsing(TestInt2CharSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedInt2CharMapGenerators.SortedMapGenerator(delegate, to, from));
	}
