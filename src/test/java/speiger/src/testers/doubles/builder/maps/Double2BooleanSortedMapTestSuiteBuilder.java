...
import speiger.src.testers.doubles.tests.maps.Double2BooleanSortedMapNavigationTester;
...
public class Double2BooleanSortedMapTestSuiteBuilder extends Double2BooleanMapTestSuiteBuilder {
	public static Double2BooleanSortedMapTestSuiteBuilder using(TestDouble2BooleanSortedMapGenerator generator) {
		return (Double2BooleanSortedMapTestSuiteBuilder) new Double2BooleanSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Double2BooleanSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Double, Boolean>, Map.Entry<Double, Boolean>>> parentBuilder, Bound from, Bound to) {
	...
	Double2BooleanSortedMapTestSuiteBuilder newBuilderUsing(TestDouble2BooleanSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedDouble2BooleanMapGenerators.SortedMapGenerator(delegate, to, from));
	}
