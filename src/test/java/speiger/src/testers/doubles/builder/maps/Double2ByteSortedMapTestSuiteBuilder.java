...
import speiger.src.testers.doubles.tests.maps.Double2ByteSortedMapNavigationTester;
...
public class Double2ByteSortedMapTestSuiteBuilder extends Double2ByteMapTestSuiteBuilder {
	public static Double2ByteSortedMapTestSuiteBuilder using(TestDouble2ByteSortedMapGenerator generator) {
		return (Double2ByteSortedMapTestSuiteBuilder) new Double2ByteSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Double2ByteSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Double, Byte>, Map.Entry<Double, Byte>>> parentBuilder, Bound from, Bound to) {
	...
	Double2ByteSortedMapTestSuiteBuilder newBuilderUsing(TestDouble2ByteSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedDouble2ByteMapGenerators.SortedMapGenerator(delegate, to, from));
	}
