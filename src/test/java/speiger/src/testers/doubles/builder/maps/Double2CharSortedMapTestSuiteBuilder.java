...
import speiger.src.testers.doubles.tests.maps.Double2CharSortedMapNavigationTester;
...
public class Double2CharSortedMapTestSuiteBuilder extends Double2CharMapTestSuiteBuilder {
	public static Double2CharSortedMapTestSuiteBuilder using(TestDouble2CharSortedMapGenerator generator) {
		return (Double2CharSortedMapTestSuiteBuilder) new Double2CharSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Double2CharSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Double, Character>, Map.Entry<Double, Character>>> parentBuilder, Bound from, Bound to) {
	...
	Double2CharSortedMapTestSuiteBuilder newBuilderUsing(TestDouble2CharSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedDouble2CharMapGenerators.SortedMapGenerator(delegate, to, from));
	}
