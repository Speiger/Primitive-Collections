...
@Ignore
public class Double2CharMapRemoveTester extends AbstractDouble2CharMapTester
{
	...
	public void testRemove_notPresent() {
		assertEquals("remove(notPresent) should return (char)-1", (char)-1, getMap().remove(k3()));
		expectUnchanged();
	}
	...
	public void testRemove_unsupportedNotPresent() {
		try {
			assertEquals("remove(notPresent) should return (char)-1 or throw UnsupportedOperationException", (char)-1, getMap().remove(k3()));
