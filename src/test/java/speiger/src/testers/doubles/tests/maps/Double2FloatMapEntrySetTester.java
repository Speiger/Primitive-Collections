...
public class Double2FloatMapEntrySetTester extends AbstractDouble2FloatMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Double2FloatMap.Entry> entrySet = getMap().double2FloatEntrySet();
		Iterator<Double2FloatMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Double2FloatMap.Entry entry : getMap().double2FloatEntrySet()) {
