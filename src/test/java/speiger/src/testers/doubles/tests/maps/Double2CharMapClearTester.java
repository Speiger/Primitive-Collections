...
@Ignore
public class Double2CharMapClearTester extends AbstractDouble2CharMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().double2CharEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().double2CharEntrySet().iterator();
			getMap().clear();
			iterator.next();
