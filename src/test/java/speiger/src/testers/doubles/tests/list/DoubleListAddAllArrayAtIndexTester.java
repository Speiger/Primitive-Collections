...
public class DoubleListAddAllArrayAtIndexTester extends AbstractDoubleListTester {
	...
	public void testAddAllArrayAtIndex_supportedAllPresent() {
		getList().addElements(0, new double[]{e0()});
	...
	public void testAddAllArrayAtIndex_supportedSomePresent() {
		getList().addElements(0, new double[]{e0(), e3()});
	...
	public void testAddAllArrayAtIndex_withDuplicates() {
		getList().addElements(0, new double[]{e0(), e1(), e0(), e1()});
	...
	public void testAddAllArrayAtIndex_negative() {
		try {
			getList().addElements(-1, new double[]{e3()});
	...
	public void testAddAllArrayAtIndex_tooLarge() {
		try {
			getList().addElements(getNumElements() + 1, new double[]{e3()});
