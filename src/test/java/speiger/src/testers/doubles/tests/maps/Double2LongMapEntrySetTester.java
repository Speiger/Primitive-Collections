...
@Ignore
public class Double2LongMapEntrySetTester extends AbstractDouble2LongMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Double2LongMap.Entry> entrySet = getMap().double2LongEntrySet();
		Iterator<Double2LongMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Double2LongMap.Entry entry : getMap().double2LongEntrySet()) {
