...
public class Double2BooleanMapEntrySetTester extends AbstractDouble2BooleanMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Double2BooleanMap.Entry> entrySet = getMap().double2BooleanEntrySet();
		Iterator<Double2BooleanMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Double2BooleanMap.Entry entry : getMap().double2BooleanEntrySet()) {
