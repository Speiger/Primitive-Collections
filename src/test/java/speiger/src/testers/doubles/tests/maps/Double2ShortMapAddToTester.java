...
@Ignore
public class Double2ShortMapAddToTester extends AbstractDouble2ShortMapTester
{	@MapFeature.Require(SUPPORTS_PUT)
	...
	private short addTo(Double2ShortMap.Entry entry) {
		return getMap().addTo(entry.getDoubleKey(), entry.getShortValue());
	}
}