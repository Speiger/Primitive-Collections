...
@Ignore
public class Double2ObjectNavigableMapNavigationTester<V> extends AbstractDouble2ObjectMapTester<V>
{
	private Double2ObjectNavigableMap<V> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Double2ObjectNavigableMap<V>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.double2ObjectEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.double2ObjectEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<V>> descending = new ObjectArrayList<>(navigableMap.descendingMap().double2ObjectEntrySet());
