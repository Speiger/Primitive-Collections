...
public class Double2ObjectMapClearTester<V> extends AbstractDouble2ObjectMapTester<V> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().double2ObjectEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<V>> iterator = getMap().double2ObjectEntrySet().iterator();
			getMap().clear();
			iterator.next();
