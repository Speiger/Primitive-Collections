...
@Ignore
public class Double2DoubleMapClearTester extends AbstractDouble2DoubleMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().double2DoubleEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().double2DoubleEntrySet().iterator();
			getMap().clear();
			iterator.next();
