...
public class Double2LongMapClearTester extends AbstractDouble2LongMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().double2LongEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().double2LongEntrySet().iterator();
			getMap().clear();
			iterator.next();
