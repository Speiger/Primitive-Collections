...
public class Double2ByteMapEntrySetTester extends AbstractDouble2ByteMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Double2ByteMap.Entry> entrySet = getMap().double2ByteEntrySet();
		Iterator<Double2ByteMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Double2ByteMap.Entry entry : getMap().double2ByteEntrySet()) {
