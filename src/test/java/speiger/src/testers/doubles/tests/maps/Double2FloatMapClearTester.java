...
@Ignore
public class Double2FloatMapClearTester extends AbstractDouble2FloatMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().double2FloatEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().double2FloatEntrySet().iterator();
			getMap().clear();
			iterator.next();
