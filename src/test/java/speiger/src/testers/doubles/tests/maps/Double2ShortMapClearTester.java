...
public class Double2ShortMapClearTester extends AbstractDouble2ShortMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().double2ShortEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().double2ShortEntrySet().iterator();
			getMap().clear();
			iterator.next();
