...
public class Double2IntMapClearTester extends AbstractDouble2IntMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().double2IntEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().double2IntEntrySet().iterator();
			getMap().clear();
			iterator.next();
