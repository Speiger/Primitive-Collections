...
public class DoubleCollectionAddAllTester extends AbstractDoubleCollectionTester
{
	...
	public void testAddAll_supportedSomePresent() {
		assertTrue("addAll(somePresent) should return true", collection.addAll(MinimalDoubleCollection.of(e3(), e0())));
	...
	public void testAddAll_unsupportedSomePresent() {
		try {
			collection.addAll(MinimalDoubleCollection.of(e3(), e0()));
	...
	public void testAddAllConcurrentWithIteration() {
		try {
			...
			assertTrue(collection.addAll(MinimalDoubleCollection.of(e3(), e0())));
			iterator.nextDouble();
	...
	public void testAddAll_unsupportedAllPresent() {
		try {
			assertFalse("addAll(allPresent) should return false or throw", collection.addAll(MinimalDoubleCollection.of(e0())));
		} catch (UnsupportedOperationException tolerated) {
		}
		expectUnchanged();
	}
