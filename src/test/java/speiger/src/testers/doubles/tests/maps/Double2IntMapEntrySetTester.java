...
public class Double2IntMapEntrySetTester extends AbstractDouble2IntMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Double2IntMap.Entry> entrySet = getMap().double2IntEntrySet();
		Iterator<Double2IntMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Double2IntMap.Entry entry : getMap().double2IntEntrySet()) {
