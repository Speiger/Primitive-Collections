...
public class Double2FloatMapRemoveTester extends AbstractDouble2FloatMapTester
{
	...
	public void testRemove_notPresent() {
		assertEquals("remove(notPresent) should return -1F", -1F, getMap().remove(k3()));
		expectUnchanged();
	}
	...
	public void testRemove_unsupportedNotPresent() {
		try {
			assertEquals("remove(notPresent) should return -1F or throw UnsupportedOperationException", -1F, getMap().remove(k3()));
