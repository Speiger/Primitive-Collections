...
import speiger.src.testers.shorts.tests.maps.Short2CharSortedMapNavigationTester;
...
public class Short2CharSortedMapTestSuiteBuilder extends Short2CharMapTestSuiteBuilder {
	public static Short2CharSortedMapTestSuiteBuilder using(TestShort2CharSortedMapGenerator generator) {
		return (Short2CharSortedMapTestSuiteBuilder) new Short2CharSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Short2CharSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Short, Character>, Map.Entry<Short, Character>>> parentBuilder, Bound from, Bound to) {
	...
	Short2CharSortedMapTestSuiteBuilder newBuilderUsing(TestShort2CharSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedShort2CharMapGenerators.SortedMapGenerator(delegate, to, from));
	}
