...
import speiger.src.testers.shorts.tests.maps.Short2DoubleSortedMapNavigationTester;
...
public class Short2DoubleSortedMapTestSuiteBuilder extends Short2DoubleMapTestSuiteBuilder {
	public static Short2DoubleSortedMapTestSuiteBuilder using(TestShort2DoubleSortedMapGenerator generator) {
		return (Short2DoubleSortedMapTestSuiteBuilder) new Short2DoubleSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Short2DoubleSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Short, Double>, Map.Entry<Short, Double>>> parentBuilder, Bound from, Bound to) {
	...
	Short2DoubleSortedMapTestSuiteBuilder newBuilderUsing(TestShort2DoubleSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedShort2DoubleMapGenerators.SortedMapGenerator(delegate, to, from));
	}
