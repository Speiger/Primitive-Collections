...
import speiger.src.testers.shorts.tests.maps.Short2LongSortedMapNavigationTester;
...
public class Short2LongSortedMapTestSuiteBuilder extends Short2LongMapTestSuiteBuilder {
	public static Short2LongSortedMapTestSuiteBuilder using(TestShort2LongSortedMapGenerator generator) {
		return (Short2LongSortedMapTestSuiteBuilder) new Short2LongSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Short2LongSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Short, Long>, Map.Entry<Short, Long>>> parentBuilder, Bound from, Bound to) {
	...
	Short2LongSortedMapTestSuiteBuilder newBuilderUsing(TestShort2LongSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedShort2LongMapGenerators.SortedMapGenerator(delegate, to, from));
	}
