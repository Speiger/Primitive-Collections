...
import speiger.src.testers.shorts.tests.maps.Short2ShortSortedMapNavigationTester;
...
public class Short2ShortSortedMapTestSuiteBuilder extends Short2ShortMapTestSuiteBuilder {
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Short2ShortSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Short, Short>, Map.Entry<Short, Short>>> parentBuilder, Bound from, Bound to) {
	...
	Short2ShortSortedMapTestSuiteBuilder newBuilderUsing(TestShort2ShortSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedShort2ShortMapGenerators.SortedMapGenerator(delegate, to, from));
	}
