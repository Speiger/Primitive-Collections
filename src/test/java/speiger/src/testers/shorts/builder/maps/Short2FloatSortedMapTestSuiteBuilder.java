...
import speiger.src.testers.shorts.tests.maps.Short2FloatSortedMapNavigationTester;
...
public class Short2FloatSortedMapTestSuiteBuilder extends Short2FloatMapTestSuiteBuilder {
	public static Short2FloatSortedMapTestSuiteBuilder using(TestShort2FloatSortedMapGenerator generator) {
		return (Short2FloatSortedMapTestSuiteBuilder) new Short2FloatSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Short2FloatSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Short, Float>, Map.Entry<Short, Float>>> parentBuilder, Bound from, Bound to) {
	...
	Short2FloatSortedMapTestSuiteBuilder newBuilderUsing(TestShort2FloatSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedShort2FloatMapGenerators.SortedMapGenerator(delegate, to, from));
	}
