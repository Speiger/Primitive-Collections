...
import speiger.src.testers.shorts.tests.maps.Short2ObjectSortedMapNavigationTester;
...
public class Short2ObjectSortedMapTestSuiteBuilder<V> extends Short2ObjectMapTestSuiteBuilder<V> {
	public static <V> Short2ObjectSortedMapTestSuiteBuilder<V> using(TestShort2ObjectSortedMapGenerator<V> generator) {
		return (Short2ObjectSortedMapTestSuiteBuilder<V>) new Short2ObjectSortedMapTestSuiteBuilder<V>().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Short2ObjectSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Short, V>, Map.Entry<Short, V>>> parentBuilder, Bound from, Bound to) {
	...
	Short2ObjectSortedMapTestSuiteBuilder<V> newBuilderUsing(TestShort2ObjectSortedMapGenerator<V> delegate, Bound to, Bound from) {
		return using(new DerivedShort2ObjectMapGenerators.SortedMapGenerator<>(delegate, to, from));
	}
