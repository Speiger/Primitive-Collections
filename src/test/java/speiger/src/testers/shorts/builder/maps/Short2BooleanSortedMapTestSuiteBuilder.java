...
import speiger.src.testers.shorts.tests.maps.Short2BooleanSortedMapNavigationTester;
...
public class Short2BooleanSortedMapTestSuiteBuilder extends Short2BooleanMapTestSuiteBuilder {
	public static Short2BooleanSortedMapTestSuiteBuilder using(TestShort2BooleanSortedMapGenerator generator) {
		return (Short2BooleanSortedMapTestSuiteBuilder) new Short2BooleanSortedMapTestSuiteBuilder().usingGenerator(generator);
	}
	...
	protected List<Class<? extends AbstractTester>> getTesters() {
		...
		testers.add(Short2BooleanSortedMapNavigationTester.class);
		return testers;
	}
	...
	TestSuite createSubmapSuite(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<Short, Boolean>, Map.Entry<Short, Boolean>>> parentBuilder, Bound from, Bound to) {
	...
	Short2BooleanSortedMapTestSuiteBuilder newBuilderUsing(TestShort2BooleanSortedMapGenerator delegate, Bound to, Bound from) {
		return using(new DerivedShort2BooleanMapGenerators.SortedMapGenerator(delegate, to, from));
	}
