...
public class Short2ObjectMapClearTester<V> extends AbstractShort2ObjectMapTester<V> 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().short2ObjectEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry<V>> iterator = getMap().short2ObjectEntrySet().iterator();
			getMap().clear();
			iterator.next();
