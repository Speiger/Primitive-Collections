...
@Ignore
public class Short2CharMapClearTester extends AbstractShort2CharMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().short2CharEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().short2CharEntrySet().iterator();
			getMap().clear();
			iterator.next();
