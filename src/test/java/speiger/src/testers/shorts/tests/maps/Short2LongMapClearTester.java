...
public class Short2LongMapClearTester extends AbstractShort2LongMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().short2LongEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().short2LongEntrySet().iterator();
			getMap().clear();
			iterator.next();
