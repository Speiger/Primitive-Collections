...
@Ignore
public class Short2DoubleMapClearTester extends AbstractShort2DoubleMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().short2DoubleEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().short2DoubleEntrySet().iterator();
			getMap().clear();
			iterator.next();
