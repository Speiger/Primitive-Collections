...
@Ignore
public class Short2IntMapEntrySetTester extends AbstractShort2IntMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Short2IntMap.Entry> entrySet = getMap().short2IntEntrySet();
		Iterator<Short2IntMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Short2IntMap.Entry entry : getMap().short2IntEntrySet()) {
