...
@Ignore
public class Short2LongMapEntrySetTester extends AbstractShort2LongMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Short2LongMap.Entry> entrySet = getMap().short2LongEntrySet();
		Iterator<Short2LongMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Short2LongMap.Entry entry : getMap().short2LongEntrySet()) {
