...
public class Short2CharMapCreatorTester extends AbstractShort2CharMapTester
{
	...
	private Short2CharMap.Entry[] getEntriesMultipleNonNullKeys() {
		Short2CharMap.Entry[] entries = createSamplesArray();
		entries[0] = entry(k1(), v0());
		return entries;
	}

	private void expectFirstRemoved(Short2CharMap.Entry[] entries) {
		resetMap(entries);
