...
public class Short2ShortMapEntrySetTester extends AbstractShort2ShortMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Short2ShortMap.Entry> entrySet = getMap().short2ShortEntrySet();
		Iterator<Short2ShortMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Short2ShortMap.Entry entry : getMap().short2ShortEntrySet()) {
