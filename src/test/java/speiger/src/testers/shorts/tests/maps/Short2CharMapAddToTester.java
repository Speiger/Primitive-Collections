...
@Ignore
public class Short2CharMapAddToTester extends AbstractShort2CharMapTester
{	@MapFeature.Require(SUPPORTS_PUT)
	...
	private char addTo(Short2CharMap.Entry entry) {
		return getMap().addTo(entry.getShortKey(), entry.getCharValue());
	}
}