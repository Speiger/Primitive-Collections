...
@Ignore
public class Short2ObjectNavigableMapNavigationTester<V> extends AbstractShort2ObjectMapTester<V>
{
	private Short2ObjectNavigableMap<V> navigableMap;
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Short2ObjectNavigableMap<V>) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.short2ObjectEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.short2ObjectEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry<V>> descending = new ObjectArrayList<>(navigableMap.descendingMap().short2ObjectEntrySet());
