...
public class Short2DoubleMapPutTester extends AbstractShort2DoubleMapTester
{	
	...
	private double put(Short2DoubleMap.Entry entry) {
		return getMap().put(entry.getShortKey(), entry.getDoubleValue());
	}
}