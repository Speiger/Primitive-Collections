...
public class Short2DoubleMapEntrySetTester extends AbstractShort2DoubleMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Short2DoubleMap.Entry> entrySet = getMap().short2DoubleEntrySet();
		Iterator<Short2DoubleMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Short2DoubleMap.Entry entry : getMap().short2DoubleEntrySet()) {
