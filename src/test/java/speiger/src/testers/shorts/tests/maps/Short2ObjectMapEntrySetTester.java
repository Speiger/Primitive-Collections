...
public class Short2ObjectMapEntrySetTester<V> extends AbstractShort2ObjectMapTester<V>
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Short2ObjectMap.Entry<V>> entrySet = getMap().short2ObjectEntrySet();
		Iterator<Short2ObjectMap.Entry<V>> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Short2ObjectMap.Entry<V> entry : getMap().short2ObjectEntrySet()) {
