...
public class Short2LongMapPutTester extends AbstractShort2LongMapTester
{	
	...
	private long put(Short2LongMap.Entry entry) {
		return getMap().put(entry.getShortKey(), entry.getLongValue());
	}
}