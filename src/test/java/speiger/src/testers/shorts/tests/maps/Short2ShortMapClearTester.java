...
public class Short2ShortMapClearTester extends AbstractShort2ShortMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().short2ShortEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().short2ShortEntrySet().iterator();
			getMap().clear();
			iterator.next();
