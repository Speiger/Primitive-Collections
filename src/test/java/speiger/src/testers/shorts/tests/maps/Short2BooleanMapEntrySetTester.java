...
public class Short2BooleanMapEntrySetTester extends AbstractShort2BooleanMapTester
{
	@CollectionSize.Require(ONE)
	@CollectionFeature.Require(SUPPORTS_ITERATOR_REMOVE)
	public void testEntrySetIteratorRemove() {
		Set<Short2BooleanMap.Entry> entrySet = getMap().short2BooleanEntrySet();
		Iterator<Short2BooleanMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Short2BooleanMap.Entry entry : getMap().short2BooleanEntrySet()) {
