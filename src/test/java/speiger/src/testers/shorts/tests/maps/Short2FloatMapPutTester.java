...
@Ignore
public class Short2FloatMapPutTester extends AbstractShort2FloatMapTester
{	
	...
	private float put(Short2FloatMap.Entry entry) {
		return getMap().put(entry.getShortKey(), entry.getFloatValue());
	}
}