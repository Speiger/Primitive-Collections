...
public class Short2ShortNavigableMapNavigationTester extends AbstractShort2ShortMapTester
{
	...
	public void setUp() throws Exception {
		super.setUp();
		navigableMap = (Short2ShortNavigableMap) getMap();
	...
	public void testPollFirst() {
		assertEquals(a, navigableMap.pollFirstEntry());
		assertEquals(entries.subList(1, entries.size()), ObjectHelpers.copyToList(navigableMap.short2ShortEntrySet()));
	}
	...
	public void testPollLast() {
		...
		assertEquals(entries.subList(0, entries.size() - 1), ObjectHelpers.copyToList(navigableMap.short2ShortEntrySet()));
	}
	...
	public void testDescendingNavigation() {
		ObjectList<Entry> descending = new ObjectArrayList<>(navigableMap.descendingMap().short2ShortEntrySet());
