...
@Ignore
public class Short2ByteMapClearTester extends AbstractShort2ByteMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().short2ByteEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().short2ByteEntrySet().iterator();
			getMap().clear();
			iterator.next();
