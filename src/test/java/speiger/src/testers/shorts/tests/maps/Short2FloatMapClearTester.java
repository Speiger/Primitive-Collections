...
public class Short2FloatMapClearTester extends AbstractShort2FloatMapTester 
{
	...
	public void testClear() {
		...
		assertFalse(getMap().short2FloatEntrySet().iterator().hasNext());
	}
	...
	public void testClearConcurrentWithEntrySetIteration() {
		try {
			ObjectIterator<Entry> iterator = getMap().short2FloatEntrySet().iterator();
			getMap().clear();
			iterator.next();
