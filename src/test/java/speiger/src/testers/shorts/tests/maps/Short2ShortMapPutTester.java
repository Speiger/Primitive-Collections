...
public class Short2ShortMapPutTester extends AbstractShort2ShortMapTester
{	
	...
	private short put(Short2ShortMap.Entry entry) {
		return getMap().put(entry.getShortKey(), entry.getShortValue());
	}
}