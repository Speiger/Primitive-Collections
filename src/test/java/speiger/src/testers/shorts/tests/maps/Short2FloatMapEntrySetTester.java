...
public class Short2FloatMapEntrySetTester extends AbstractShort2FloatMapTester
{
	...
	public void testEntrySetIteratorRemove() {
		Set<Short2FloatMap.Entry> entrySet = getMap().short2FloatEntrySet();
		Iterator<Short2FloatMap.Entry> entryItr = entrySet.iterator();
	...
	public void testSetValue() {
		for (Short2FloatMap.Entry entry : getMap().short2FloatEntrySet()) {
